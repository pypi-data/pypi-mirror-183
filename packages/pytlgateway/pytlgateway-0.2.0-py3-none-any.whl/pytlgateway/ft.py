...
LL9 = 1000000000
config_filename = "C:\\Users\\Administrator\\Desktop\\ft_batandjson\\ft_setting.json"
...
def decode_args(argv) -> str:
    ...
    try:
      opts, args = getopt.getopt(argv,"he:o:p:",["endtime="])
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            config_filename = arg
    print (f"end_time={endtime} config_filename{config_filename}")
    return endtime
