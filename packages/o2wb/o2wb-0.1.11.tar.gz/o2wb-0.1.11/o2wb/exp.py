...
def main():
    ...
    if(args.mapping):
        print("Please, create a mapping on import.")
    ...
    sparqlResponse = sparqlResponse["results"]["bindings"]

    # print(sparqlResponse)
    if sparqlResponse == []:
        print("No results got from SPARQL endpoint. Make sure that the endpoint is updated with new changes.")
