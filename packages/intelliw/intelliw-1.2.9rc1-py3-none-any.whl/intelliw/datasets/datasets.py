...
LastEditTime: 2022-12-26 11:05:01
LastEditors: Hexu
Description: 数据集
...
def get_datasource_writer(output_addr: str) -> AbstractDataSourceWriter:
    ...
    if output_datasource_type == DST.EMPTY:
        ...
        return DataSourceWriter(source_addr=output_addr, source_id=config.OUTPUT_DATA_SOURCE_ID, writer_type=output_datasource_type)
    else:
