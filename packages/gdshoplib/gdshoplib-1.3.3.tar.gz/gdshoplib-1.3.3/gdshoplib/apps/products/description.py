...
class ProductDescription:
    ...
    def get_description_block(self, platform_key=None):
        ...
        if platform_key:
            return self._description_blocks.get(f"description:{platform_key.lower()}")
        return self._description_blocks.get("description")
