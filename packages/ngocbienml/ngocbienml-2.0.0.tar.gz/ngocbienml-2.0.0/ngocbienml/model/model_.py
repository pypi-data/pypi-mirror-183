...
from ngocbienml.visualization.plot import Plot
from sklearn.model_selection import train_test_split
from ngocbienml.utils.utils_ import *
from ngocbienml.metrics.metrics_ import binary_score, multiclass_score
...
class Model(GeneralModel):
    ...
    def feat_selection(self):
        ...
        if self.name == 'lr':
            self.data.columns = [col + '*_' + str(i) for col, i in
                                 zip(self.data.columns, range(len(self.data.columns)))]
            self.std_selection()
