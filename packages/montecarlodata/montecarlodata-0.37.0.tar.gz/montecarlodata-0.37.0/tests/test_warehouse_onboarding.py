...
class WarehouseOnBoardingTest(TestCase):
    ...
    def test_redshift_flow(self, onboard_mock):
        expected_options = {**{'connectionType': 'redshift', 'warehouseType': 'redshift'}, **_SAMPLE_BASE_OPTIONS}
    ...
    def test_snowflake_flow_with_private_key(self, read_as_base64_mock, onboard_mock):
        ...
        expected_options = {
            **{'warehouseType': 'snowflake', 'private_key': base64_private_key.decode()}, **_SAMPLE_BASE_OPTIONS}
    ...
    @patch.object(WarehouseOnboardingService, 'onboard')
    @patch('montecarlodata.integrations.onboarding.warehouse.warehouses.read_as_base64')
    def test_snowflake_flow_with_private_key_and_passphrase(self, read_as_base64_mock, onboard_mock):
        file_path = '/tmp/my_private_key'
        private_key = 'private_key'
        passphrase = 'foobar123'
        base64_private_key = base64.b64encode(private_key.encode('utf-8'))
        input_options = {'private_key': file_path, 'private_key_passphrase': passphrase, **_SAMPLE_BASE_OPTIONS}
    ...
    def test_bq_flow(self, read_as_base64_mock, onboard_mock):
        ...
        expected_options = {
            **{'warehouseType': 'bigquery', 'serviceJson': base64_service_json.decode()}, **_SAMPLE_BASE_OPTIONS}
