...
from montecarlodata.integrations.onboarding.fields import EXPECTED_FIVETRAN_RESPONSE_FIELD, \
    EXPECTED_ADD_CONNECTION_RESPONSE_FIELD, FIVETRAN_CONNECTION_TYPE
...
class FivetranOnboardingService(BaseOnboardingService):
    ...
    def onboard_fivetran(self, **kwargs) -> None:
        self.onboard(validation_query=TEST_FIVETRAN_CRED_MUTATION,
                     ...
                     connection_type=FIVETRAN_CONNECTION_TYPE, **kwargs)