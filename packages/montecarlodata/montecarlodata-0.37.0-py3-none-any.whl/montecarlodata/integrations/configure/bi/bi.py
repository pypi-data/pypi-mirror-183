...
class BiService:
    ...
    def refresh_bi_to_warehouse_connections(self, bi_container_id: str, warehouse_source_details: List[Dict]) -> None:
        if warehouse_source_details:
            warehouse_source_details = [self._request_wrapper.convert_snakes_to_camels(wsd) for wsd in
            ...
            match_success = response.get(MATCH_AND_CREATE_BI_WH_SRC_GQL_RESPONSE_FIELD, {})\
