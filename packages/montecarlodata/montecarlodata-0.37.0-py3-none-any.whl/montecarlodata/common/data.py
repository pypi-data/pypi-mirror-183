...
class ResourceProperties:
    ...
    def serializable(self):
        ...
        return {
            key: getattr(self, key) for key in serialize_keys
        }
...
class EventProperties:
    ...
    def __post_init__(self):
        self.event_queue_name = AWSArn(self.event_queue_arn).resource if self.event_queue_arn else None
    ...
    def serializable(self):
        ...
        serializable_dict['resource_properties'] = [resource.serializable() for resource in self.resource_properties]
