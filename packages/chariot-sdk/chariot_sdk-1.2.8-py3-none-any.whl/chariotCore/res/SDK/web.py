...
#
####
_rest_server = FastAPI(title="千乘插件API接口", version="1.2.8", description="")
...
async def triggers(trigger_name: str, plugin_stdin: typing.Optional[models.PLUGIN_TEST_MODEL]):
    ...
    trigger_process = multiprocessing.Process(target=trigger._run,args=(input_data, connection_data, dispatcher_url,cache_url,))
...
async def alarm_receivers(alarm_receiver_name: str, plugin_stdin: typing.Optional[models.PLUGIN_TEST_MODEL]):
    ...
    alarm_receiver_process = multiprocessing.Process(target=alarm_receiver._run,args=(input_data, connection_data, dispatcher_url,cache_url,))
...
async def alarm_receivers_test(alarm_receiver_name: str, plugin_stdin: typing.Optional[models.PLUGIN_TEST_MODEL]=None):
    """
    #   告警接收器连接器测试接口
    """ 
    clearLog(clear_size=1)
...
async def indicator_receivers(indicator_receiver_name: str, plugin_stdin: typing.Optional[models.PLUGIN_TEST_MODEL]):
    ...
    indicator_receiver_process = multiprocessing.Process(target=indicator_receiver._run,args=(input_data, connection_data, dispatcher_url,cache_url,))
...
async def indicator_receivers_test(indicator_receiver_name: str, plugin_stdin: typing.Optional[models.PLUGIN_TEST_MODEL]=None):
    """
    #   情报接收器连接器测试接口
    """  
    clearLog(clear_size=1)
