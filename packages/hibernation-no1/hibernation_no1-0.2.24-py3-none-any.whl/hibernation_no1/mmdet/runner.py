...
class Runner:
    ...
    def __init__(self,
        ...
        self.iterd_per_epochs = iterd_per_epochs
        ...
        if self._max_epochs is not None:     
            ...
            self._max_epochs = self._max_iters // self.iterd_per_epochs
    ...
    def val(self, val_dataloader, **kwargs):     
        ...
        log_str = f"epoch: [{self.epoch}|{self.max_epochs}],    iter: [{self._inner_iter}|{self.iterd_per_epochs}]    "
