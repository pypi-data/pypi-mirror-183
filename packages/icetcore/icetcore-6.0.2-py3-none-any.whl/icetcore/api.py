...
class TCoreAPI():
    def __init__(self,eventclass=None) -> None:
        ...
        self.quoteobj=None
    #连线
    def connect(self,appid="AlgoMaster2DEV",servicekey="8076c9867a372d2a9a814ae710c256e2"):
    ...
    def symbollookup(self, findkey:str,symboltype=""):
        if self.quoteobj.eventobj.symblookready:
            return self.quoteobj.symbollookup(symboltype, findkey)
    #指定时间，对应合约是否为假日
