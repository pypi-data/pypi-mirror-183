...
class BaseEvents(metaclass=ABCMeta):
    ...
    # #@abstractmethod
    # def onsymbolhistory(self,symboltype,symboldate,symboldict):
    #     self.extendevent.onsymbolhistory(symboltype,symboldate,symboldict)
    #@abstractmethod
    def onpositionmoniter(self,data):
        if self.extendevent:
    ...
    def OnFilledReport(self, strReportID):
        self.onfilledreportreal(self.tradeapi.getreportbyid(strReportID))
...
class TradeClass:
    ...
    def getactiveorder(self):
        try:
            ...
            self.GetReportData(1,"",ReportItems)
    ...
    def getfilledreport(self):
        try:
            ...
            for i in range(ReportItems.Count):
                fillreportdict=self.getreportbyid(ReportItems.GetReportID(i))
    ...
    def getreportbyid(self,ReportID):
        try:
            pythoncom.CoInitialize()
            ExecutionReportItem=client.Dispatch('{C4D0CDB7-8F21-4752-AF97-025ADC7B7FD9}')#{C4D0CDB7-8F21-4752-AF97-025ADC7B7FD9}
            ...
            "FilledOrdersCount":ExecutionReportItem.FilledOrdersCount,
