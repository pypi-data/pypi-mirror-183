...
['infoml',
 'infoml.binf',
 'infoml.bmes.ahmet',
 'infoml.bmes.ahmet.binf',
 'infoml.bmes.ahmet.oldfiles',
 'infoml.bmes.ahmet.qsb',
 'infoml.hcitools.hcitools']
...
{'': ['*'],
 'infoml': ['hcitools/*',
            'hcitools/.vscode/*',
            'hcitools/docs/*',
            'hcitools/docs/assets/*',
            'hcitools/docs/examples/*',
            'hcitools/docs/hcitools/*',
            'hcitools/scripts/*'],
 'infoml.bmes.ahmet': ['@bmes/*', 'cbe/*', 'ta/*', 'temp/*'],
 'infoml.bmes.ahmet.qsb': ['copy of some presentations .DELETE LATER/*',
                           'keggdemo/*',
                           'temp/*'],
 'infoml.hcitools.hcitools': ['datasets/*']}
