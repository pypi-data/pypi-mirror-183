...
if not packagebuild: # auxilarary packages in this project default to packagebuild = True, because the projcet is not currently meant for use as a dependency. If you feel inclined to use it as a dependency for other projects feel free to leave a issue at the repo!
    import bootstrap
    bootstrap.main()
