...
from netbox_data_disk.fields import NetworkField, AddressField
from netbox_data_disk.utilities import arpa_to_prefix
...
class NameServer(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_data_disk:nameserver", kwargs={"pk": self.pk})
...
class Zone(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_data_disk:zone", kwargs={"pk": self.pk})
...
class Record(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_data_disk:record", kwargs={"pk": self.id})
...
class View(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_data_disk:view", kwargs={"pk": self.id})
