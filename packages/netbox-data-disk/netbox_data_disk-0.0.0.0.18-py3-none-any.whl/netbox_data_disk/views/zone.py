...
from netbox_data_disk.filters import ZoneFilter, RecordFilter
from netbox_data_disk.forms import (
    ZoneImportForm,
    ZoneForm,
    ZoneFilterForm,
    ZoneBulkEditForm,
)
from netbox_data_disk.models import Record, Zone
from netbox_data_disk.tables import (
    ZoneTable,
    RecordTable,
    ManagedRecordTable,
)
...
class ZoneEditView(generic.ObjectEditView):
    ...
    form = ZoneForm
    default_return_url = "plugins:netbox_data_disk:zone_list"
...
class ZoneRecordListView(generic.ObjectChildrenView):
    ...
    template_name = "netbox_data_disk/zone/record.html"
    hide_if_empty = True

    tab = ViewTab(
        label="Records",
        permission="netbox_data_disk.view_record",
...
class ZoneManagedRecordListView(generic.ObjectChildrenView):
    ...
    filterset = RecordFilter
    template_name = "netbox_data_disk/zone/managed_record.html"
    actions = ("changelog",)
