...
from netbox_data_disk.filters import NameServerFilter, ZoneFilter
...
from netbox_data_disk.models import Zone, NameServer
from netbox_data_disk.tables import NameServerTable, ZoneTable
...
class NameServerEditView(generic.ObjectEditView):
    queryset = NameServer.objects.all()
    form = NameServerForm
    default_return_url = "plugins:netbox_data_disk:nameserver_list"
