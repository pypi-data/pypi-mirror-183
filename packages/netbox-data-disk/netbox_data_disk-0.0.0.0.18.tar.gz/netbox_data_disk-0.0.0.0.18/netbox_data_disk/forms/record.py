...
from netbox_data_disk.models import View, Zone, Record, RecordTypeChoices, RecordStatusChoices
...
class RecordBulkEditForm(NetBoxModelBulkEditForm):
    ...
    zone = DynamicModelChoiceField(
        ...
        required=False,
        widget=APISelect(
            attrs={"data-url": reverse_lazy("plugins-api:netbox_data_disk-api:zone-list")}
        ),
    )
