...
package_data = \
{'': ['*'],
 'netbox_data_disk': ['project-static/*',
                      'project-static/dist/*',
                      'project-static/src/*',
                      'static/netbox_secretstore/*',
                      'templates/netbox_secretstore/*',
                      'templates/netbox_secretstore/buttons/*',
                      'templates/netbox_secretstore/inc/*']}
