...
from netbox_data_disk.models import Secret, SecretRole, SessionKey, UserKey


class SecretsTestMixin:
    view_namespace = 'plugins-api:netbox_data_disk'
...
class GetSessionKeyTest(APITestCase):
    ...
    def test_get_session_key(self):
        ...
        url = reverse('plugins-api:netbox_data_disk-api:get-session-key-list')
        data = {
    ...
    def test_get_session_key_preserved(self):
        ...
        url = reverse('plugins-api:netbox_data_disk-api:get-session-key-list') + '?preserve_key=True'
        data = {
            'private_key': PRIVATE_KEY,
        }
        response = self.client.post(url, data, **self.header)
