...
from netbox_data_disk.forms import UserKeyForm
from netbox_data_disk.models import UserKey
...
class UserKeyFormTestCase(TestCase):
    ...
    def setUp(self):
        user = create_test_user(
            permissions=[
                'netbox_data_disk.view_secretrole',
                'netbox_data_disk.add_secretrole',
            ]
        )
