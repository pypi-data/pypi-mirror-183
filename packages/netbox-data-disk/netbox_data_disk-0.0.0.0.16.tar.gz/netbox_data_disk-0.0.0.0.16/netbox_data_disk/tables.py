...
from netbox_data_disk.utils.tables import PluginButtonsColumn
...
class SecretRoleTable(BaseTable):
    ...
    secret_count = columns.LinkedCountColumn(
        viewname='plugins:netbox_data_disk:secret_list',
...
class SecretTable(NetBoxTable):
    ...
    tags = columns.TagColumn(
        url_name='plugins:netbox_data_disk:secret_list'
    )
