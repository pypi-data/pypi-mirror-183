...
from netbox_data_disk.api.serializers import (
    ViewSerializer,
    ZoneSerializer,
    NameServerSerializer,
    RecordSerializer,
)
from netbox_data_disk.filters import ViewFilter, ZoneFilter, NameServerFilter, RecordFilter
from netbox_data_disk.models import View, Zone, NameServer, Record


class NetboxDataDiskRootView(APIRootView):
    """
    NetboxDataDisk API root view
    """

    def get_view_name(self):
        return "NetboxDataDisk"
