...
import netbox_data_disk.fields.address
import taggit.managers

from netbox_data_disk.models import RecordTypeChoices
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("extras", "0084_staging"),
        ("netbox_data_disk", "0020_netbox_3_4"),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name="record",
            name="ip_address",
            field=netbox_data_disk.fields.address.AddressField(blank=True, null=True),
        ),
