...
from netbox_data_disk.models import View, Zone, ZoneStatusChoices, NameServer
...
class ZoneForm(NetBoxModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        defaults = settings.PLUGINS_CONFIG.get("netbox_data_disk")
...
class ZoneImportForm(NetBoxModelImportForm):
    ...
    def _get_default_value(self, field):
        _default_values = settings.PLUGINS_CONFIG.get("netbox_data_disk", {})
...
class ZoneBulkEditForm(NetBoxModelBulkEditForm):
    view = DynamicModelChoiceField(
        ...
        label="View",
        widget=APISelect(
            attrs={"data-url": reverse_lazy("plugins-api:netbox_data_disk-api:view-list")}
        ),
    )
    status = forms.ChoiceField(
        choices=add_blank_choice(ZoneStatusChoices),
    ...
    soa_mname = DynamicModelChoiceField(
        ...
        widget=APISelect(
            attrs={
                "data-url": reverse_lazy("plugins-api:netbox_data_disk-api:nameserver-list")
            }
        ),
    )
    soa_rname = CharField(
