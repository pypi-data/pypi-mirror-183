...
from netbox_data_disk.utils.hashers import SecretValidationHasher
from netbox_data_disk.models import Secret, UserKey
from netbox_data_disk.utils.crypto import encrypt_master_key, decrypt_master_key, generate_random_key
...
class UserKeyTestCase(TestCase):
    ...
    def setUp(self):
        self.TEST_KEYS = {}
        key_size = settings.PLUGINS_CONFIG['netbox_data_disk'].get('public_key_size')
    ...
    def test_03_key_sizes(self):
        ...
        """
        rsa = RSA.generate(settings.PLUGINS_CONFIG['netbox_data_disk'].get('public_key_size', 2048) - 256)
