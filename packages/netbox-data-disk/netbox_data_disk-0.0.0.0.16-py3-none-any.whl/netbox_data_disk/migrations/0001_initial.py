    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userkey', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='session_key', to='netbox_data_disk.userkey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='secrets', to='netbox_data_disk.secretrole')),
