...
def secrets_to_nbsecrets(apps, schema_editor):
    try:
        ...
        ctnbsecret = ContentType.objects.get(app_label='netbox_data_disk', model='secret')
        ctnbsecretrole = ContentType.objects.get(app_label='netbox_data_disk', model='secretrole')
        ctnbuserkey = ContentType.objects.get(app_label='netbox_data_disk', model='userkey')
        ctnbsessionkey = ContentType.objects.get(app_label='netbox_data_disk', model='sessionkey')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('netbox_data_disk', '0002_rename_table'),
    ]
