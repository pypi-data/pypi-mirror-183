...
from netbox_data_disk.models import ZoneStatusChoices


def delete_ptr_records_for_inactive_zones(apps, schema_editor):
    logger = logging.getLogger("django")

    Record = apps.get_model("netbox_data_disk", "Record")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("netbox_data_disk", "0014_add_view_description"),
        ("netbox_data_disk", "0015_add_record_status"),
    ]
