...
from netbox_data_disk.filters import RecordFilter
...
from netbox_data_disk.models import Record
from netbox_data_disk.tables import RecordTable, ManagedRecordTable
...
class ManagedRecordListView(generic.ObjectListView):
    ...
    actions = ("export",)
    template_name = "netbox_data_disk/record/managed.html"
...
class RecordEditView(generic.ObjectEditView):
    ...
    form = RecordForm
    default_return_url = "plugins:netbox_data_disk:record_list"
