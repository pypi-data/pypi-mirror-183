...
from netbox_data_disk.models import Record, RecordTypeChoices, Zone
from netbox_data_disk.tables import RelatedRecordTable, RelatedZoneTable
...
class RelatedDNSRecords(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        return self.render(
            "netbox_data_disk/record/related.html",
            extra_context={
...
class RelatedDNSPointerZones(PluginTemplateExtension):
    ...
    def full_width_page(self):
        ...
        return self.render(
            "netbox_data_disk/zone/related.html",
            extra_context={
...
if get_plugin_config("netbox_data_disk", "feature_ipam_integration"):
