...
from netbox_data_disk.choices import FileTypeChoices, CommitTreeChangeTypeChoices
from netbox_data_disk.helpers import get_repository_dir
from utilities.querysets import RestrictedQuerySet

from .abstract import BigIDModel
from netbox_data_disk.utils.rq import remove_queued
...
class Backup(BigIDModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_data_disk:backup', args=[self.pk])
    ...
    def enqueue_if_needed(self):
        from netbox_data_disk.utils.rq import enqueue_if_needed
    ...
    def get_config(self, index='HEAD'):
        from netbox_data_disk.git import repository
