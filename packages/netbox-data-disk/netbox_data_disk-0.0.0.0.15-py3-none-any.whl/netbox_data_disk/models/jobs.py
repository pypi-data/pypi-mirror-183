...
class BackupJob(BigIDModel):
    ...
    def delete(self, using=None, keep_parents=False):
        queue = get_queue('netbox_data_disk.jobs')
    ...
    @property
    def queue(self):
        return get_queue('netbox_data_disk.jobs')
