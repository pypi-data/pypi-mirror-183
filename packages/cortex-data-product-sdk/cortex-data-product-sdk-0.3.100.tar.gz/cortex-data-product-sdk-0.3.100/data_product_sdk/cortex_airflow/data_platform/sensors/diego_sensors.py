...
class DiegoSensor(BaseSensorOperator):
    ...
    def check_completed_execution_id(self, platform_url, execution_id: str):
        url = f"https://{platform_url}/controller/dataloader/cube-load/s3/{execution_id}"
    ...
    def poke(self, context, execution_id=None, platform_url=None, diego_operator=None) -> bool:
        ...
        assert (execution_id and platform_url) or diego_operator, \
