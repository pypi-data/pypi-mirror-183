...
def get_sql_ingest_configs(pm_name, user_name, start_date, schedule_interval,
                           table_name, partition_columns, backfill=False):

    configs_dict = get_configs_dict_from_yaml(yaml_path="base_sql_ingest_config.yaml")
