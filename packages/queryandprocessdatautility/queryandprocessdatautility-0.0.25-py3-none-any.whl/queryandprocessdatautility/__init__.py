    ...
    def getQueryData(self, jsonData=None, isWebsocet=None):
        try:
            ...
            if 'dbDetails' in self.calculationData.keys() and self.calculationData.get('dbDetails') != None:
                if 'dataSourceType' in self.calculationData['dbDetails'] and self.calculationData.get('dbDetails')['dataSourceType'] != None:
                    self.dataSourceType = self.calculationData['dbDetails']['dataSourceType']
