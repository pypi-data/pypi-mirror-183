...
class GetOneCrmLeadResponseBody:
    lead: Optional[shared.Lead] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lead') }})
    

@dataclass
class GetOneCrmLeadRequest:
    query_params: GetOneCrmLeadQueryParams = field()
...
class GetOneCrmLeadResponse:
    ...
    response_body: Optional[GetOneCrmLeadResponseBody] = field(default=None)
