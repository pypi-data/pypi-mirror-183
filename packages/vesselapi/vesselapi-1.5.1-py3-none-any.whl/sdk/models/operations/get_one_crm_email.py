...
class GetOneCrmEmailResponseBody:
    email: Optional[shared.Email] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('email') }})
    

@dataclass
class GetOneCrmEmailRequest:
    query_params: GetOneCrmEmailQueryParams = field()
...
class GetOneCrmEmailResponse:
    ...
    response_body: Optional[GetOneCrmEmailResponseBody] = field(default=None)
