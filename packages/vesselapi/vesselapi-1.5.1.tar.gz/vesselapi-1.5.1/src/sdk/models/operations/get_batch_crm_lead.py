...
class GetBatchCrmLeadResponseBody:
    ...
    leads: Optional[list[shared.Lead]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('leads') }})
    

@dataclass
class GetBatchCrmLeadRequest:
    query_params: GetBatchCrmLeadQueryParams = field()
...
class GetBatchCrmLeadResponse:
    ...
    response_body: Optional[GetBatchCrmLeadResponseBody] = field(default=None)
