...
class Simulation():
    ...
    def simulation(self):
        # step 1 correct errors using SRRec
...
#     input_file = "/home/pping/Data/Repo/data/srrec_data/group3/SAS-Cov-2/srrec_result/new_no_ml/output/umi_simulated_raw_original_sars_r1_corrected_correct.fastq"
#     sim = Simulation(logger, 30, )

#     raw_data, true_data = sim.error_injection(input_file)
#     output_dir = "/home/pping/Data/Repo/data/srrec_data/group3/SAS-Cov-2/"
#     DP = DataProcessing( 
#         logger,
#         num_workers=30,
