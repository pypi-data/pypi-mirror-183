...
def custom_logger(root_name, debug_mode) -> logging.Logger:
    ...
    # # Output full log
    # file_handler = logging.FileHandler('SRRec.log')
    ...
    # # Output warning log
    # file_handler = logging.FileHandler('SRRec.Warning.log')
    ...
    # # Output error log
    # file_handler = logging.FileHandler('SRRec.Error.log')
...
def usage():
    ...
    print("     SRRec -m|--module <module_name> -c <path_configuration_file>")
    print("   Mandatary:")
    print("     -c|--config                   input configuration file")
    # print(" ")
    print("2. Using command line with the default parameters")
    print("     SRRec -m|--module <module_name> -i <path_raw_data.fastq|fasta|fa|fq>")
    print("   Mandatary:")
...
if __name__ == "__main__":
    # input_file = '/home/pping/Data/Repo/data/srrec_data/group1/raw/new_tcr.seq.real_SRR1543964.fastq'
