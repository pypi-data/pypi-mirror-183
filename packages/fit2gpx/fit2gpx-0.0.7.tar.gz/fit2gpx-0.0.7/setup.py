...
setuptools.setup(
    ...
    version="0.0.7",                        # Version - Initial release - README Updated
    ...
    download_url='https://github.com/dodo-saba/fit2gpx/archive/refs/tags/v0.0.7.tar.gz', # Package downloaded from GitHub
