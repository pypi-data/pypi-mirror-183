...
class ActorMotionComponentServer(BaseComponent):
    ...
    def AddEntityTrackMotion(self, targetPos, duraTime, startPos=None, relativeCoord=False, isLoop=False):
        # type: (Tuple[float,float,float], float, Tuple[float,float,float], bool, bool) -> int
        """
        给实体（不含玩家）添加轨迹运动器
        """
        pass
    ...
    def AddEntityAroundEntityMotion(self, eID, angularVelocity, axis=(0, 1, 0), lockDir=False, stopRad=0):
        # type: (str, float, Tuple[float,float,float], bool, float) -> int
        """
        给实体（不含玩家）添加对实体环绕运动器
        """
        pass
    ...
    def AddPlayerTrackMotion(self, targetPos, duraTime, startPos=None, relativeCoord=False, isLoop=False):
        # type: (Tuple[float,float,float], float, Tuple[float,float,float], bool, bool) -> int
        """
        给玩家添加轨迹运动器
        """
    ...
    def AddPlayerAroundEntityMotion(self, eID, angularVelocity, axis=(0, 1, 0), lockDir=False, stopRad=0):
        # type: (str, float, Tuple[float,float,float], bool, float) -> int
        """
        给玩家添加对实体环绕运动器
        """
