...
class OctadocsMixin(BasePlugin):   # type: ignore   # noqa: WPS338, WPS214
    ...
    def _add_files(self, config: Config):
        ...
        default_context = _construct_default_context(config)
        extra['default_context'] = default_context
    ...
    def _compute_urls(self, navigation: Navigation):
        ...
        urls_file = self.docs_dir.parent / '.cache/urls.json'
        ...
        self.iolanta.add(
            url=path_to_url(urls_file),
            graph_iri=URIRef(
                'https://iolanta-tech.github.io/mkdocs-iolanta/urls',
            ),
        )
