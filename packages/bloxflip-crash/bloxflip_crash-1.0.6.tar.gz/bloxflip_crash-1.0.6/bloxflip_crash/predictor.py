class predict:
    ...
    def __init__(self, amount):
        ...
        self.model = predict.MLPRegressor(hidden_layer_sizes=(10, 10), max_iter=1000, learning_rate='adaptive', solver='adam')    #  You can change the model to any you want this one here is using an AI (ANN)
