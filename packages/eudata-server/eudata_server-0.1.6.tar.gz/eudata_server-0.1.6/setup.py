...
install_requires = \
['pandas>=1.5.2,<2.0.0', 'requests>=2.28.1,<3.0.0', 'rich>=12.6.0,<13.0.0']

entry_points = \
{'console_scripts': ['dev = eudata_server.server:develop',
                     'prod = eudata_server.server:run',
                     'sslprod = eudata_server.server:run_ssl']}
