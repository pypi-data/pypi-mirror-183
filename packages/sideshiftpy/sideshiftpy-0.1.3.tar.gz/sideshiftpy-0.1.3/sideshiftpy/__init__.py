...
bart = {
    ...
    "xmr": "42XNLYtzYLNDbEN3EgKHVhEEygEnxCokBAiAbk1SHZDCLPQrCCnVyavdtzt6oy4mu1PVhay2wNYVz65sN5bRrUBTF72HAkU",
...
class Sideshift:
    ...
    def create_order(self, order: OrderRequest) -> OrderResponse:
        ...
        recieving_address = bart[order.recieving_method]
        print(recieving_address)
