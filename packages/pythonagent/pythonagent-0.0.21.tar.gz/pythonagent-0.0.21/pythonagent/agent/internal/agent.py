...
class Agent(object):
    ...
    def load_common_lib(self, lib_path):
        ...
        self.lib.nd_bt_end.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.c_int]
    ...
    def sdk_getNDSessionCookie(self, bt):
        return self.lib.sdk_getNDSessionCookie(bt).decode()
    ...
    def end_business_transaction_native(self, bt):
        ...
        rc = self.lib.nd_bt_end(bt, statuscode, ctypes.c_int(0))
