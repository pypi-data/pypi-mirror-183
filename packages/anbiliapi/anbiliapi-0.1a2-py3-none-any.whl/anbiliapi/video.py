...
async def get_video_info(aid: int = None, bvid: str = None):
    ...
    kwargs = {
        ...
        "method": "GET",
        "data": {"aid": aid} if bvid is None else {"bvid": bvid}
    }
...
class Video(Bilibili):
    def __init__(self, credential: Credential, aid: int = None, bid: str = None) -> None:
    ...
    async def coin(self, multiply: int = 1, select_like: bool = True):
        """
        投币
        :param select_like:
        :param multiply:
