...
from typing import TYPE_CHECKING, Any, BinaryIO, List, Optional, Sequence, Tuple, Union
...
if TYPE_CHECKING:
    ...
    from vectice.api.json import AttachmentOutput, DatasetVersionOutput, ProjectOutput, WorkspaceOutput
