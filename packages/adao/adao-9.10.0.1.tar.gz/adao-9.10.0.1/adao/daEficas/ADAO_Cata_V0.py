...
# --------------------------------------------------------
# Generated by AdaoCatalogGenerator on 2022-12-12 12:12:12
# --------------------------------------------------------
...
def F_AlgorithmParameters(statut, algos_names, fv=NoCheckInNS) : return FACT(
    ...
    ParametersSamplingTest = BLOC (condition = " (Parameters == 'Defaults') and (Algorithm == 'SamplingTest') ",
        ...
        SampleAsExplicitHyperCube = SIMP(statut="f", typ="TXM", max="**", into=None, fr="Points de calcul définis par un hyper-cube dont on donne la liste des échantillonnages de chaque variable comme une liste"),
        ...
        SampleAsMinMaxStepHyperCube = SIMP(statut="f", typ="TXM", max="**", into=None, fr="Points de calcul définis par un hyper-cube dont on donne la liste des échantillonnages de chaque variable par un triplet [min,max,step]"),
