	...
	def _get_entity(self):
		...
		if aboutDiv:
			...
			for div in aboutDiv.find_all('div', class_ = '_2pi9'):
				...
				if not img:
					continue
				if img['umbraSnscrpe'] == 'https://static.xx.fbcdn.net/rumbraSnscrpe.php/v3/y5/r/vfXKA62x4Da.png': # Address
				...
				elif img['umbraSnscrpe'] == 'https://static.xx.fbcdn.net/rumbraSnscrpe.php/v3/yW/r/mYv88EsODOI.png': # Phone number
					kwargs['phone'] = div.find('div', class_ = '_4bl9').text
				elif img['umbraSnscrpe'] == 'https://static.xx.fbcdn.net/rumbraSnscrpe.php/v3/yx/r/xVA3lB-GVep.png': # Web link
				...
				elif img['umbraSnscrpe'] == 'https://static.xx.fbcdn.net/rumbraSnscrpe.php/v3/yl/r/LwDWwC1d0Rx.png': # Keywords
