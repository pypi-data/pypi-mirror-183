...
class AuditLog:
    ...
    async def add_entry(self: AL, toot: dict[str, Any]) -> None:
    ...
    async def _add_plain_entry(self: AL, toot: dict[str, Any]) -> None:
        entry = (
    ...
    async def _add_csv_entry(self: AL, toot: dict[str, Any]) -> None:
