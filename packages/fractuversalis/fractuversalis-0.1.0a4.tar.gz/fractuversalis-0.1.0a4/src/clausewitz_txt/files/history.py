...
class HistoryFile(SortedDict[date, Dict[bytes, any]]):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    @classmethod
    def from_serialized_txt(cls, txt: Dict[bytes | date, List[any] | any], *args, **kwargs) -> 'HistoryFile':
        fl = cls(*args, **kwargs)
    ...
    def to_serialized_txt(self) -> Dict[bytes | date, List[any] | any]:
        d = dict(self)
