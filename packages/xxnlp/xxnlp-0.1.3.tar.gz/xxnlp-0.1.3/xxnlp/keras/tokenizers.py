...
from xxnlp.snippets import is_string, is_py2, open, convert_to_unicode, truncate_sequences, lowercase_and_normalize
from xxnlp.types import Path
...
class Tokenizer(TokenizerBase):
    ...
    def __init__(
        ...
        if is_string(token_dict) or isinstance(token_dict, Path):
...
class SpTokenizer(TokenizerBase):
    ...
    def __init__(self, sp_model_path, **kwargs):
        ...
        if isinstance(sp_model_path, Path):
            sp_model_path = sp_model_path.absolute().as_posix()
