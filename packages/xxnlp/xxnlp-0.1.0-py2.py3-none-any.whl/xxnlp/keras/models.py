...
import numpy as np
from xxnlp.backend import get_available_gpus
from xxnlp.layers import *
from xxnlp.snippets import insert_arguments
from xxnlp.snippets import delete_arguments
from xxnlp.snippets import is_string, string_matching
from xxnlp.snippets import orthogonally_resize
from xxnlp.types import *
from keras.models import Model
from transformers import TFGPT2LMHeadModel as TFGPT2
import json

class TFGPT2LMHeadModel(TFGPT2):
    pass
    ...
    **kwargs
    ...
    if checkpoint_path is not None:
        if isinstance(checkpoint_path, Path):
            checkpoint_path = checkpoint_path.absolute().as_posix()
