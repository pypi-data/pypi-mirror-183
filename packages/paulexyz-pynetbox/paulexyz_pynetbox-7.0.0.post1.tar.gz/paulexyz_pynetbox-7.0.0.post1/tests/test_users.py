...
class Generic:
    class Tests(unittest.TestCase):
        name = ""
        ret = paulexyz_pynetbox.core.response.Record
        app = "users"
...
class UsersTestCase(Generic.Tests):
    ...
    def test_repr(self, _):
        test = nb.users.get(1)
        self.assertEqual(type(test), paulexyz_pynetbox.models.users.Users)
...
class UnknownModelTestCase(unittest.TestCase):
    ...
    def test_unknown_model(self, _):
        ...
        self.assertEqual(type(unknown_obj), paulexyz_pynetbox.core.response.Record)
