...
from paulexyz_pynetbox.core.app import App, PluginsApp
from paulexyz_pynetbox.core.response import Record
...
class Api:
    ...
    **Additional Attributes**:
    ...
    def create_token(self, username, password):
        ...
        >>> import paulexyz_pynetbox
        >>> nb = paulexyz_pynetbox.api("https://netbox-server")
