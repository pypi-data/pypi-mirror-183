    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(blank=True, default=None, null=True)),
                ('date_modified', models.DateTimeField(blank=True, default=None, null=True)),
                ('champion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='skins', to='product.champion')),
            ],
            options={
                'verbose_name': 'Skin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(blank=True, default=None, null=True)),
                ('date_modified', models.DateTimeField(blank=True, default=None, null=True)),
                ('all_skins', models.ManyToManyField(blank=True, related_name='all_skins_products', to='product.skin')),
                ('owned_skins', models.ManyToManyField(blank=True, related_name='owned_skin_products', to='product.skin')),
                ('permanent_skins', models.ManyToManyField(blank=True, related_name='permanent_skin_products', to='product.skin')),
                ('skins', models.ManyToManyField(blank=True, to='product.skin')),
            ],
        ),
    ]
