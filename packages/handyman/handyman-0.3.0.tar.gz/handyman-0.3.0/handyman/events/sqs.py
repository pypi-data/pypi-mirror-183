...
from handyman.events.event_types import Events
...
EVENT_MESSAGE_ATTRIBUTES = {}
EVENT_MESSAGE_ATTRIBUTES[Events.WAREHOUSE_CALLS] = {
    'EventType': {
        'StringValue': str(Events.WAREHOUSE_CALLS.value),
        'DataType': 'String'
    }
}
EVENT_MESSAGE_ATTRIBUTES[Events.WAREHOUSE_LEADS] = {
    'EventType': {
        'StringValue': str(Events.WAREHOUSE_LEADS.value),
        'DataType': 'String'
    }
}
EVENT_MESSAGE_ATTRIBUTES[Events.WAREHOUSE_TCN] = {
    'EventType': {
        'StringValue': str(Events.WAREHOUSE_TCN.value),
        'DataType': 'String'
    }
}
...
def get_event_attributes(e_type: Events):
    '''
    Add attributes to events

    :type e_type: Events
    :param e_type: Enum of events.

    :rtype: dict
    :return: Attributes dict
    '''
    global EVENT_MESSAGE_ATTRIBUTES

    if e_type in EVENT_MESSAGE_ATTRIBUTES:
        return EVENT_MESSAGE_ATTRIBUTES[e_type]
        ...
        entries = [
            {
                ...
                'MessageAttributes': get_event_attributes(e_type)
