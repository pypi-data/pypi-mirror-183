...
class Code:
    ...
    def find_code(driver, search: str) -> dict:
        ...
        WebDriverWait(driver, 7).until(EC.presence_of_element_located((By.XPATH, '//*[@data-eventactioncontent]')))
        # Get the response element

        response = driver.find_elements(By.XPATH, '//*[@data-eventactioncontent]')
