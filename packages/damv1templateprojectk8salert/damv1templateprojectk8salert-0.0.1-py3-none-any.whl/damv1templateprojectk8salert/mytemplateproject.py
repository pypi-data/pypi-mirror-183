...
&#128308;<p style="margin:0; padding:0;color:MediumSeaGreen;font-size:18px;display:inline;line-height:10px;">({{value_str_number}})</p><h3 style="margin:0; padding:0;display:inline;line-height:10px;"> :: {{value_str_ns}} :: {{value_str_po}}</h3>
