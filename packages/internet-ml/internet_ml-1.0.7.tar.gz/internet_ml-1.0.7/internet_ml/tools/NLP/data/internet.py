...
class Google:
    def __init__(
        ...
        if (
            ...
            self.__GOOGLE_SEARCH_API_KEY = str(os.environ["INTERNET_ML_GOOGLE_API"])
            self.__GOOGLE_SEARCH_ENGINE_ID = str(
            ...
            self.__GOOGLE_SEARCH_API_KEY = str(variable["INTERNET_ML_GOOGLE_API"])
            self.__GOOGLE_SEARCH_ENGINE_ID = str(
                variable["INTERNET_ML_GOOGLE_SEARCH_ENGINE_ID"]
            )
        self.__num_res: int = (
            5
