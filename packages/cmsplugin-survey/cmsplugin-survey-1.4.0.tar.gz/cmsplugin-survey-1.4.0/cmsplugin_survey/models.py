...
class Answer(models.Model):
    ...
    def percents(self):
        return (
            int(round(self.votes_count * 100.0 / self.question.votes_count))
            if self.question.votes_count
            else 0
        )
...
class Vote(models.Model):
    answer = models.ForeignKey(
        Answer, verbose_name=_("answer"), related_name="votes", on_delete=models.CASCADE
    )
