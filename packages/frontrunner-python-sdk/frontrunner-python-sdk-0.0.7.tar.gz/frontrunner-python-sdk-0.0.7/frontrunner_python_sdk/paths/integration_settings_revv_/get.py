...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RevvSettings']:
            return RevvSettings

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RevvSettings'], typing.List['RevvSettings']],
    ...
    def __getitem__(self, i: int) -> 'RevvSettings':
...
class BaseApi(api_client.Api):
    ...
    def _integration_settings_revv_list_oapg(
        self: api_client.Api,
...
class IntegrationSettingsRevvList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integration_settings_revv_list(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integration_settings_revv_list_oapg(
