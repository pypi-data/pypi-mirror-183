...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PullJob']:
            return PullJob

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PullJob'], typing.List['PullJob']],
    ...
    def __getitem__(self, i: int) -> 'PullJob':
...
class PullJobsList(BaseApi):
    ...
    def pull_jobs_list(
        ...
        return self._pull_jobs_list_oapg(
