...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TwitterSettings']:
            return TwitterSettings

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TwitterSettings'], typing.List['TwitterSettings']],
    ...
    def __getitem__(self, i: int) -> 'TwitterSettings':
...
class BaseApi(api_client.Api):
    ...
    def _integration_settings_twitter_list_oapg(
        self: api_client.Api,
...
class IntegrationSettingsTwitterList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integration_settings_twitter_list(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integration_settings_twitter_list_oapg(
