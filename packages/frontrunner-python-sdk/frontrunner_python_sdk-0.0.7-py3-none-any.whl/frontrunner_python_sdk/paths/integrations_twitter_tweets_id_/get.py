...
class BaseApi(api_client.Api):
    ...
    def _integrations_twitter_tweets_retrieve_oapg(
        self: api_client.Api,
...
class IntegrationsTwitterTweetsRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integrations_twitter_tweets_retrieve(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integrations_twitter_tweets_retrieve_oapg(
