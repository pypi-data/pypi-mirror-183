...
class BaseApi(api_client.Api):
    ...
    def _integrations_twitter_tweets_destroy_oapg(
        self: api_client.Api,
...
class IntegrationsTwitterTweetsDestroy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integrations_twitter_tweets_destroy(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        ...
        return self._integrations_twitter_tweets_destroy_oapg(
