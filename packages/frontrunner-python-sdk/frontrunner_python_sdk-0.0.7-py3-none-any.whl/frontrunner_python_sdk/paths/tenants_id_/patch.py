...
# body param
SchemaForRequestBodyApplicationJson = TenantRequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TenantRequest
SchemaForRequestBodyMultipartFormData = TenantRequest


request_body_tenant_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Tenant
...
class BaseApi(api_client.Api):
    ...
    def _tenants_partial_update_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tenant_request.serialize(body, content_type)
...
class TenantsPartialUpdate(BaseApi):
    ...
    def tenants_partial_update(
        ...
        return self._tenants_partial_update_oapg(
            body=body,
