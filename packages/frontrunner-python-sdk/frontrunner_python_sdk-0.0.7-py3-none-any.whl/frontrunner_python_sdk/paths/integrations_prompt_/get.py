...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Broadcast']:
            return Broadcast

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Broadcast'], typing.List['Broadcast']],
    ...
    def __getitem__(self, i: int) -> 'Broadcast':
...
class BaseApi(api_client.Api):
    ...
    def _integrations_prompt_list_oapg(
        self: api_client.Api,
...
class IntegrationsPromptList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integrations_prompt_list(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integrations_prompt_list_oapg(
