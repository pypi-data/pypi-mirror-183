...
# **api_token_create**
> AuthToken api_token_create(username, password)
...
with frontrunner_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = frontrunner_python_sdk.ApiApi(api_client)
    username = 'username_example' # str | 
password = 'password_example' # str | 

    try:
        api_response = api_instance.api_token_create(username, password)
        pprint(api_response)
