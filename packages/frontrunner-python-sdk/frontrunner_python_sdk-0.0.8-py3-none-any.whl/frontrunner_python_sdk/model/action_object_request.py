        ...
        def discriminator():
            return {
                'class_name': {
                    ...
                    'Campaign': CampaignActionRequest,
                    'CampaignActionRequest': CampaignActionRequest,
                    'Person': PersonActionRequest,
                    'PersonActionRequest': PersonActionRequest,
                    'TenantUserProfile': UserProfileActionRequest,
                    'Tweet': TweetActionRequest,
                    'TweetActionRequest': TweetActionRequest,
                    'Tweeter': TweeterActionRequest,
                    'TweeterActionRequest': TweeterActionRequest,
