...
SchemaFor200ResponseBodyApplicationJson = TenantUserPart
...
class BaseApi(api_client.Api):
    ...
    def _abbreviated_users_retrieve_oapg(
        self: api_client.Api,
...
class AbbreviatedUsersRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def abbreviated_users_retrieve(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._abbreviated_users_retrieve_oapg(
