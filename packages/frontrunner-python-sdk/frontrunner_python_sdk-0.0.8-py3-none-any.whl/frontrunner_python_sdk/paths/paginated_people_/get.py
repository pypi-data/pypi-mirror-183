...
SchemaFor200ResponseBodyApplicationJson = PaginatedPersonList
...
class BaseApi(api_client.Api):
    ...
    def _paginated_people_list_oapg(
        self: api_client.Api,
...
class PaginatedPeopleList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def paginated_people_list(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._paginated_people_list_oapg(
