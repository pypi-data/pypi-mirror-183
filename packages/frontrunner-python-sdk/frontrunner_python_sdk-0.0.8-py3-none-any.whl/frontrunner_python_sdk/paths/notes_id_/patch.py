...
# body param
SchemaForRequestBodyApplicationJson = NoteCreateUpdateRequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = NoteCreateUpdateRequest
SchemaForRequestBodyMultipartFormData = NoteCreateUpdateRequest


request_body_note_create_update_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Note
...
class BaseApi(api_client.Api):
    ...
    def _notes_partial_update_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_note_create_update_request.serialize(body, content_type)
...
class NotesPartialUpdate(BaseApi):
    ...
    def notes_partial_update(
        ...
        return self._notes_partial_update_oapg(
            body=body,
