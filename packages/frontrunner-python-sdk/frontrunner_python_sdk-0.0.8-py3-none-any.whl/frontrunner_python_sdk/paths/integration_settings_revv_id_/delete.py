...
class BaseApi(api_client.Api):
    ...
    def _integration_settings_revv_destroy_oapg(
        self: api_client.Api,
...
class IntegrationSettingsRevvDestroy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integration_settings_revv_destroy(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        ...
        return self._integration_settings_revv_destroy_oapg(
