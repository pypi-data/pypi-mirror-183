...
class BaseApi(api_client.Api):
    ...
    def _integration_settings_revv_retrieve_oapg(
        self: api_client.Api,
...
class IntegrationSettingsRevvRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integration_settings_revv_retrieve(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integration_settings_revv_retrieve_oapg(
