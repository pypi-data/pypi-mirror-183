...
class PersonActionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["class_name", "first_name", "last_name", "dob", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["class_name", "first_name", "last_name", "dob", ], str]):
