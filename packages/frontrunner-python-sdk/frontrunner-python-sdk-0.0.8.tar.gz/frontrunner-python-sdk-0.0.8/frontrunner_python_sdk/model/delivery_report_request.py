...
class DeliveryReportRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["delivered", "queued", "waiting", "errors", "replied", "opt_outs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["delivered", "queued", "waiting", "errors", "replied", "opt_outs", ], str]):
