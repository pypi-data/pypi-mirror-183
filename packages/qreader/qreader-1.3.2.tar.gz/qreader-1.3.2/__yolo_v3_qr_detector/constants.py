...
YOLO_CONFIG_PATH = os.path.join(os.path.dirname(__file__), "qrcode-yolov3-tiny.cfg")
YOLO_WEIGHTS_PATH = os.path.join(os.path.dirname(__file__), "qrcode-yolov3-tiny_last.weights")
