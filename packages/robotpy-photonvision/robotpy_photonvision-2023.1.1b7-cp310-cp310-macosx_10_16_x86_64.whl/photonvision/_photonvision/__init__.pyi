...
class PhotonCamera():
    ...
    def _driverModeSubscriber(self) -> ntcore._ntcore.BooleanSubscriber:
        ...
        """
    @property
    def _inputSaveImgEntry(self) -> ntcore._ntcore.BooleanPublisher:
        """
        :type: ntcore._ntcore.BooleanPublisher
        """
    @property
    ...
    def _mainTable(self) -> ntcore._ntcore.NetworkTable:
        ...
        """
    @property
    def _outputSaveImgEntry(self) -> ntcore._ntcore.BooleanPublisher:
        """
        :type: ntcore._ntcore.BooleanPublisher
        """
    @property
...
class RobotPoseEstimator():
    ...
    """
    def __init__(self, aprilTags: typing.Dict[int, wpimath.geometry._geometry.Pose3d], strategy: PoseStrategy, param2: typing.List[typing.Tuple[PhotonCamera, wpimath.geometry._geometry.Transform3d]]) -> None: ...
