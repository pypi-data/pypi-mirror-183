...
class CustomGraphicsView(QGraphicsView):
    ...
    def mouseMoveEvent(self, event: QMouseEvent):
        ...
        if (event.buttons() & Qt.MouseButton.LeftButton) or (self.state.current_tool is not None and self.state.current_tool.should_auto_scroll_with_left_button_released()):
