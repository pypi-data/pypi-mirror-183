...
from maphis.common.label_change import LabelChange, DoType, CommandEntry, CommandKind
...
from maphis.label_editor.label_layer import LabelLayer
...
class LabelEditor(QObject):
    ...
    def _handle_primary_label_changed(self, label: int, old_label: int):
        ...
        if label > 0:
            ...
            if label_level_to_visualize != old_label_level:
