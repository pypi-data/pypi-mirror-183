#  TCgram - Telegram MTProto API Client Library for Python
#  Copyright (C) 2017-present Dan <https://github.com/delivrance>
#
#  This file is part of TCgram.
#
#  TCgram is free software: you can redistribute it and/or modify
#  it under the terms of the GNU Lesser General Public License as published
#  by the Free Software Foundation, either version 3 of the License, or
#  (at your option) any later version.
#
#  TCgram is distributed in the hope that it will be useful,
#  but WITHOUT ANY WARRANTY; without even the implied warranty of
#  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
#  GNU Lesser General Public License for more details.
#
#  You should have received a copy of the GNU Lesser General Public License
#  along with TCgram.  If not, see <http://www.gnu.org/licenses/>.
...
from TCgram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "TCgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~TCgram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~TCgram.handlers.MessageHandler` the *update* argument will be a :obj:`~TCgram.types.Message`; in a :obj:`~TCgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~TCgram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~TCgram.filters.command` or :meth:`~TCgram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~TCgram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~TCgram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~TCgram.types.Message`.
    ...
    async def func(flt, client: TCgram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~TCgram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~TCgram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~TCgram.types.InlineQuery`: The filter will match ``query``.
