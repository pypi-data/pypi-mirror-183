...
import TCgram
from TCgram import __version__, __license__
from TCgram import enums
from TCgram import raw
from TCgram import utils
from TCgram.crypto import aes
from TCgram.errors import CDNFileHashMismatch
from TCgram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest
)
from TCgram.handlers.handler import Handler
from TCgram.methods import Methods
from TCgram.session import Auth, Session
from TCgram.storage import FileStorage, MemoryStorage
from TCgram.types import User, TermsOfService
from TCgram.utils import ainput
...
class Client(Methods):
    """TCgram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~TCgram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where TCgram will store the session files.
    ...
    APP_VERSION = f"TCgram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to TCgram (version {__version__})")
        print(f"TCgram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~TCgram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.TCgram.org/start/auth")
        ...
        try:
            ...
            if isinstance(r, raw.types.upload.File):
                ...
                try:
                    ...
                    raise e
        except TCgram.StopTransmission:
            raise
        except Exception as e:
            log.exception(e)
