...
import TCgram
from TCgram.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~TCgram.Client.start`, :meth:`~TCgram.idle` and :meth:`~TCgram.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`TCgram.compose`.
