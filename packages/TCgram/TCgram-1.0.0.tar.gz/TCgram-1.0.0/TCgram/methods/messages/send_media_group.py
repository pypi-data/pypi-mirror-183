...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~TCgram.types.InputMediaPhoto`, :obj:`~TCgram.types.InputMediaVideo`, :obj:`~TCgram.types.InputMediaAudio` and :obj:`~TCgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~TCgram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from TCgram.types import InputMediaPhoto, InputMediaVideo
