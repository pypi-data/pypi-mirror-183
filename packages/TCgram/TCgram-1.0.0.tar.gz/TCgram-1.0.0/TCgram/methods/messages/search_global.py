...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~TCgram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~TCgram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~TCgram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "TCgram". Get the first 50 results
                async for message in app.search_global("TCgram", limit=50):
                    print(message.text)
