...
import TCgram
from TCgram import StopTransmission, enums
from TCgram import raw
from TCgram import types
from TCgram import utils
from TCgram.errors import FilePartMissing
from TCgram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~TCgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~TCgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~TCgram.Client.stop_transmission`, None is returned.
