...
import TCgram
from TCgram import raw, enums
from TCgram import types
from TCgram import utils
from TCgram.errors import MessageIdsEmpty, PeerIdInvalid
from TCgram.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~TCgram.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~TCgram.types.Chat`, *optional*):
        ...
        chat (:obj:`~TCgram.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~TCgram.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~TCgram.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~TCgram.types.Message`, *optional*):
        ...
        service (:obj:`~TCgram.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~TCgram.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~TCgram.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~TCgram.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~TCgram.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~TCgram.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~TCgram.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~TCgram.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~TCgram.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~TCgram.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~TCgram.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~TCgram.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~TCgram.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~TCgram.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~TCgram.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~TCgram.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~TCgram.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~TCgram.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~TCgram.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~TCgram.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~TCgram.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~TCgram.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~TCgram.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~TCgram.types.GameHighScore`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <TCgram.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~TCgram.filters.command`.

        video_chat_scheduled (:obj:`~TCgram.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~TCgram.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~TCgram.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~TCgram.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~TCgram.types.WebAppData`, *optional*):
            Service message: web app data sent to the bot.

        reply_markup (:obj:`~TCgram.types.InlineKeyboardMarkup` | :obj:`~TCgram.types.ReplyKeyboardMarkup` | :obj:`~TCgram.types.ReplyKeyboardRemove` | :obj:`~TCgram.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~TCgram.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            List of :obj:`~TCgram.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            ...
            parse_mode (:obj:`~TCgram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            entities (List of :obj:`~TCgram.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~TCgram.types.MessageEntity`):
        ...
        Returns:
            On success, the sent :obj:`~TCgram.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~TCgram.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~TCgram.types.Message`.

        Use as a shortcut for:

        .. code-block:: python

            from TCgram import enums
        ...
        Parameters:
            action (:obj:`~TCgram.enums.ChatAction`):
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~TCgram.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~TCgram.types.InputMediaPhoto` or
                :obj:`~TCgram.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~TCgram.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~TCgram.enums.PollType`, *optional*):
                Poll type, :obj:`~TCgram.enums.PollType.QUIZ` or :obj:`~TCgram.enums.PollType.REGULAR`.
                Defaults to :obj:`~TCgram.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~TCgram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~TCgram.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~TCgram.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~TCgram.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~TCgram.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~TCgram.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            media (:obj:`~TCgram.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~TCgram.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~TCgram.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~TCgram.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~TCgram.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            :obj:`~TCgram.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~TCgram.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~TCgram.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~TCgram.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            :obj:`~TCgram.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~TCgram.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            :obj:`~TCgram.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~TCgram.types.Message`.
        ...
        Returns:
            :obj:`~TCgram.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~TCgram.types.Message`.
