...
import TCgram
from TCgram import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~TCgram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~TCgram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~TCgram.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~TCgram.types.EmojiStatus`, *optional*):
            Emoji status.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~TCgram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~TCgram.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~TCgram.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~TCgram.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~TCgram.types.User`.
