...
class Object:
    def __init__(self, client: "TCgram.Client" = None):
        self._client = client

    def bind(self, client: "TCgram.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~TCgram.types.Client`):
