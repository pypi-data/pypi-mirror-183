...
class TextWrap():
    ...
    def render_text(self, text):
        ...
        for paragraph in nodes:
            lines = self.wrapper.wrap_nodes_to_lines(paragraph)
            rv = rv + lines
    ...
    def split_and_wrap(self, text):
        ...
        for i, nodes in enumerate(paragraphs):
            paragraphs[i] = self.wrapper.wrap_nodes(nodes)
        return paragraphs
    ...
    def render_image(self, text, img=None, where=(0,0), margin=(0,0,0,0), fg=(0,0,0,255), bg=(255,255,255,255)):
        ...
        for paragraph in paragraphs:
            self._render_image_part(paragraph, img, where=(v_origin, h_origin), fg=fg)
    ...
    def _render_image_part(self, lines, img, where=(0,0), fg=(0,0,0,255)):
