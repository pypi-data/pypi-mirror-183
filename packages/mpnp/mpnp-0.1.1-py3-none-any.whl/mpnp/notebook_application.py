...
class Vax_App( ):
    ...
    def __init__( self, file_name = None, X = None, y = None, X_emb = None, x_name = None ):
        ...
        self.svg_args = { 'draw_row_labels' : True, 'draw_col_labels' : True, 'draw_rows_line' : False, 'draw_cols_line' : False, 'col_label_degrees' : 15, 'draw_box_frame' : False, 'inner_pad_row' : 5, 'inner_pad_col' : 5, 'cell_background' : 'all', 'cell_background_color' : '#f2f2f2',  'draw_frame_top_legend' : False, 'draw_box_row_left_legend' : True, 'draw_frame_left_legend' : False, 'rows_left_legend_show_value' : True, 'draw_frame_right_legend' : False, 'draw_box_row_right_legend' : False, 'rows_right_legend_width' : 75/3, 'binary_legend' : [ '< 0.05', '>= 0.05' ], 'margin_left' : 400, 'margin_top' : 650, 'margin_right' : 400, 'margin_bottom' : 300, 'matrix_legend_ratio' : 0.80, 'draw_x_k' : False, 'col_label_font_size' : 25 }
        ...
        self.coverage = widgets.FloatSlider( value = 0.0, min = 0, max = 100.0, step = 0.05, description = 'Coverage:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = '.2f' )
        
        self.range_frame = widgets.Checkbox( value = False, description = 'Range', disabled = False, indent = False )

        self.label_angle = widgets.IntSlider( value = 15, min = 0, max = 90, step = 1, description = 'Angle:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' ) # , layout = widgets.Layout( width = '350px')

        self.label_size = widgets.IntSlider( value = 25, min = 0, max = 35, step = 1, description = 'Size:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' ) # , layout = widgets.Layout( width = '300px')
        
        self.left = widgets.IntSlider( value = 400, min = 0, max = 1000, step = 5, description = 'Left:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' )
        
        self.top = widgets.IntSlider( value = 650, min = 0, max = 1000, step = 5, description = 'Top:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' )
        
        self.right = widgets.IntSlider( value = 400, min = 0, max = 1000, step = 5, description = 'Right:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' )
        
        self.bottom = widgets.IntSlider( value = 300, min = 0, max = 1000, step = 5, description = 'Bottom:', disabled = False, continuous_update = True, orientation = 'horizontal', readout = True, readout_format = 'd' )
    ...
    def maps( self ):
        ...
        self.dtm.plot_map( self.X_emb, self.y, np.array( patterns_s ), plt, self.fig, self.ax, font_legend_size = 8, size = 30, linewidth = 0.45, color_map1 = np.array( [ '#f2f2f2ff', '#1f77b3', '#ff7e0e', '#bcbc21' ] ), color_map2 = np.array( [ '#f2f2f2ff', '#e277c1', '#9367bc', '#bc0049', '#00aa79', '#ffdb00', '#d89c00', '#e41a1c', '#8c564b', '#ff9a75' ] ) )
    ...
    def reset_f( self, b ):
        ...
        self.left.value = 400
        self.right.value = 400
        self.top.value = 650
        self.bottom.value = 300

        self.label_angle.value = 15
        self.label_size.value = 25
