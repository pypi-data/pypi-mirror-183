...
curl -L https://github.com/PyO3/maturin/releases/download/v0.14.7/maturin-x86_64-unknown-linux-musl.tar.gz | tar -xz -C /usr/local/bin
...
echo "::endgroup::"
maturin build --release -i 3.7 3.8 3.9 3.10 3.11 --sdist -o dist --target x86_64-unknown-linux-gnu