...
def create_new_user_config(
    ...
    :param host: ip of the host (string)
    :param port: port number (int)
    :param send_anonymous_logs: (bool) Setting this parameter to `True` means you
        agree to send anonymously the logs that the qm module produces.
    :param datadog_token: string of token to send logs.
    :param organization: Name of your organization.
    """
