...
class sProfile:
    ...
    def __init__(self):
        ...
        self._title = f"new slope profile"
        ...
        self._line = Line2D([], [])
        self._line_percent = Line2D([], [])
        self._line_degree = Line2D([], [])
        self._trick_line = Line2D([], [])
    ...
    def copy_style(self, sprofile):
        if not isinstance(sprofile, sProfile):
            return False
        else:
    ...
    def __getstate__(self):
        ...
        attributes["_line_percent"] = Line2D([], [])
        attributes["_line_degree"] = Line2D([], [])
        attributes["_trick_line"] = Line2D([], [])
