...
def get_configs(base_yaml_path, pm_name, user_name, start_date, schedule_interval, table_name, partition_columns, backfill=False):
    ...
    input_config = ruamel.yaml.round_trip_load(open(base_yaml_path, "rb"), preserve_quotes=True)
