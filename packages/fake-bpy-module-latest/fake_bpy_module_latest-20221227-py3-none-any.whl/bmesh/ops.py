...
def bisect_plane(bm: 'bmesh.types.BMesh',
                 geom: 'bmesh.types.BMEdge' = [],
                 dist: float = 0,
                 plane_co: 'mathutils.Vector' = 'mathutils.Vector()',
                 plane_no: 'mathutils.Vector' = 'mathutils.Vector()',
...
def create_vert(bm: 'bmesh.types.BMesh',
                co: 'mathutils.Vector' = 'mathutils.Vector()') -> typing.Dict:
...
def pointmerge(bm: 'bmesh.types.BMesh',
               verts: typing.List['bmesh.types.BMVert'] = [],
               merge_co: 'mathutils.Vector' = 'mathutils.Vector()'):
...
def rotate(bm: 'bmesh.types.BMesh',
           cent: 'mathutils.Vector' = 'mathutils.Vector()',
           matrix: 'mathutils.Matrix' = 'mathutils.Matrix.Identity(4)',
           verts: typing.List['bmesh.types.BMVert'] = [],
...
def spin(bm: 'bmesh.types.BMesh',
         geom: 'bmesh.types.BMEdge' = [],
         cent: 'mathutils.Vector' = 'mathutils.Vector()',
         axis: 'mathutils.Vector' = 'mathutils.Vector()',
         dvec: 'mathutils.Vector' = 'mathutils.Vector()',
         angle: float = 0,
         space: 'mathutils.Matrix' = 'mathutils.Matrix.Identity(4)',
         steps: int = 0,
         use_merge: bool = False,
...
def triangle_fill(
        ...
        edges: typing.List['bmesh.types.BMEdge'] = [],
        normal: typing.Optional['mathutils.Vector'] = 'mathutils.Vector()'
) -> typing.Dict:
