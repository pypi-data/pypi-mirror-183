...
class DatasetBriefDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, id, urn, datasource_name, datasource_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, id, urn, datasource_name, datasource_type, *args, **kwargs):  # noqa: E501
        """DatasetBriefDto - a model defined in OpenAPI
