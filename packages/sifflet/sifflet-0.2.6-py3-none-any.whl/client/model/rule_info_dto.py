...
class RuleInfoDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, rule_label, criticality, source_platform, read_only, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, rule_label, criticality, source_platform, read_only, *args, **kwargs):  # noqa: E501
        """RuleInfoDto - a model defined in OpenAPI
