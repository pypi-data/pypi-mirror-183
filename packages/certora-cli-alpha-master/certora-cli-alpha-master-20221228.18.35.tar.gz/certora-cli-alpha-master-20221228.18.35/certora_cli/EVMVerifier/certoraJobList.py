...
class JobList:
    ...
    def __init__(self, current_path: Path = Path.cwd()):
        ...
        self.recent_jobs_path = Path(get_certora_root_directory()) / RECENT_JOBS_FILE
        self.temp_file_path = Path(get_certora_root_directory()) / f".tmp{RECENT_JOBS_FILE}"
    ...
    def rename_recent_jobs_file(self) -> None:
        ...
        name = Path(get_certora_root_directory()) / f".incompatible.{current_time}{RECENT_JOBS_FILE}"
        try:
