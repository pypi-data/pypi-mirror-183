...
# from .report.flow_analyser import FlowAnalyser  # for type hinting
...
class Flow(object):
    ...
    def __init__(
        ...
        self._analysers: List[
            'byteblower_test_framework.report.flow_analyser.FlowAnalyser'] = \
            list()
    ...
    def add_analyser(
        self,
        analyser: 'byteblower_test_framework.report.flow_analyser.FlowAnalyser'
    ) -> None:
