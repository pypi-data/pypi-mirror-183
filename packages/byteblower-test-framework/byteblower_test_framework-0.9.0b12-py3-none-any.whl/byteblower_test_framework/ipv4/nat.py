...
from ..frame import UDP_DYNAMIC_PORT
from ..server import Server  # for type hinting
from .port import DEFAULT_NETMASK, IPv4Port
...
class NatResolver(object):
    ...
    def resolve(self,
                ...
                public_udp_port: int = UDP_DYNAMIC_PORT,
                nat_udp_port: int = UDP_DYNAMIC_PORT) -> Tuple[str, int]:
        ...
        # Build frame content
        # NOTE: Done in byteblower_test_framework.configure_logging():
