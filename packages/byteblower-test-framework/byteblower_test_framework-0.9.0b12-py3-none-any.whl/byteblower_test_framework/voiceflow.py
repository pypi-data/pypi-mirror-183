...
from .frame import ETHERNET_HEADER_LENGTH, UDP_DYNAMIC_PORT
from .frame_factory import create_frame
from .frameblastingflow import DEFAULT_NUMBER_OF_FRAMES, FrameBlastingFlow
from .ipv4.frame import IPV4_HEADER_LENGTH
from .ipv4.port import IPv4Port  # for type hinting
from .ipv6.frame import IPV6_HEADER_LENGTH
from .ipv6.port import IPv6Port  # for type hinting
    ...
    def __init__(
        ...
        * 10ms packetization
        ...
        :type initial_time_to_wait: Optional[Union[timedelta, float, int]],
           optional
        :param udp_src: UDP src port, defaults to UDP_DYNAMIC_PORT
        :type udp_src: int, optional
        :param udp_dest: UDP dest port, defaults to UDP_DYNAMIC_PORT
