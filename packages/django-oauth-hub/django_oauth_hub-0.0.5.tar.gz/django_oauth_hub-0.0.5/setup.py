...
package_data = \
{'': ['*'],
 'django_oauth_hub': ['locale/nl/LC_MESSAGES/django.po'],
 'django_oauth_hub.oauth_client': ['locale/nl/LC_MESSAGES/django.po',
                                   'templates/oauth_client/*'],
 'django_oauth_hub.oauth_server': ['locale/nl/LC_MESSAGES/django.po']}
