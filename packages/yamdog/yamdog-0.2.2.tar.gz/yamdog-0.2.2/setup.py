...
PATH_PACKAGE = PATH_INIT.parent
IMPORT_NAME = PATH_PACKAGE.name
...
#───────────────────────────────────────────────────────────────────────
# packages
setup_info['packages']  = find_packages(PATH_SRC)
#───────────────────────────────────────────────────────────────────────
# Packages Dir
...
setup_info['entry_points'] = {'console_scripts':
    [f'{IMPORT_NAME} = {IMPORT_NAME}.CLI:main',]}
#%%═════════════════════════════════════════════════════════════════════
# PRINTING SETUP INFO
if '--print' in sys.argv:
