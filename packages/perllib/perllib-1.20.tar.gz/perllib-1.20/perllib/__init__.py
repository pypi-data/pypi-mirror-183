# perllib module for pythonizer, generated by makelib.py on Tue Dec 27 18:42:18 2022
#
...
_TIE_MAP = {'FETCH': '__getitem__','SCALAR': '__len__','EXISTS': '__contains__','DELETE': '__delitem__','FETCHSIZE': '__len__','PUSH': 'append','CLEAR': 'clear','STORE': '__setitem__','DESTROY': '__del__','UNTIE': '__untie__'}
CHILD_ERROR = 0
OS_ERROR = ''
...
TRACEBACK = 0
BASETIME = tm_py.time()
_PYTHONIZER_KEYWORDS = {'memoryview','os','issubclass','float','isinstance','repr','stat','hash','perllib','class','ord','fileinput','anext','functools','assert','compile','pdb','exec','argparse','classmethod','math','subprocess','complex','int','print','del','elif','format','if','property','or','async','dict','else','round','as','io','bool','zip','for','not','is','get','return','locals','inspect','set','random','from','close','finally','all','with','range','sys','hex','casefold','open','iter','ArrayHash','global','slice','False','chr','str','vars','while','traceback','abs','signal','callable','globals','dir','map','glob','sorted','bin','pass','enumerate','sum','bytes','True','hasattr','Array','delattr','oct','and','super','except','await','ascii','any','next','calendar','tuple','try','struct','getopt','atexit','collections.abc','eval','re','None','rfind','max','extend','break','def','wantarray','type','min','pop','builtins','rstrip','staticmethod','keys','pow','len','types','id','$PERLLIB','in','nonlocal','tempfile','help','object','copy','find','values','warnings','list','divmod','tm_py','import','continue','fcntl','input','lambda','breakpoint','setattr','update','dataclasses','aiter','getattr','insert','itertools','Hash','yield','filter','frozenset','raise','lower','codecs','reversed','upper','bytearray'}
...
def bless(obj, classname, isa=(), is_tie_package=False):
    ...
    if is_tie_package:
        result_class = add_tie_methods(result_class)
    result = result_class()
    self = result
