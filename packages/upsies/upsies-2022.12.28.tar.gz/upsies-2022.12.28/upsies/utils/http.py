...
def _get_user_agent_from_cache():
    ...
    if os.path.exists(cache_filepath):
        ...
        _log.debug('user agent cache created: %r', cache_created)
        cache_age = time.time() - cache_created
        _log.debug('    user agent cache age: %r', cache_age)
        _log.debug('user agent cache max age: %r', USER_AGENT_CACHE_MAX_AGE)
