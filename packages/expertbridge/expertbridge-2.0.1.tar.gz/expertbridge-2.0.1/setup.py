...
PACKAGE_JSON = os.path.join(BASE_DIR, "expertbridge-frontend", "package.json")
...
VERSION_INFO_FILE = os.path.join(BASE_DIR, "expertbridge", "static", "version_info.json")
...
setup(
    ...
    zip_safe=False,
    entry_points={
        "console_scripts": ["expertbridge=expertbridge.cli.main:expertbridge"],
    },
    install_requires=[
        "backoff>=1.8.0",
        "bleach>=3.0.2, <4.0.0",
    ...
    author_email="dev@expertbridge.apache.org",
    url="https://expertbridge.apache.org/",
    download_url="https://www.apache.org/dist/expertbridge/" + version_string,
    classifiers=[
