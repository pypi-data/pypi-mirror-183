...
from expertbridge.utils.core import convert_legacy_filters_into_adhoc, merge_extra_filters
...
class ExtraCache:
    ...
    def url_param(
        ...
        `?foo=bar`, as in `{domain}/expertbridge/sqllab?foo=bar`. Then if your query is
        ...
        from expertbridge.views.utils import get_form_data
    ...
    def get_filters(self, column: str, remove_filter: bool = False) -> List[Filter]:
        ...
        """
        # pylint: disable=import-outside-toplevel
        from expertbridge.utils.core import FilterOperator
        from expertbridge.views.utils import get_form_data
...
class PrestoTemplateProcessor(JinjaTemplateProcessor):
    ...
    def latest_partitions(self, table_name: str) -> Optional[List[str]]:
        ...
        # pylint: disable=import-outside-toplevel
        from expertbridge.db_engine_specs.presto import PrestoEngineSpec
