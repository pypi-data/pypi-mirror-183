...
This model was introduced in SIP-68 (https://github.com/apache/expertbridge/issues/14909),
...
from expertbridge.columns.models import Column
...
from expertbridge.sql_parse import Table as TableName

if TYPE_CHECKING:
    from expertbridge.datasets.models import Dataset
...
class Table(Model, AuditMixinNullable, ExtraJSONMixin, ImportExportMixin):
    ...
    # Column is managed externally and should be read-only inside Expertbridge
