...
# under the License.
""" Expertbridge wrapper around pyarrow.Table.
"""
import datetime
import json
import logging
...
from expertbridge.expertbridge_typing import DbapiDescription, DbapiResult, ResultSetColumnType
        ...
        if pa_data:  # pylint: disable=too-many-nested-blocks
            for i, column in enumerate(column_names):
                if pa.types.is_nested(pa_data[i].type):
                    ...
                    #  are added as a natively supported column type in Expertbridge
                    #  (expertbridge.utils.core.GenericDataType).
                    stringified_arr = stringify_values(array[column])
