...
from expertbridge.models.reports import ReportExecutionLog
from expertbridge.reports.logs.schemas import openapi_spec_methods_override
from expertbridge.views.base_api import BaseExpertbridgeModelRestApi

logger = logging.getLogger(__name__)


class ReportExecutionLogRestApi(BaseExpertbridgeModelRestApi):
