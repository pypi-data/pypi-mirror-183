...
from expertbridge.reports.notifications.base import BaseNotification
from expertbridge.reports.notifications.exceptions import NotificationError
from expertbridge.utils.core import send_email_smtp
from expertbridge.utils.decorators import statsd_gauge
from expertbridge.utils.urls import modify_url_query
...
class EmailNotification(BaseNotification):  # pylint: disable=too-few-public-methods
    ...
    def _get_content(self) -> EmailContent:
        ...
        call_to_action = __("Explore in Expertbridge")
        url = (
