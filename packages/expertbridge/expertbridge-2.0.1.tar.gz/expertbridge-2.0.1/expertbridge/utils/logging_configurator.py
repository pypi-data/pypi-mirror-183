...
class DefaultLoggingConfigurator(  # pylint: disable=too-few-public-methods
    ...
    def configure_logging(
        ...
        # configure expertbridge app logger
        expertbridge_logger = logging.getLogger("expertbridge")
        if debug_mode:
            expertbridge_logger.setLevel(logging.DEBUG)
        else:
            # In production mode, add log handler to sys.stderr.
            expertbridge_logger.addHandler(logging.StreamHandler())
            expertbridge_logger.setLevel(logging.INFO)
