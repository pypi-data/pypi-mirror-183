...
CACHE_IMPORT_PATH = "expertbridge.extensions.metastore_cache.ExpertbridgeMetastoreCache"
...
class CacheManager:
    ...
    def _init_cache(
        ...
        if (required and cache_type is None) or cache_type == "ExpertbridgeMetastoreCache":
