...
from expertbridge.constants import NULL_STRING, PandasAxis
from expertbridge.exceptions import InvalidPostProcessingError
from expertbridge.utils.pandas_postprocessing.utils import (
...
def pivot(  # pylint: disable=too-many-arguments,too-many-locals
    ...
    # for MultiIndex.
    # https://github.com/apache/expertbridge/issues/15956
