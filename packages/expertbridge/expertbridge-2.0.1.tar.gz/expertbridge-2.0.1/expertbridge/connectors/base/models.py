...
from expertbridge.constants import EMPTY_STRING, NULL_STRING
from expertbridge.datasets.commands.exceptions import DatasetNotFoundError
from expertbridge.models.helpers import AuditMixinNullable, ImportExportMixin, QueryResult
from expertbridge.models.slice import Slice
from expertbridge.expertbridge_typing import FilterValue, FilterValues, QueryObjectDict
from expertbridge.utils import core as utils
from expertbridge.utils.core import GenericDataType, MediumText
...
class BaseDatasource(
    ...
    def explore_url(self) -> str:
        ...
        return f"/expertbridge/explore/{self.type}/{self.id}/"
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        query_obj is a dictionary representing Expertbridge's query interface.
        Should return a ``expertbridge.models.helpers.QueryResult``
        """
        raise NotImplementedError()
