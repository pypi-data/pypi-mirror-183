...
from expertbridge import ConnectorRegistry, db, is_feature_enabled, security_manager
...
from expertbridge.models.tags import ChartUpdater
...
from expertbridge.viz import BaseViz, viz_types
...
class Slice(  # pylint: disable=too-many-public-methods
    ...
    def get_explore_url(
        self,
        base_url: str = "/expertbridge/explore",
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/expertbridge/explore_json")
    ...
    def changed_by_url(self) -> str:
        return f"/expertbridge/profile/{self.changed_by.username}"  # type: ignore
    ...
    @property
    def url(self) -> str:
        return f"/expertbridge/explore/?form_data=%7B%22slice_id%22%3A%20{self.id}%7D"
...
def event_after_chart_changed(
    ...
    url = get_url_path("Expertbridge.slice", slice_id=target.id, standalone="true")
