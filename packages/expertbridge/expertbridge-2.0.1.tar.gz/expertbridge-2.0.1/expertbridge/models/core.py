...
"""A collection of ORM sqlalchemy models for Expertbridge"""
import enum
import json
import logging
import textwrap
...
from expertbridge import app, db_engine_specs, is_feature_enabled
from expertbridge.databases.utils import make_url_safe
from expertbridge.db_engine_specs.base import TimeGrain
from expertbridge.extensions import cache_manager, encrypted_field_factory, security_manager
from expertbridge.models.helpers import AuditMixinNullable, ImportExportMixin
from expertbridge.models.tags import FavStarUpdater
from expertbridge.result_set import ExpertbridgeResultSet
from expertbridge.utils import cache as cache_util, core as utils
from expertbridge.utils.core import get_username
from expertbridge.utils.memoized import memoized
...
class Database(
    ...
    def function_names(self) -> List[str]:
        try:
            ...
            # more info in: https://github.com/apache/expertbridge/issues/9678
            logger.error(
    ...
    def get_sqla_engine(
        ...
        if DB_CONNECTION_MUTATOR:
            if not source and request and request.referrer:
                if "/expertbridge/dashboard/" in request.referrer:
                    source = utils.QuerySource.DASHBOARD
                elif "/expertbridge/explore/" in request.referrer:
                    source = utils.QuerySource.CHART
                elif "/expertbridge/sqllab/" in request.referrer:
    ...
    def sql_url(self) -> str:
        return f"/expertbridge/sql/{self.id}/"
...
class Log(Model):  # pylint: disable=too-few-public-methods
    ...
    """ORM object used to log Expertbridge actions to the database"""
