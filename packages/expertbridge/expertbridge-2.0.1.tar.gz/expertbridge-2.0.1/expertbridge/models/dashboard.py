...
from expertbridge import app, ConnectorRegistry, db, is_feature_enabled, security_manager
from expertbridge.common.request_contexed_based import is_user_admin
from expertbridge.connectors.base.models import BaseDatasource
from expertbridge.connectors.sqla.models import SqlMetric, TableColumn
from expertbridge.extensions import cache_manager
from expertbridge.models.filter_set import FilterSet
from expertbridge.models.helpers import AuditMixinNullable, ImportExportMixin
from expertbridge.models.slice import Slice
from expertbridge.models.tags import DashboardUpdater
...
from expertbridge.utils.decorators import debounce
...
class Dashboard(Model, AuditMixinNullable, ImportExportMixin):
    ...
    @property
    def url(self) -> str:
        return f"/expertbridge/dashboard/{self.slug or self.id}/"
    ...
    def update_thumbnail(self) -> None:
        url = get_url_path("Expertbridge.dashboard", dashboard_id_or_slug=self.id)
