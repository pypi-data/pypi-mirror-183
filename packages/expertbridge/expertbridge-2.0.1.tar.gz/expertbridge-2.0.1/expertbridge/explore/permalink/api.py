...
from expertbridge.explore.permalink.commands.create import CreateExplorePermalinkCommand
from expertbridge.explore.permalink.commands.get import GetExplorePermalinkCommand
from expertbridge.explore.permalink.exceptions import ExplorePermalinkInvalidStateError
from expertbridge.explore.permalink.schemas import ExplorePermalinkPostSchema
from expertbridge.extensions import event_logger
from expertbridge.key_value.exceptions import KeyValueAccessDeniedError
...
class ExplorePermalinkRestApi(BaseApi):
    ...
    def post(self) -> Response:
        ...
        try:
            ...
            url = f"{http_origin}/expertbridge/explore/p/{key}/"
