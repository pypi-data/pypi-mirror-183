...
# under the License.
"""Loads datasets, dashboards and slices in a new expertbridge instance"""
import json
import os
...
import expertbridge.utils.database
from expertbridge import app, db
from expertbridge.connectors.sqla.models import SqlMetric
...
def load_world_bank_health_n_pop(  # pylint: disable=too-many-locals, too-many-statements
    ...
    database = expertbridge.utils.database.get_example_database()
