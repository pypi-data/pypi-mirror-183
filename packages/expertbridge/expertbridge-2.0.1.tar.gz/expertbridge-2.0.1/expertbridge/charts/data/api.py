...
from expertbridge import is_feature_enabled, security_manager
from expertbridge.charts.api import ChartRestApi
from expertbridge.charts.commands.exceptions import (
    ChartDataCacheLoadError,
    ChartDataQueryFailedError,
)
from expertbridge.charts.data.commands.create_async_job_command import (
    CreateAsyncChartDataJobCommand,
)
from expertbridge.charts.data.commands.get_data_command import ChartDataCommand
from expertbridge.charts.data.query_context_cache_loader import QueryContextCacheLoader
from expertbridge.charts.post_processing import apply_post_process
from expertbridge.charts.schemas import ChartDataQueryContextSchema
...
from expertbridge.exceptions import QueryObjectValidationError
...
from expertbridge.utils.core import create_zip, json_int_dttm_ser
from expertbridge.views.base import CsvResponse, generate_download_headers
from expertbridge.views.base_api import statsd_metrics
...
class ChartDataRestApi(ChartRestApi):
    ...
    def _send_chart_response(
        ...
        if result_format == ChartDataResultFormat.CSV:
            ...
            if not security_manager.can_access("can_csv", "Expertbridge"):
