...
from expertbridge import app, is_feature_enabled, thumbnail_cache
from expertbridge.charts.commands.bulk_delete import BulkDeleteChartCommand
from expertbridge.charts.commands.create import CreateChartCommand
from expertbridge.charts.commands.delete import DeleteChartCommand
from expertbridge.charts.commands.exceptions import (
...
from expertbridge.charts.commands.export import ExportChartsCommand
from expertbridge.charts.commands.importers.dispatcher import ImportChartsCommand
from expertbridge.charts.commands.update import UpdateChartCommand
from expertbridge.charts.dao import ChartDAO
from expertbridge.charts.filters import (
    ChartAllTextFilter,
    ChartCertifiedFilter,
    ChartFavoriteFilter,
    ChartFilter,
)
from expertbridge.charts.schemas import (
    CHART_SCHEMAS,
    ChartPostSchema,
    ChartPutSchema,
...
from expertbridge.tasks.thumbnails import cache_chart_thumbnail
from expertbridge.utils.screenshots import ChartScreenshot
...
class ChartRestApi(BaseExpertbridgeModelRestApi):
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("Expertbridge.slice", slice_id=chart.id, standalone="true")
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        url = get_url_path("Expertbridge.slice", slice_id=chart.id, standalone="true")
