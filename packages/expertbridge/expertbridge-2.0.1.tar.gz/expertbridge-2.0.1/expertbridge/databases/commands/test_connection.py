...
from expertbridge.exceptions import ExpertbridgeSecurityException, ExpertbridgeTimeoutException
from expertbridge.extensions import event_logger
from expertbridge.models.core import Database
from expertbridge.utils.core import override_user
            ...
            with override_user(self._actor):
                ...
                try:
                    ...
                    raise ExpertbridgeTimeoutException(
                        error_type=ExpertbridgeErrorType.CONNECTION_DATABASE_TIMEOUT,
                        message=(
