...
from expertbridge.db_engine_specs import BaseEngineSpec, get_engine_specs
from expertbridge.exceptions import CertificateException, ExpertbridgeSecurityException
from expertbridge.models.core import ConfigurationMethod, Database, PASSWORD_MASK
from expertbridge.security.analytics_db_safety import check_sqlalchemy_uri
from expertbridge.utils.core import markdown, parse_ssl_cert
...
class ImportV1DatabaseExtraSchema(Schema):
    ...
    def fix_schemas_allowed_for_csv_upload(
        ...
        """
        # Fix for https://github.com/apache/expertbridge/pull/16756, which temporarily
