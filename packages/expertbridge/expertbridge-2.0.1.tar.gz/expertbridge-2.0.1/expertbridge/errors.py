...
class ExpertbridgeErrorType(str, Enum):
    """
    Types of errors that can exist within Expertbridge.

    Keep in sync with expertbridge-frontend/src/components/ErrorMessage/types.ts
...
ISSUE_CODES = {
    ...
    1010: _("Expertbridge encountered an error while running a command."),
    1011: _("Expertbridge encountered an unexpected error."),
...
ERROR_TYPES_TO_ISSUE_CODES_MAPPING = {
    ExpertbridgeErrorType.ADHOC_SUBQUERY_NOT_ALLOWED_ERROR: [1037],
    ExpertbridgeErrorType.BACKEND_TIMEOUT_ERROR: [1000, 1001],
    ExpertbridgeErrorType.GENERIC_DB_ENGINE_ERROR: [1002],
    ExpertbridgeErrorType.COLUMN_DOES_NOT_EXIST_ERROR: [1003, 1004],
    ExpertbridgeErrorType.TABLE_DOES_NOT_EXIST_ERROR: [1003, 1005],
    ExpertbridgeErrorType.SCHEMA_DOES_NOT_EXIST_ERROR: [1003, 1016],
    ExpertbridgeErrorType.MISSING_TEMPLATE_PARAMS_ERROR: [1006],
    ExpertbridgeErrorType.INVALID_TEMPLATE_PARAMS_ERROR: [1028],
    ExpertbridgeErrorType.RESULTS_BACKEND_NOT_CONFIGURED_ERROR: [1021],
    ExpertbridgeErrorType.DML_NOT_ALLOWED_ERROR: [1022],
    ExpertbridgeErrorType.CONNECTION_INVALID_HOSTNAME_ERROR: [1007],
    ExpertbridgeErrorType.CONNECTION_PORT_CLOSED_ERROR: [1008],
    ExpertbridgeErrorType.CONNECTION_HOST_DOWN_ERROR: [1009],
    ExpertbridgeErrorType.GENERIC_COMMAND_ERROR: [1010],
    ExpertbridgeErrorType.GENERIC_BACKEND_ERROR: [1011],
    ExpertbridgeErrorType.CONNECTION_INVALID_USERNAME_ERROR: [1012],
    ExpertbridgeErrorType.CONNECTION_INVALID_PASSWORD_ERROR: [1013],
    ExpertbridgeErrorType.CONNECTION_ACCESS_DENIED_ERROR: [1014, 1015],
    ExpertbridgeErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR: [1015],
    ExpertbridgeErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR: [1017],
    ExpertbridgeErrorType.CONNECTION_MISSING_PARAMETERS_ERROR: [1018],
    ExpertbridgeErrorType.INVALID_PAYLOAD_FORMAT_ERROR: [1019],
    ExpertbridgeErrorType.INVALID_PAYLOAD_SCHEMA_ERROR: [1020],
    ExpertbridgeErrorType.INVALID_CTAS_QUERY_ERROR: [1023],
    ExpertbridgeErrorType.INVALID_CVAS_QUERY_ERROR: [1024, 1025],
    ExpertbridgeErrorType.SQLLAB_TIMEOUT_ERROR: [1026, 1027],
    ExpertbridgeErrorType.OBJECT_DOES_NOT_EXIST_ERROR: [1029],
    ExpertbridgeErrorType.SYNTAX_ERROR: [1030],
    ExpertbridgeErrorType.RESULTS_BACKEND_ERROR: [1031, 1032, 1033],
    ExpertbridgeErrorType.CONNECTION_INVALID_PORT_ERROR: [1034],
    ExpertbridgeErrorType.ASYNC_WORKERS_ERROR: [1035],
    ExpertbridgeErrorType.DATABASE_NOT_FOUND_ERROR: [1011, 1036],
    ExpertbridgeErrorType.CONNECTION_DATABASE_TIMEOUT: [1001, 1009],
}


class ErrorLevel(str, Enum):
    """
    Levels of errors that can exist within Expertbridge.
