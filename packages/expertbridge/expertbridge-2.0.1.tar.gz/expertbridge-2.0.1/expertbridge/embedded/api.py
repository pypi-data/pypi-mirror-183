...
from expertbridge.dashboards.schemas import EmbeddedDashboardResponseSchema
...
from expertbridge.reports.logs.schemas import openapi_spec_methods_override
from expertbridge.views.base_api import BaseExpertbridgeModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class EmbeddedDashboardRestApi(BaseExpertbridgeModelRestApi):
