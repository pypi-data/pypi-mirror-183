...
from expertbridge import event_logger, is_feature_enabled, security_manager
...
from expertbridge.views.base import BaseExpertbridgeView, common_bootstrap_payload


class EmbeddedView(BaseExpertbridgeView):
