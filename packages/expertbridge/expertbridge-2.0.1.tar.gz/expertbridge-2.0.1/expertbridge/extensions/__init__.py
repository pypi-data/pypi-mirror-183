...
from expertbridge.utils.async_query_manager import AsyncQueryManager
from expertbridge.utils.cache_manager import CacheManager
from expertbridge.utils.encrypt import EncryptedFieldFactory
from expertbridge.utils.feature_flag_manager import FeatureFlagManager
from expertbridge.utils.machine_auth import MachineAuthProviderFactory
from expertbridge.utils.profiler import ExpertbridgeProfiler
...
class ProfilingExtension:  # pylint: disable=too-few-public-methods
    ...
    def init_app(self, app: Flask) -> None:
        app.wsgi_app = ExpertbridgeProfiler(app.wsgi_app, self.interval)  # type: ignore
