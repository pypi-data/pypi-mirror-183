...
from expertbridge.key_value.exceptions import KeyValueCreateFailedError
from expertbridge.key_value.types import KeyValueResource
from expertbridge.key_value.utils import get_uuid_namespace

RESOURCE = KeyValueResource.METASTORE_CACHE


class ExpertbridgeMetastoreCache(BaseCache):
    ...
    def _prune() -> None:
        ...
        from expertbridge.key_value.commands.delete_expired import (
    ...
    def set(self, key: str, value: Any, timeout: Optional[int] = None) -> bool:
        # pylint: disable=import-outside-toplevel
        from expertbridge.key_value.commands.upsert import UpsertKeyValueCommand
    ...
    def add(self, key: str, value: Any, timeout: Optional[int] = None) -> bool:
        # pylint: disable=import-outside-toplevel
        from expertbridge.key_value.commands.create import CreateKeyValueCommand
    ...
    def delete(self, key: str) -> Any:
        # pylint: disable=import-outside-toplevel
        from expertbridge.key_value.commands.delete import DeleteKeyValueCommand
