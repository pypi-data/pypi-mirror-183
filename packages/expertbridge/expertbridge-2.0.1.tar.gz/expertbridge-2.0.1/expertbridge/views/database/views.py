...
from expertbridge import app, db
from expertbridge.connectors.sqla.models import SqlaTable
from expertbridge.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from expertbridge.exceptions import CertificateException
...
from expertbridge.views.base import DeleteMixin, ExpertbridgeModelView, YamlExportMixin
...
class DatabaseView(
    DatabaseMixin, ExpertbridgeModelView, DeleteMixin, YamlExportMixin
    ...
    add_template = "expertbridge/models/database/add.html"
    edit_template = "expertbridge/models/database/edit.html"
    validators_columns = {
...
class CsvToDatabaseView(SimpleFormView):
    ...
    form_template = "expertbridge/form_view/csv_to_database_view/edit.html"
    ...
    def form_post(self, form: CsvToDatabaseForm) -> Response:
        ...
        if not schema_allows_file_upload(database, csv_table.schema):
            message = __(
                ...
                "is not allowed for csv uploads. Please contact your Expertbridge Admin.",
...
class ExcelToDatabaseView(SimpleFormView):
    ...
    form_template = "expertbridge/form_view/excel_to_database_view/edit.html"
    ...
    def form_post(self, form: ExcelToDatabaseForm) -> Response:
        ...
        if not schema_allows_file_upload(database, excel_table.schema):
            message = __(
                'Database "%(database_name)s" schema "%(schema_name)s" '
                "is not allowed for excel uploads. Please contact your Expertbridge Admin.",
                database_name=database.database_name,
...
class ColumnarToDatabaseView(SimpleFormView):
    ...
    form_template = "expertbridge/form_view/columnar_to_database_view/edit.html"
