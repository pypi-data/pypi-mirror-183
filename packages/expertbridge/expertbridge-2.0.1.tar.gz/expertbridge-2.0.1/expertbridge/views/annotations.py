...
from expertbridge.models.annotations import Annotation, AnnotationLayer
...
class AnnotationModelView(
    ExpertbridgeModelView, CompactCRUDMixin
...
class AnnotationLayerModelView(ExpertbridgeModelView):
