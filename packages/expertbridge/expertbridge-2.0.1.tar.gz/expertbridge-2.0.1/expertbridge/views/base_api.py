...
from expertbridge.exceptions import InvalidPayloadFormatError
from expertbridge.extensions import db, event_logger, security_manager
from expertbridge.models.core import FavStar
from expertbridge.models.dashboard import Dashboard
from expertbridge.models.slice import Slice
from expertbridge.schemas import error_payload_content
from expertbridge.sql_lab import Query as SqllabQuery
from expertbridge.stats_logger import BaseStatsLogger
from expertbridge.expertbridge_typing import FlaskResponse
from expertbridge.utils.core import time_function
from expertbridge.views.base import handle_api_exception
...
def requires_json(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: "BaseExpertbridgeModelRestApi", *args: Any, **kwargs: Any) -> Response:
...
class BaseExpertbridgeModelRestApi(ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific expertbridge generic functionality
    """
