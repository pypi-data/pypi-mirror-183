...
from expertbridge import db, event_logger, is_feature_enabled, security_manager
from expertbridge.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from expertbridge.models.dashboard import Dashboard as DashboardModel
...
from expertbridge.views.base import (
    ...
    ExpertbridgeModelView,
)
from expertbridge.views.dashboard.mixin import DashboardMixin


class DashboardModelView(
    DashboardMixin, ExpertbridgeModelView, DeleteMixin
    ...
    def download_dashboards(self) -> FlaskResponse:
        ...
        return self.render_template(
            "expertbridge/export_dashboards.html", dashboards_url="/dashboard/list"
        )
...
class Dashboard(BaseExpertbridgeView):
    ...
    def new(self) -> FlaskResponse:  # pylint: disable=no-self-use
        ...
        db.session.commit()
        return redirect(f"/expertbridge/dashboard/{new_dashboard.id}/?edit=true")
