...
import expertbridge.models.core as models
from expertbridge import app, dataframe, db, result_set, viz
...
from expertbridge.extensions import cache_manager, feature_flag_manager, security_manager
from expertbridge.legacy import update_time_range
...
from expertbridge.expertbridge_typing import FormData
...
def get_datasource_info(
    ...
    :raises ExpertbridgeException: If the datasource no longer exists
    """
...
# /expertbridge-frontend/src/dashboard/util/componentTypes.js
...
def check_explore_cache_perms(_self: Any, cache_key: str) -> None:
    ...
    :param _self: the Expertbridge view instance
    ...
    **kwargs: Any
    ...
    try:
        ...
        raise ExpertbridgeSecurityException(
            ExpertbridgeError(
                error_type=ExpertbridgeErrorType.FAILED_FETCHING_DATASOURCE_INFO_ERROR,
    ...
    if datasource_type is None:
        raise ExpertbridgeSecurityException(
            ExpertbridgeError(
                error_type=ExpertbridgeErrorType.UNKNOWN_DATASOURCE_TYPE_ERROR,
                level=ErrorLevel.ERROR,
...
def _deserialize_results_payload(
    ...
    if use_msgpack:
        ...
        df = result_set.ExpertbridgeResultSet.convert_table_to_df(pa_table)
