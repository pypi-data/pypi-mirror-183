...
from expertbridge.databases.schemas import encrypted_field_properties, EncryptedString
from expertbridge.databases.utils import make_url_safe
from expertbridge.db_engine_specs.base import BaseEngineSpec
from expertbridge.db_engine_specs.exceptions import ExpertbridgeDBAPIDisconnectionError
from expertbridge.errors import ExpertbridgeError, ExpertbridgeErrorType
...
class BigQueryEngineSpec(BaseEngineSpec):
    ...
    custom_errors: Dict[Pattern[str], Tuple[str, ExpertbridgeErrorType, Dict[str, Any]]] = {
        CONNECTION_DATABASE_PERMISSIONS_REGEX: (
            ...
            ExpertbridgeErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
            {},
        ),
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {DefaultCredentialsError: ExpertbridgeDBAPIDisconnectionError}
