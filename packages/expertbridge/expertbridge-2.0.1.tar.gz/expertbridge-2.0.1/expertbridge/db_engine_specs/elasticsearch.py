...
class ElasticSearchEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {
            es_exceptions.DatabaseError: ExpertbridgeDBAPIDatabaseError,
            es_exceptions.OperationalError: ExpertbridgeDBAPIOperationalError,
            es_exceptions.ProgrammingError: ExpertbridgeDBAPIProgrammingError,
        }
