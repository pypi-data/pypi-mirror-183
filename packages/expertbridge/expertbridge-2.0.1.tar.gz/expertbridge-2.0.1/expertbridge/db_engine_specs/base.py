...
from expertbridge import security_manager, sql_parse
...
from expertbridge.sql_parse import ParsedQuery, Table
from expertbridge.expertbridge_typing import ResultSetColumnType
from expertbridge.utils import core as utils
from expertbridge.utils.core import ColumnSpec, GenericDataType, get_username
from expertbridge.utils.hashing import md5_sha_from_str
from expertbridge.utils.network import is_hostname_valid, is_port_open

if TYPE_CHECKING:
    # prevent circular imports
    from expertbridge.connectors.sqla.models import TableColumn
...
class BaseEngineSpec:  # pylint: disable=too-many-public-methods
    ...
    custom_errors: Dict[
        Pattern[str], Tuple[str, ExpertbridgeErrorType, Dict[str, Any]]
    ] = {}
    ...
    def get_dbapi_mapped_exception(cls, exception: Exception) -> Exception:
        """
        Get a expertbridge custom DBAPI exception from the driver specific exception.
        ...
        :return: Expertbridge custom DBAPI exception
        """
    ...
    def extract_errors(
        ...
        return [
            ExpertbridgeError(
                error_type=ExpertbridgeErrorType.GENERIC_DB_ENGINE_ERROR,
        ...
        if missing:
            errors.append(
                ExpertbridgeError(
                    ...
                    error_type=ExpertbridgeErrorType.CONNECTION_MISSING_PARAMETERS_ERROR,
        ...
        if not is_hostname_valid(host):
            errors.append(
                ExpertbridgeError(
                    ...
                    error_type=ExpertbridgeErrorType.CONNECTION_INVALID_HOSTNAME_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["host"]},
                ),
            )
        ...
        try:
            ...
            errors.append(
                ExpertbridgeError(
                    ...
                    error_type=ExpertbridgeErrorType.CONNECTION_INVALID_PORT_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
        if not (isinstance(port, int) and 0 <= port < 2**16):
            ...
            errors.append(
                ExpertbridgeError(
                    ...
                    error_type=ExpertbridgeErrorType.CONNECTION_PORT_CLOSED_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
