...
from expertbridge.db_engine_specs.base import (
    BaseEngineSpec,
...
if TYPE_CHECKING:
    from expertbridge.models.core import Database  # pragma: no cover
...
class PostgresBaseEngineSpec(BaseEngineSpec):
    ...
    custom_errors: Dict[Pattern[str], Tuple[str, ExpertbridgeErrorType, Dict[str, Any]]] = {
        CONNECTION_INVALID_USERNAME_REGEX: (
            ...
            ExpertbridgeErrorType.CONNECTION_INVALID_USERNAME_ERROR,
            {"invalid": ["username"]},
        ),
        CONNECTION_INVALID_PASSWORD_REGEX: (
            __('The password provided for username "%(username)s" is incorrect.'),
            ExpertbridgeErrorType.CONNECTION_INVALID_PASSWORD_ERROR,
        ...
        SYNTAX_ERROR_REGEX: (
            ...
            ExpertbridgeErrorType.SYNTAX_ERROR,
            {},
        ),
    }
...
class PostgresEngineSpec(PostgresBaseEngineSpec, BasicParametersMixin):
    ...
    def get_extra_params(database: "Database") -> Dict[str, Any]:
        ...
        :raises ExpertbridgeException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError as ex:
            raise ExpertbridgeException("Unable to parse database extras") from ex
