...
from expertbridge.db_engine_specs.base import BaseEngineSpec, LimitMethod
from expertbridge.db_engine_specs.exceptions import (
    ExpertbridgeDBAPIDatabaseError,
    ExpertbridgeDBAPIOperationalError,
    ExpertbridgeDBAPIProgrammingError,
)
...
class KustoSqlEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {
            kusto_exceptions.DatabaseError: ExpertbridgeDBAPIDatabaseError,
            kusto_exceptions.OperationalError: ExpertbridgeDBAPIOperationalError,
            kusto_exceptions.ProgrammingError: ExpertbridgeDBAPIProgrammingError,
        }
