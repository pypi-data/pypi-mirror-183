...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls) -> None:
        ...
        from expertbridge.db_engines import hive as patched_hive
    ...
    def df_to_sql(
        ...
        if to_sql_kwargs["if_exists"] == "append":
            raise ExpertbridgeException("Append operation not currently supported")
        ...
        if to_sql_kwargs["if_exists"] == "fail":
            ...
            if table_exists:
                raise ExpertbridgeException("Table already exists")
