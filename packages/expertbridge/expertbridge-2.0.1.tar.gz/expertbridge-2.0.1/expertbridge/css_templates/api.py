...
from expertbridge.css_templates.commands.bulk_delete import BulkDeleteCssTemplateCommand
from expertbridge.css_templates.commands.exceptions import (
    CssTemplateBulkDeleteFailedError,
    CssTemplateNotFoundError,
)
from expertbridge.css_templates.filters import CssTemplateAllTextFilter
from expertbridge.css_templates.schemas import (
    get_delete_ids_schema,
    openapi_spec_methods_override,
)
from expertbridge.extensions import event_logger
from expertbridge.models.core import CssTemplate
from expertbridge.views.base_api import BaseExpertbridgeModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class CssTemplateRestApi(BaseExpertbridgeModelRestApi):
