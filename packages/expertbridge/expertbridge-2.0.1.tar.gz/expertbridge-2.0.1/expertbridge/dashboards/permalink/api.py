...
from expertbridge.dashboards.permalink.commands.create import (
    CreateDashboardPermalinkCommand,
)
from expertbridge.dashboards.permalink.commands.get import GetDashboardPermalinkCommand
from expertbridge.dashboards.permalink.exceptions import DashboardPermalinkInvalidStateError
from expertbridge.dashboards.permalink.schemas import DashboardPermalinkPostSchema
...
class DashboardPermalinkRestApi(BaseApi):
    ...
    def post(self, pk: str) -> Response:
        ...
        try:
            ...
            url = f"{http_origin}/expertbridge/dashboard/p/{key}/"
