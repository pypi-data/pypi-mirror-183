...
from expertbridge.commands.exceptions import ObjectNotFoundError
from expertbridge.dashboards.commands.exceptions import DashboardNotFoundError
from expertbridge.dashboards.dao import DashboardDAO
from expertbridge.dashboards.filter_sets.commands.create import CreateFilterSetCommand
from expertbridge.dashboards.filter_sets.commands.delete import DeleteFilterSetCommand
from expertbridge.dashboards.filter_sets.commands.exceptions import (
...
from expertbridge.dashboards.filter_sets.commands.update import UpdateFilterSetCommand
from expertbridge.dashboards.filter_sets.consts import (
    DASHBOARD_FIELD,
    DASHBOARD_ID_FIELD,
    DESCRIPTION_FIELD,
...
from expertbridge.dashboards.filter_sets.filters import FilterSetFilter
from expertbridge.dashboards.filter_sets.schemas import (
    FilterSetPostSchema,
    FilterSetPutSchema,
)
...
class FilterSetRestApi(BaseExpertbridgeModelRestApi):
    ...
    def _init_properties(self) -> None:
        ...
        super(BaseExpertbridgeModelRestApi, self)._init_properties()
