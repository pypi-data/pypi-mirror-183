...
from expertbridge import db, is_feature_enabled, security_manager
...
from expertbridge.security.guest_token import GuestTokenResourceType, GuestUser
from expertbridge.views.base import BaseFilter, is_user_admin
from expertbridge.views.base_api import BaseFavoriteFilter
...
class DashboardAccessFilter(BaseFilter):  # pylint: disable=too-few-public-methods
    ...
    def apply(self, query: Query, value: Any) -> Query:
        ...
        if is_feature_enabled("EMBEDDED_EXPERTBRIDGE") and security_manager.is_guest_user(
            g.user
        ):
