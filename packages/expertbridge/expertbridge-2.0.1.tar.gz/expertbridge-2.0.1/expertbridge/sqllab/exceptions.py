...
if TYPE_CHECKING:
    from expertbridge.utils.sqllab_execution_context import SqlJsonExecutionContext


class SqlLabException(ExpertbridgeException):
        ...
        if error_type is None:
            if exception is not None:
                if (
                    ...
                    exception.error, ExpertbridgeError  # type: ignore
                ):
...
class QueryIsForbiddenToAccessException(SqlLabException):
    def __init__(
        ...
        super().__init__(
            ...
            ExpertbridgeErrorType.QUERY_SECURITY_ACCESS_ERROR,
