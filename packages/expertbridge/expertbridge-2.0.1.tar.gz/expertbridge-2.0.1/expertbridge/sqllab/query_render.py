...
from expertbridge.sqllab.command import SqlQueryRender
from expertbridge.sqllab.exceptions import SqlLabException
...
class SqlQueryRenderImpl(SqlQueryRender):
    ...
    def _raise_undefined_parameter_exception(
        ...
        raise SqlQueryRenderException(
            ...
            error_type=ExpertbridgeErrorType.MISSING_TEMPLATE_PARAMS_ERROR,
    ...
    def _raise_template_exception(
        ...
        raise SqlQueryRenderException(
            sql_json_execution_context=execution_context,
            error_type=ExpertbridgeErrorType.INVALID_TEMPLATE_PARAMS_ERROR,
            reason_message=__(
