...
from expertbridge.dao.exceptions import DAOCreateFailedError
from expertbridge.errors import ExpertbridgeErrorType
from expertbridge.exceptions import ExpertbridgeErrorsException, ExpertbridgeGenericErrorException
...
if TYPE_CHECKING:
    ...
    from expertbridge.sqllab.sql_json_executer import SqlJsonExecutor
...
class ExecuteSqlCommand(BaseCommand):
    ...
    def run(  # pylint: disable=too-many-statements,useless-suppression
        ...
        except (SqlLabException, ExpertbridgeErrorsException) as ex:
            raise ex
