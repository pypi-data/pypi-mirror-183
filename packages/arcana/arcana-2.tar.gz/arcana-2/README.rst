...
The ``arcana`` is a metapackage that installs all centrally supported sub-packages:

* `arcana-core <https://github.com/ArcanaFramework/arcana-core>`__
* `arcana-dirtree <https://github.com/ArcanaFramework/arcana-dirtree>`__
* `arcana-xnat <https://github.com/ArcanaFramework/arcana-xnat>`__
* `arcana-bids <https://github.com/ArcanaFramework/arcana-bids>`__
