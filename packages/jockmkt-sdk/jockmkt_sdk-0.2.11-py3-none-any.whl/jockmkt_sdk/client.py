...
class Client(object):
    ...
    def ws_connect(self, loop: asyncio.Event, queue: List, error_handler: Callable, callback=None):
        """
    ...
    def ws_connect_new(self, loop: asyncio.Event, queue: List, error_handler: Callable, subscriptions: List[Dict],
