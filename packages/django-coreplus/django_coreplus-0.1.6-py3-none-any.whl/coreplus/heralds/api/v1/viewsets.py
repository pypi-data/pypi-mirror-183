...
from coreplus.reactions.api.v1.serializers import ReactionableModelAddSerializer, ReactionSerializer
from coreplus.reactions.models import Reaction

from ...models import DirectMessage, DirectMessageAttachment
from .serializers import AttachmentSerializer, DirectMessageCreateSerializer, DirectMessageSerializer
...
class DirectMessageViewSet(ModelViewSet):
    ...
    def get_recipient(self, request, *args, **kwargs):
        ...
        unread_messages = messages.filter(recipient=self.request.user, status=DirectMessage.UNREAD)
