...
class ConverterTest(unittest.TestCase):
    ...
    def test_get_seconds_from_finapts(self):
        ...
        self.assertEqual(ssconv.get_seconds_from_finapts('LCM', 'M', '100m Freestyle', 1000), 46.91)
        ...
        self.assertEqual(ssconv.get_seconds_from_finapts('SCM', 'F', '100m Butterfly', 1000), 54.59)
