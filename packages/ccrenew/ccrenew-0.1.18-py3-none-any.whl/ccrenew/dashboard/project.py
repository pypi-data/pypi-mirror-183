...
class Project:
    ...
    def export_df(self, server='dev'):
        ...
        Args:
            server (str, optional): Option to insert data to prod or dev environments.
                <ul>
    ...
    def export_summary(self, server='dev'):
        ...
        Args:
            server (str, optional): Option to insert data to prod or dev table.
                <ul>
    ...
    def export(self, save_pickle=True, server='dev', *args):
        """
        Export project to desired location(s)

        Args:
            save_pickle (bool, optional): Option to save pickle after exporting.
            server (str, optional): SQL table to export to. Options are `prod` or `dev`.
        """
