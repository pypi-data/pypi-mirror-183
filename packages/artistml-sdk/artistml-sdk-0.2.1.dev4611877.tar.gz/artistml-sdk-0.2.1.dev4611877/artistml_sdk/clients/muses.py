...
from ..apis.thirdparty.kfpapi.pipeline_spec_pb2 import ComponentInputsSpec
from ..apis.thirdparty.kfpapi.pipeline_spec_pb2 import ComponentOutputsSpec
...
class MusesClient:
    ...
    def create_run_from_file(
        ...
        yaml_path: str,
        trigger: Trigger,
        input_definitions: ComponentInputsSpec,
        output_definitions: ComponentOutputsSpec,
    ) -> CreateRunResponse:
    ...
    def create_run_from_function(
        ...
        return self.create_flow(run=Run(
            flow_id=resp.details.id,
            trigger=trigger,
            input_definitions=input_definitions,
            output_definitions=output_definitions,
