...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x12muses/v1/run.proto\x12\x08muses.v1\x1a\x19google/api/resource.proto\x1a%thirdparty/kfpapi/pipeline_spec.proto\x1a\x1fthirdparty/kfpbackend/job.proto\"\x9f\x03\n\x03Run\x12\x0e\n\x02id\x18\x01 \x01(\x03R\x02id\x12\x1b\n\tcreate_at\x18\x02 \x01(\tR\x08\x63reateAt\x12\x1b\n\tupdate_at\x18\x03 \x01(\tR\x08updateAt\x12\x17\n\x07\x66low_id\x18\x04 \x01(\x03R\x06\x66lowId\x12\x12\n\x04name\x18\x05 \x01(\tR\x04name\x12\x38\n\x07trigger\x18\x06 \x01(\x0b\x32\x1e.thirdparty.kfpbackend.TriggerR\x07trigger\x12S\n\x11input_definitions\x18\x07 \x01(\x0b\x32&.thirdparty.kfpapi.ComponentInputsSpecR\x10inputDefinitions\x12V\n\x12output_definitions\x18\x08 \x01(\x0b\x32\'.thirdparty.kfpapi.ComponentOutputsSpecR\x11outputDefinitions::\xea\x41\x37\n\"github.com.artistml.apis/RunEntity\x12\x11\x66lows/*/runs/{id}\"\x11\n\x0fRunOptionFilterB.Z,github.com/artistml/apis/go/muses/v1;musesv1b\x06proto3')
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RUN._serialized_start=132
  _RUN._serialized_end=547
  _RUNOPTIONFILTER._serialized_start=549
  _RUNOPTIONFILTER._serialized_end=566
