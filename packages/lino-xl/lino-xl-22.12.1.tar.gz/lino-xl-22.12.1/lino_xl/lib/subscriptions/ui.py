...
class Subscriptions(dd.Table):
    ...
    entry_date
    """
    column_names = "start_date partner subject workflow_buttons *"
...
class SubscriptionsByJournal(Subscriptions, ByJournal):
    # required_roles = dd.login_required(InvoicingUser)
    # _order_area = SubscriptionLayouts.default
    required_roles = dd.login_required(InvoicingUser)
    master_key = 'journal'
    column_names = "number partner subject start_date workflow_buttons *"
    insert_layout = """
    subject
    # journal
    start_date
...
class SubscriptionsByPartner(Subscriptions):
    master_key = 'partner'
    column_names = "subject entry_date:8 journal number workflow_buttons user *"
