...
class SpatialAnalysis:
  ...
  # REQUUIRES: valid csv input
  # MODIFIES: N/A
  # EFFECT: if used in Colab / Jupyter a visual of the data will print
  def printCSV(self):
      print('if used in Colab / Jupyter a visual of the data will print')
      self.c
