...
class InstanceConfiguration(core.Schema):
    ...
    def __init__(
        self,
        *,
        block_device_mapping: Union[List[BlockDeviceMapping], core.ArrayOut[BlockDeviceMapping]],
...
class DsContainerRecipe(core.Data):
    ...
    container_type: Union[str, core.StringOut] = core.attr(str, computed=True)

    date_created: Union[str, core.StringOut] = core.attr(str, computed=True)

    description: Union[str, core.StringOut] = core.attr(str, computed=True)

    dockerfile_template_data: Union[str, core.StringOut] = core.attr(str, computed=True)

    encrypted: Union[bool, core.BoolOut] = core.attr(bool, computed=True)

    id: Union[str, core.StringOut] = core.attr(str, computed=True)

    instance_configuration: Union[
        List[InstanceConfiguration], core.ArrayOut[InstanceConfiguration]
