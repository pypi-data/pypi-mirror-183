...
class MysqlLayer(core.Resource):
    ...
    root_password: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)

    root_password_on_all_instances: Optional[Union[bool, core.BoolOut]] = core.attr(
        bool, default=None
    )
    ...
    def __init__(
        ...
        *,
        ...
        root_password: Optional[Union[str, core.StringOut]] = None,
        root_password_on_all_instances: Optional[Union[bool, core.BoolOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        root_password: Optional[Union[str, core.StringOut]] = core.arg(default=None)

        root_password_on_all_instances: Optional[Union[bool, core.BoolOut]] = core.arg(default=None)
