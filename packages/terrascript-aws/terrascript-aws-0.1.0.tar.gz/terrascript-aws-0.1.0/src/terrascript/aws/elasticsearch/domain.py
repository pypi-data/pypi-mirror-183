...
class Domain(core.Resource):
    ...
    elasticsearch_version: Optional[Union[str, core.StringOut]] = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        elasticsearch_version: Optional[Union[str, core.StringOut]] = None,
    ...
    class Args(core.Resource.Args):
        ...
        elasticsearch_version: Optional[Union[str, core.StringOut]] = core.arg(default=None)
