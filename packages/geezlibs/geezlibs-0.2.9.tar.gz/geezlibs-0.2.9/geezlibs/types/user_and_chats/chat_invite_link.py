...
import geezlibs
from geezlibs import raw, ramutils
...
class ChatInviteLink(Object):
    ...
    def _parse(
        ...
        return ChatInviteLink(
            ...
            date=ramutils.timestamp_to_datetime(invite.date),
            is_primary=invite.permanent,
            is_revoked=invite.revoked,
            creator=creator,
            name=invite.title,
            creates_join_request=invite.request_needed,
            start_date=ramutils.timestamp_to_datetime(invite.start_date),
            expire_date=ramutils.timestamp_to_datetime(invite.expire_date),
