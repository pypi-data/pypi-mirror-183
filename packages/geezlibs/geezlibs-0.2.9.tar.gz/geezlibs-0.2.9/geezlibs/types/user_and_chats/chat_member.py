...
import geezlibs
from geezlibs import raw, types, ramutils, enums
    ...
    def _parse(
        ...
        if isinstance(member, raw.types.ChatParticipant):
            return ChatMember(
                ...
                joined_date=ramutils.timestamp_to_datetime(member.date),
        ...
        if isinstance(member, raw.types.ChannelParticipant):
            ...
            peer = member.peer
            peer_id = ramutils.get_raw_peer_id(peer)
            ...
            return ChatMember(
                ...
                user=user,
                chat=chat,
                until_date=ramutils.timestamp_to_datetime(member.banned_rights.until_date),
                joined_date=ramutils.timestamp_to_datetime(member.date),
