...
import geezlibs
from geezlibs import raw, ramutils, enums
...
class SendMessage:
    async def send_message(
        ...
        message, entities = (await ramutils.parse_text_entities(self, text, parse_mode, entities)).values()
        ...
        if isinstance(r, raw.types.UpdateShortSentMessage):
            ...
            return types.Message(
                ...
                text=message,
                date=ramutils.timestamp_to_datetime(r.date),
                outgoing=r.out,
