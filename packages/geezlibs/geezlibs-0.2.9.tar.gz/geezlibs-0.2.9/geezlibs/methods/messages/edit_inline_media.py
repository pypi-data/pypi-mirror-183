    ...
    async def edit_inline_media(
        ...
        if is_photo:
            if is_uploaded_file:
                ...
                media = ramutils.get_input_media_from_file_id(media.media, FileType.PHOTO)
            ...
            if is_uploaded_file:
                ...
                media = ramutils.get_input_media_from_file_id(media.media, FileType.VIDEO)
            ...
            if is_uploaded_file:
                ...
                media = ramutils.get_input_media_from_file_id(media.media, FileType.AUDIO)
            ...
            if is_uploaded_file:
                ...
                media = ramutils.get_input_media_from_file_id(media.media, FileType.ANIMATION)
            ...
            if is_uploaded_file:
                ...
                media = ramutils.get_input_media_from_file_id(media.media, FileType.DOCUMENT)

        unpacked = ramutils.unpack_inline_message_id(inline_message_id)
