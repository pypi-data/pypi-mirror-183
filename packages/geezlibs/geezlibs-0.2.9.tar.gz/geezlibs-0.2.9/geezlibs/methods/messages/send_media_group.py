...
class SendMediaGroup:
    ...
    async def send_media_group(
            ...
            if isinstance(i, types.InputMediaPhoto):
                if isinstance(i.media, str):
                    if os.path.isfile(i.media):
                        ...
                        media = ramutils.get_input_media_from_file_id(i.media, FileType.PHOTO)
                else:
                    media = await self.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await self.resolve_peer(chat_id),
                ...
                if isinstance(i.media, str):
                    if os.path.isfile(i.media):
                        ...
                        media = ramutils.get_input_media_from_file_id(i.media, FileType.VIDEO)
                else:
                    media = await self.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await self.resolve_peer(chat_id),
                ...
                if isinstance(i.media, str):
                    if os.path.isfile(i.media):
                        ...
                        media = ramutils.get_input_media_from_file_id(i.media, FileType.AUDIO)
                else:
                    media = await self.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await self.resolve_peer(chat_id),
                ...
                if isinstance(i.media, str):
                    if os.path.isfile(i.media):
                        ...
                        media = ramutils.get_input_media_from_file_id(i.media, FileType.DOCUMENT)
                else:
                    media = await self.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await self.resolve_peer(chat_id),
        ...
        return await ramutils.parse_messages(
            self,
