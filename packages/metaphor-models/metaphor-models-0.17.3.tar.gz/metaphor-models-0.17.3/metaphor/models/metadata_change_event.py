...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(created_at, id, activity, person_created_at, deleted_at, display_name, entity_type, person_id, last_ingested_at, last_modified_at, logical_id, organization, properties, slack_profile, teams_conversion_reference)
