...
from .exceptions import DeviceConnectionError, DeviceUnspportedError, ApiError, DeviceApiError
...
async def api_request(
    ...
    try:
        async with aiohttp_session.get(
            ...
            if response.content_type != CONTENT_TYPE:
                raise DeviceUnspportedError("invalid content type")
    ...
    if "success" not in result:
        raise DeviceUnspportedError("response malformed")
