...
class OJ:
    ...
    def info(self, refresh=False):
        ...
        while True:
            ...
            tabel = soup.select_one('body > center:nth-child(1) > table:nth-child(7)')
            ...
            if len(trs) != 20:
                self._info = datas
                return datas
            next_page_url = f'{self.base_url}JudgeOnline/' + soup.select_one(
                'body > center:nth-child(1) > a:nth-child(10)').get('href')
    ...
    def submit_test_code(self, interval=10):
        """
        测试提交代码
        """
        ...
        self.load_and_submit('base_code.json', interval)
