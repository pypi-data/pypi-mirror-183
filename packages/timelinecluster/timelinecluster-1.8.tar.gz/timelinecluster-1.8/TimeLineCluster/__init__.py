        ...
        try:
            ...
            if(self.status):
                ...
                if(len(source_data) > 0): # check source data for process
                    ...
                    first_update_source = source_data.iloc[0] # store first update timestamp
                    ...
                    for i , source in enumerate(unique_source_data.iloc): # self.pk_report_name, self.pk_report_start_date
                        ...
                        if(self.generic.process_status == False):
                            self.genLogErrorPk(for_drop_report, unique_source_data, first_update_source, last_update_source)
                            return
