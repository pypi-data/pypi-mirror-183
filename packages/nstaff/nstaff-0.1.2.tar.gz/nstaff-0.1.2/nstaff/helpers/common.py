...
class Common:
    ...
    @staticmethod
    def convert_string_dictionary_to_dictionary(string_dictionary: str) -> dict:
        """
        Description
    ...
    def log_page_load_time(page_name, start_time, end_time):
        ...
        print(colored("\n[\n\tLoad Time: {} Seconds, \n\tMax Load Time: {} Seconds, \n\tPage: {} \n\tHost Internet "
                      "Speed: {} Mbps\n] "
                      .format(int(end_time - start_time), int(config.wait), page_name, config_v2.internet_speed), color_info))
    ...
    def print_info(message):
        print(colored(message, color_info))
