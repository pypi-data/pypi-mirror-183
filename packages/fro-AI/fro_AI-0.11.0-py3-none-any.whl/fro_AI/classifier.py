...
MODELS = {'resetnet18': models.resnet18, 'squeezenet1_0': models.squeezenet1_0}
...
class Classifier():
    ...
    def get_base_model(self, model_name='resetnet18', weights='pretrained'):
        ...
        Args:
            model_name (str, optional): 模型名称，目前支持 'resetnet18', 'squeezenet1_0'。 Defaults to 'resetnet18'.
    ...
    def create_optimizer(self, optim_name, lr=0.001):
        ...
        if optim_name == 'Adam':
            ...
            raise ValueError(f"unknow optim_name: {optim_name}")
    ...
    def train(self,
        ...
        Args:
            ...
            optimizer (str, optional): 优化器，目前支持 'Adam' 和 'SGD'. Defaults to 'Adam'.
