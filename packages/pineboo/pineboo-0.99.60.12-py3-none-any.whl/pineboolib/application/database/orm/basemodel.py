        ...
        if self._session is None:
            ...
            for relation in relations:
                for obj in getattr(self, relation, []):
                    list_objects_orig.append(obj)

            if relations:
                print("OJO1", list_objects_orig)
            ...
            if not only or "before_flush" in only:
                ...
                for relation in relations:
                    ...
                    print("OJO2 %s" % list_objects, list_objects_orig)
            ...
            if not only or "check_integrity" in only:
                ...
                for relation in relations:
                    list_objects = getattr(self, relation, [])
                    print("OJO3 %s" % list_objects, list_objects_orig)
            ...
            if not only or "flush" in only:
                for relation in relations:
                    list_objects = getattr(self, relation, [])
                    print("OJO4 %s" % list_objects, list_objects_orig)
                ...
                try:
                    ...
                    for relation in relations:
                        list_objects = getattr(self, relation, [])
                        print("OJO5 %s" % list_objects, list_objects_orig)
                        for list_object in list_objects:
