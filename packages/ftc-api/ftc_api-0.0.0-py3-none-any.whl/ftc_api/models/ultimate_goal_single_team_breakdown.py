...
T = TypeVar("T", bound="UltimateGoalSingleTeamBreakdown")


@attr.s(auto_attribs=True)
class UltimateGoalSingleTeamBreakdown:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ultimate_goal_single_team_breakdown = cls(
            adjust=adjust,
            dc_points=dc_points,
        ...
        return ultimate_goal_single_team_breakdown
