...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, HybridSchedule]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, HybridSchedule]]:
    return Response(
