...
class FreightFrenzyAllianceScoreDetails:
    ...
    Attributes:
        ...
        alliances (Union[Unset, None, List['FreightFrenzyAllianceScoreBreakdown']]):
    """
    ...
    alliances: Union[Unset, None, List["FreightFrenzyAllianceScoreBreakdown"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        freight_frenzy_alliance_score_details = cls(
        ...
        return freight_frenzy_alliance_score_details
