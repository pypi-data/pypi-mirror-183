...
class PowerPlaySingleTeamScoreDetails:
    ...
    Attributes:
        ...
        scores (Union[Unset, PowerPlayRemoteScoreBreakdown]):
    """
    ...
    scores: Union[Unset, "PowerPlayRemoteScoreBreakdown"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = PowerPlayRemoteScoreBreakdown.from_dict(_scores)

        power_play_single_team_score_details = cls(
        ...
        return power_play_single_team_score_details
