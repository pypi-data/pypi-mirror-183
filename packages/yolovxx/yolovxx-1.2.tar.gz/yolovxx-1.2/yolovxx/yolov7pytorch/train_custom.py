...
class Yolov7:
    ...
    def __init__(self, classes_path: str = 'voc_classes.txt', VOCdevkit_path: str = '.',
                 anchors_path: str = 'yolovxx/yolov7pytorch/yolo_anchors.txt', fonts: str = ".",
    ...
    def predict(self, cuda: bool = True, model_path: str = "", mode: str = "predict",
        ...
        yolo = YOLO(model_path=model_path, classes_path=self.classes_path, anchors_path=self.anchors_path,
                    anchors_mask=self.anchors_mask, input_shape=self.input_shape, phi=self.phi, fonts=self.fonts,
