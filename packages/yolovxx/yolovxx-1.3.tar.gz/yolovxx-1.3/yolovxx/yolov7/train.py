...
class Yolov7:
    ...
    def __init__(self, classes_path: str = 'voc_classes.txt', VOCdevkit_path: str = '.',
                 anchors: List[list] = [[ 12., 16.], [ 19., 36.], [ 40., 28.], [ 36., 75.], [ 76., 55.], [ 72., 146.], [142., 110.], [192., 243.], [459., 401.]],
                 fonts: str = ".", phi: str = "l", input_shape: list = [640, 640], anchors_mask: List[list] = [[6, 7, 8], [3, 4, 5], [0, 1, 2]]) -> None:
    ...
    def train(self, cuda: bool = True, distributed: bool = False, sync_bn: bool = False,
        ...
        print("[infooooooooo]", anchors)
        print("[infooooooooo]", num_anchors)
        exit(0)
