...
from geodesic.descriptors import _StringDescr, _BoolDescr, _ListDescr, _DictDescr, _IntDescr, _BaseDescr
...
class BosonConfig(_APIObject):
    ...
    credential = _StringDescr(doc="credential needed to access this dataset")
...
class BosonDescr(_BaseDescr):
    ...
    __set__ sets from a dictionary or BosonConfig, coercing to a BosonConfig if needed and stores internally to the APIObject dict
    """
