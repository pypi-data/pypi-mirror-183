...
class Progress(Thread):
    ...
    Args:
        interval: Sets the time interval to be displayed on the screen.
        stdout: Sets the standard output
    ...
    def set_meta(self, total_length, object_name):
        ...
        Args:
            total_length: Total length of object.
            object_name: Object name to be showed.
        """
        self.total_length = total_length
        self.object_name = object_name
        self.prefix = f'{self.object_name}: ' if self.object_name else ''
    ...
    def update(self, size):
        ...
        Args:
            size: Object size to be showed. The object size should be in bytes.
        """
...
def format_string(current_size, total_length, elapsed_time):
    ...
    Args:
        current_size: Number of finished object size
        total_length: Total object size
        elapsed_time: number of seconds passed since start
    """
