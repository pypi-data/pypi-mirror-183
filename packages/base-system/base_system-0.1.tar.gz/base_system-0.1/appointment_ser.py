...
from work_scheduling.models import DoctorWorkShift
...
class DoctorWorkShiftSerializer(serializers.ModelSerializer):
    ...
    # wstype = serializers.SerializerMethodField()
    ...
    def get_weekday(self, obj):
        weekday = obj.week_day.week_day
        return weekday

    def get_wstype(self, obj):
        wstype = obj.ws_type.name
        return wstype
