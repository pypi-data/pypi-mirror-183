...
class CognitoAuthenticator(Authenticator):
    ...
    async def authenticate(self, handler, data):
        ...
        try:
            ...
            if "ChallengeName" in response:
                if response['ChallengeName'] == 'NEW_PASSWORD_REQUIRED':
                    self.CognitoResponse = "Please Change Password!!"
                    return
        ...
        if not user:
            ...
            infos = {"username": username, "is_authorized": True, "email": username}
    ...
    def get_handlers(self, app):
        native_handlers = [
            ...
            (r"/static/images/(.*)", CustomHandler, {"path": "./templates/images/sigma.png"}),
        ]
