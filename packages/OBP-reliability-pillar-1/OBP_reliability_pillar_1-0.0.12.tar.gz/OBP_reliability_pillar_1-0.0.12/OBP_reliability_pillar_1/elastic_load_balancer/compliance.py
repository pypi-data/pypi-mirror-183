import logging
from OBP_reliability_pillar_1.elastic_load_balancer.cross_zone_load_balancing_enabled import \
    cross_zone_load_balancing_enabled
from OBP_reliability_pillar_1.elastic_load_balancer.elb_deletion_protection import elb_deletion_protection_enabled
