...
if TYPE_CHECKING:
    from ..models.address_data_attributes_metadata import AddressDataAttributesMetadata


T = TypeVar("T", bound="AddressDataAttributes")


@attr.s(auto_attribs=True)
class AddressDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AddressDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "AddressDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AddressDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AddressDataAttributesMetadata.from_dict(_metadata)

        address_data_attributes = cls(
            business=business,
        ...
        address_data_attributes.additional_properties = d
        return address_data_attributes
