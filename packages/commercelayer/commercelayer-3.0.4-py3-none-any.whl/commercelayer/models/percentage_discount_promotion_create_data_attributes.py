...
if TYPE_CHECKING:
    from ..models.percentage_discount_promotion_create_data_attributes_metadata import (
        PercentageDiscountPromotionCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="PercentageDiscountPromotionCreateDataAttributes")


@attr.s(auto_attribs=True)
class PercentageDiscountPromotionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PercentageDiscountPromotionCreateDataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PercentageDiscountPromotionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PercentageDiscountPromotionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PercentageDiscountPromotionCreateDataAttributesMetadata.from_dict(_metadata)

        percentage_discount_promotion_create_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        percentage_discount_promotion_create_data_attributes.additional_properties = d
        return percentage_discount_promotion_create_data_attributes
