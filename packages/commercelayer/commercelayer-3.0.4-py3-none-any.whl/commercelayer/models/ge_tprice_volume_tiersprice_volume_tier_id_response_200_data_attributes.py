...
if TYPE_CHECKING:
    from ..models.ge_tprice_volume_tiersprice_volume_tier_id_response_200_data_attributes_metadata import (
        GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributes:
    """
    Attributes:
        ...
        formatted_price_amount (Union[Unset, str]): The price of this price tier, formatted. Example: €10,00.
        ...
        metadata (Union[Unset, GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpriceVolumeTierspriceVolumeTierIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tprice_volume_tiersprice_volume_tier_id_response_200_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        ge_tprice_volume_tiersprice_volume_tier_id_response_200_data_attributes.additional_properties = d
        return ge_tprice_volume_tiersprice_volume_tier_id_response_200_data_attributes
