...
if TYPE_CHECKING:
    from ..models.sku_list_data_attributes_metadata import SkuListDataAttributesMetadata


T = TypeVar("T", bound="SkuListDataAttributes")


@attr.s(auto_attribs=True)
class SkuListDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "SkuListDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListDataAttributesMetadata.from_dict(_metadata)

        sku_list_data_attributes = cls(
            name=name,
            slug=slug,
        ...
        sku_list_data_attributes.additional_properties = d
        return sku_list_data_attributes
