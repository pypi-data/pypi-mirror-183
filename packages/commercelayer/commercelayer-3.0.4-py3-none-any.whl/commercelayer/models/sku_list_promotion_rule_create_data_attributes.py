...
if TYPE_CHECKING:
    from ..models.sku_list_promotion_rule_create_data_attributes_metadata import (
        SkuListPromotionRuleCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="SkuListPromotionRuleCreateDataAttributes")


@attr.s(auto_attribs=True)
class SkuListPromotionRuleCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListPromotionRuleCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "SkuListPromotionRuleCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListPromotionRuleCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListPromotionRuleCreateDataAttributesMetadata.from_dict(_metadata)

        all_skus = d.pop("all_skus", UNSET)

        min_quantity = d.pop("min_quantity", UNSET)

        sku_list_promotion_rule_create_data_attributes = cls(
            reference=reference,
        ...
        sku_list_promotion_rule_create_data_attributes.additional_properties = d
        return sku_list_promotion_rule_create_data_attributes
