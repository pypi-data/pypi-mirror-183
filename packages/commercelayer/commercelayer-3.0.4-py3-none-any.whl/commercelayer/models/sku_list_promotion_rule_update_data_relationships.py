...
if TYPE_CHECKING:
    ...
    from ..models.sku_list_promotion_rule_update_data_relationships_sku_list import (
        SkuListPromotionRuleUpdateDataRelationshipsSkuList,
    )


T = TypeVar("T", bound="SkuListPromotionRuleUpdateDataRelationships")


@attr.s(auto_attribs=True)
class SkuListPromotionRuleUpdateDataRelationships:
    """
    Attributes:
        ...
        sku_list (Union[Unset, SkuListPromotionRuleUpdateDataRelationshipsSkuList]):
    """
    ...
    sku_list: Union[Unset, "SkuListPromotionRuleUpdateDataRelationshipsSkuList"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sku_list, Unset):
            ...
            sku_list = SkuListPromotionRuleUpdateDataRelationshipsSkuList.from_dict(_sku_list)

        sku_list_promotion_rule_update_data_relationships = cls(
            promotion=promotion,
            sku_list=sku_list,
        )

        sku_list_promotion_rule_update_data_relationships.additional_properties = d
        return sku_list_promotion_rule_update_data_relationships
