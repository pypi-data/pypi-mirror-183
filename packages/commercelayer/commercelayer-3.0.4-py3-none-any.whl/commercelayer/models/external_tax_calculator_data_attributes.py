...
if TYPE_CHECKING:
    from ..models.external_tax_calculator_data_attributes_metadata import ExternalTaxCalculatorDataAttributesMetadata


T = TypeVar("T", bound="ExternalTaxCalculatorDataAttributes")


@attr.s(auto_attribs=True)
class ExternalTaxCalculatorDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ExternalTaxCalculatorDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "ExternalTaxCalculatorDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.external_tax_calculator_data_attributes_metadata import (
            ExternalTaxCalculatorDataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, ExternalTaxCalculatorDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExternalTaxCalculatorDataAttributesMetadata.from_dict(_metadata)

        tax_calculator_url = d.pop("tax_calculator_url", UNSET)

        shared_secret = d.pop("shared_secret", UNSET)

        external_tax_calculator_data_attributes = cls(
            name=name,
        ...
        external_tax_calculator_data_attributes.additional_properties = d
        return external_tax_calculator_data_attributes
