...
if TYPE_CHECKING:
    from ..models.ge_tvoidsvoid_id_response_200_data_attributes_metadata import (
        GETvoidsvoidIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETvoidsvoidIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETvoidsvoidIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETvoidsvoidIdResponse200DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETvoidsvoidIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETvoidsvoidIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETvoidsvoidIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tvoidsvoid_id_response_200_data_attributes = cls(
            number=number,
        ...
        ge_tvoidsvoid_id_response_200_data_attributes.additional_properties = d
        return ge_tvoidsvoid_id_response_200_data_attributes
