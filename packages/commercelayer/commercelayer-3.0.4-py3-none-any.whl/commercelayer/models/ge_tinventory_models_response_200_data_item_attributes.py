...
if TYPE_CHECKING:
    from ..models.ge_tinventory_models_response_200_data_item_attributes_metadata import (
        GETinventoryModelsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETinventoryModelsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETinventoryModelsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETinventoryModelsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETinventoryModelsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETinventoryModelsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETinventoryModelsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tinventory_models_response_200_data_item_attributes = cls(
            name=name,
            strategy=strategy,
        ...
        ge_tinventory_models_response_200_data_item_attributes.additional_properties = d
        return ge_tinventory_models_response_200_data_item_attributes
