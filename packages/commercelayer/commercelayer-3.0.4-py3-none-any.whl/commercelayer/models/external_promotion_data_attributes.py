...
if TYPE_CHECKING:
    from ..models.external_promotion_data_attributes_metadata import ExternalPromotionDataAttributesMetadata


T = TypeVar("T", bound="ExternalPromotionDataAttributes")


@attr.s(auto_attribs=True)
class ExternalPromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ExternalPromotionDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "ExternalPromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ExternalPromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExternalPromotionDataAttributesMetadata.from_dict(_metadata)

        promotion_url = d.pop("promotion_url", UNSET)

        shared_secret = d.pop("shared_secret", UNSET)

        external_promotion_data_attributes = cls(
            name=name,
        ...
        external_promotion_data_attributes.additional_properties = d
        return external_promotion_data_attributes
