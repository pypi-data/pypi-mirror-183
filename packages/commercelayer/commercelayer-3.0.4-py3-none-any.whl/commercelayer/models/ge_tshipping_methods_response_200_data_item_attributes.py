...
if TYPE_CHECKING:
    from ..models.ge_tshipping_methods_response_200_data_item_attributes_metadata import (
        GETshippingMethodsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingMethodsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETshippingMethodsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingMethodsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETshippingMethodsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingMethodsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingMethodsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tshipping_methods_response_200_data_item_attributes = cls(
            name=name,
            scheme=scheme,
        ...
        ge_tshipping_methods_response_200_data_item_attributes.additional_properties = d
        return ge_tshipping_methods_response_200_data_item_attributes
