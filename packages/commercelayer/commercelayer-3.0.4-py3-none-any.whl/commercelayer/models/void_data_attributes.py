...
if TYPE_CHECKING:
    from ..models.void_data_attributes_metadata import VoidDataAttributesMetadata


T = TypeVar("T", bound="VoidDataAttributes")


@attr.s(auto_attribs=True)
class VoidDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, VoidDataAttributesMetadata]): Set of key-value pairs that you can attach to the resource.
    ...
    metadata: Union[Unset, "VoidDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, VoidDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = VoidDataAttributesMetadata.from_dict(_metadata)

        void_data_attributes = cls(
            number=number,
        ...
        void_data_attributes.additional_properties = d
        return void_data_attributes
