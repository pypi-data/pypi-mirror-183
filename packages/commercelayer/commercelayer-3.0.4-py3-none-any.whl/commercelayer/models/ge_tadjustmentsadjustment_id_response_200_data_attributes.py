...
if TYPE_CHECKING:
    from ..models.ge_tadjustmentsadjustment_id_response_200_data_attributes_metadata import (
        GETadjustmentsadjustmentIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETadjustmentsadjustmentIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETadjustmentsadjustmentIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETadjustmentsadjustmentIdResponse200DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETadjustmentsadjustmentIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETadjustmentsadjustmentIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETadjustmentsadjustmentIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tadjustmentsadjustment_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tadjustmentsadjustment_id_response_200_data_attributes.additional_properties = d
        return ge_tadjustmentsadjustment_id_response_200_data_attributes
