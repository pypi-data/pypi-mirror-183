...
if TYPE_CHECKING:
    from ..models.ge_tsku_listssku_list_id_response_200_data_attributes_metadata import (
        GETskuListsskuListIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETskuListsskuListIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETskuListsskuListIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETskuListsskuListIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETskuListsskuListIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETskuListsskuListIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETskuListsskuListIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tsku_listssku_list_id_response_200_data_attributes = cls(
            name=name,
            slug=slug,
        ...
        ge_tsku_listssku_list_id_response_200_data_attributes.additional_properties = d
        return ge_tsku_listssku_list_id_response_200_data_attributes
