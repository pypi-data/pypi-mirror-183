...
if TYPE_CHECKING:
    from ..models.ge_texternal_gateways_response_200_data_item_attributes_metadata import (
        GETexternalGatewaysResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETexternalGatewaysResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETexternalGatewaysResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETexternalGatewaysResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETexternalGatewaysResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETexternalGatewaysResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETexternalGatewaysResponse200DataItemAttributesMetadata.from_dict(_metadata)
        ...
        ge_texternal_gateways_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_texternal_gateways_response_200_data_item_attributes.additional_properties = d
        return ge_texternal_gateways_response_200_data_item_attributes
