...
if TYPE_CHECKING:
    from ..models.percentage_discount_promotion_update_data_attributes_metadata import (
        PercentageDiscountPromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="PercentageDiscountPromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class PercentageDiscountPromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PercentageDiscountPromotionUpdateDataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PercentageDiscountPromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PercentageDiscountPromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PercentageDiscountPromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        percentage = d.pop("percentage", UNSET)

        percentage_discount_promotion_update_data_attributes = cls(
            name=name,
        ...
        percentage_discount_promotion_update_data_attributes.additional_properties = d
        return percentage_discount_promotion_update_data_attributes
