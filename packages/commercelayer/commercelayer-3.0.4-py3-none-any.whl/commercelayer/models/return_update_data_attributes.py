...
if TYPE_CHECKING:
    from ..models.return_update_data_attributes_metadata import ReturnUpdateDataAttributesMetadata


T = TypeVar("T", bound="ReturnUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ReturnUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ReturnUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ReturnUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ReturnUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ReturnUpdateDataAttributesMetadata.from_dict(_metadata)

        return_update_data_attributes = cls(
            request=request,
            approve=approve,
            cancel=cancel,
            ship=ship,
        ...
        return_update_data_attributes.additional_properties = d
        return return_update_data_attributes
