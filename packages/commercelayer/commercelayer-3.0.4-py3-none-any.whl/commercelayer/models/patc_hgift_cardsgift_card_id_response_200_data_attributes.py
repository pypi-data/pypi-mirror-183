...
if TYPE_CHECKING:
    from ..models.patc_hgift_cardsgift_card_id_response_200_data_attributes_metadata import (
        PATCHgiftCardsgiftCardIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHgiftCardsgiftCardIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHgiftCardsgiftCardIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHgiftCardsgiftCardIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHgiftCardsgiftCardIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHgiftCardsgiftCardIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHgiftCardsgiftCardIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hgift_cardsgift_card_id_response_200_data_attributes = cls(
        ...
        patc_hgift_cardsgift_card_id_response_200_data_attributes.additional_properties = d
        return patc_hgift_cardsgift_card_id_response_200_data_attributes
