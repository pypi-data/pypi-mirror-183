...
if TYPE_CHECKING:
    from ..models.ge_tshipping_zones_response_200_data_item_attributes_metadata import (
        GETshippingZonesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingZonesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETshippingZonesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingZonesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETshippingZonesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingZonesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingZonesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tshipping_zones_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tshipping_zones_response_200_data_item_attributes.additional_properties = d
        return ge_tshipping_zones_response_200_data_item_attributes
