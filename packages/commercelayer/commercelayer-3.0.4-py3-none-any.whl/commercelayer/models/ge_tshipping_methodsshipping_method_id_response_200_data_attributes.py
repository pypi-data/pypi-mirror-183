...
if TYPE_CHECKING:
    from ..models.ge_tshipping_methodsshipping_method_id_response_200_data_attributes_metadata import (
        GETshippingMethodsshippingMethodIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingMethodsshippingMethodIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETshippingMethodsshippingMethodIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingMethodsshippingMethodIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETshippingMethodsshippingMethodIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingMethodsshippingMethodIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingMethodsshippingMethodIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tshipping_methodsshipping_method_id_response_200_data_attributes = cls(
            name=name,
            scheme=scheme,
        ...
        ge_tshipping_methodsshipping_method_id_response_200_data_attributes.additional_properties = d
        return ge_tshipping_methodsshipping_method_id_response_200_data_attributes
