...
if TYPE_CHECKING:
    from ..models.fixed_price_promotion_update_data_attributes_metadata import (
        FixedPricePromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FixedPricePromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class FixedPricePromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FixedPricePromotionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FixedPricePromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FixedPricePromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FixedPricePromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        fixed_amount_cents = d.pop("fixed_amount_cents", UNSET)

        fixed_price_promotion_update_data_attributes = cls(
            name=name,
        ...
        fixed_price_promotion_update_data_attributes.additional_properties = d
        return fixed_price_promotion_update_data_attributes
