...
if TYPE_CHECKING:
    from ..models.ge_tfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes_metadata import (
        GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata]): Set of key-
    ...
    metadata: Union[Unset, "GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        ge_tfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes.additional_properties = d
        return ge_tfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes
