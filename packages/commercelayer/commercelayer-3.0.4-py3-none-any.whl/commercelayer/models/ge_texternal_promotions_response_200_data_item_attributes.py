...
if TYPE_CHECKING:
    from ..models.ge_texternal_promotions_response_200_data_item_attributes_metadata import (
        GETexternalPromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETexternalPromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETexternalPromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETexternalPromotionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETexternalPromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETexternalPromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETexternalPromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        promotion_url = d.pop("promotion_url", UNSET)

        shared_secret = d.pop("shared_secret", UNSET)

        ge_texternal_promotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_texternal_promotions_response_200_data_item_attributes.additional_properties = d
        return ge_texternal_promotions_response_200_data_item_attributes
