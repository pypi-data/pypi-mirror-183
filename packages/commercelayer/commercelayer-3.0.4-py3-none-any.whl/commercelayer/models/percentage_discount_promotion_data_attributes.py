...
if TYPE_CHECKING:
    from ..models.percentage_discount_promotion_data_attributes_metadata import (
        PercentageDiscountPromotionDataAttributesMetadata,
    )


T = TypeVar("T", bound="PercentageDiscountPromotionDataAttributes")


@attr.s(auto_attribs=True)
class PercentageDiscountPromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PercentageDiscountPromotionDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "PercentageDiscountPromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PercentageDiscountPromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PercentageDiscountPromotionDataAttributesMetadata.from_dict(_metadata)

        percentage = d.pop("percentage", UNSET)

        percentage_discount_promotion_data_attributes = cls(
            name=name,
        ...
        percentage_discount_promotion_data_attributes.additional_properties = d
        return percentage_discount_promotion_data_attributes
