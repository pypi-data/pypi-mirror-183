...
if TYPE_CHECKING:
    from ..models.ge_tfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes_metadata import (
        GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata]): Set of
    ...
    metadata: Union[Unset, "GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )
        ...
        ge_tfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes.additional_properties = d
        return ge_tfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes
