...
if TYPE_CHECKING:
    from ..models.ge_tline_item_optionsline_item_option_id_response_200_data_attributes_metadata import (
        GETlineItemOptionslineItemOptionIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_tline_item_optionsline_item_option_id_response_200_data_attributes_options import (
        GETlineItemOptionslineItemOptionIdResponse200DataAttributesOptions,
    )


T = TypeVar("T", bound="GETlineItemOptionslineItemOptionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETlineItemOptionslineItemOptionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        delay_days (Union[Unset, int]): The shipping delay that the customer can expect when adding this option (days,
            rounded). Example: 2.
        options (Union[Unset, GETlineItemOptionslineItemOptionIdResponse200DataAttributesOptions]): Set of key-value
        ...
        metadata (Union[Unset, GETlineItemOptionslineItemOptionIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    options: Union[Unset, "GETlineItemOptionslineItemOptionIdResponse200DataAttributesOptions"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETlineItemOptionslineItemOptionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, GETlineItemOptionslineItemOptionIdResponse200DataAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = GETlineItemOptionslineItemOptionIdResponse200DataAttributesOptions.from_dict(_options)
        ...
        metadata: Union[Unset, GETlineItemOptionslineItemOptionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETlineItemOptionslineItemOptionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tline_item_optionsline_item_option_id_response_200_data_attributes = cls(
            name=name,
            quantity=quantity,
        ...
        ge_tline_item_optionsline_item_option_id_response_200_data_attributes.additional_properties = d
        return ge_tline_item_optionsline_item_option_id_response_200_data_attributes
