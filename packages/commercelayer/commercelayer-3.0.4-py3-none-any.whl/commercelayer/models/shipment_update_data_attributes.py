...
if TYPE_CHECKING:
    from ..models.shipment_update_data_attributes_metadata import ShipmentUpdateDataAttributesMetadata


T = TypeVar("T", bound="ShipmentUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ShipmentUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShipmentUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ShipmentUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShipmentUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShipmentUpdateDataAttributesMetadata.from_dict(_metadata)

        shipment_update_data_attributes = cls(
            on_hold=on_hold,
            picking=picking,
            packing=packing,
        ...
        shipment_update_data_attributes.additional_properties = d
        return shipment_update_data_attributes
