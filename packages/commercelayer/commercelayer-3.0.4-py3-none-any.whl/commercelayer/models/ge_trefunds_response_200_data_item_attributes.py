...
if TYPE_CHECKING:
    from ..models.ge_trefunds_response_200_data_item_attributes_metadata import (
        GETrefundsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETrefundsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETrefundsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETrefundsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETrefundsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETrefundsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETrefundsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_trefunds_response_200_data_item_attributes = cls(
            number=number,
        ...
        ge_trefunds_response_200_data_item_attributes.additional_properties = d
        return ge_trefunds_response_200_data_item_attributes
