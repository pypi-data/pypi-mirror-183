...
if TYPE_CHECKING:
    from ..models.promotion_data_attributes_metadata import PromotionDataAttributesMetadata


T = TypeVar("T", bound="PromotionDataAttributes")


@attr.s(auto_attribs=True)
class PromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PromotionDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PromotionDataAttributesMetadata.from_dict(_metadata)

        promotion_data_attributes = cls(
            name=name,
        ...
        promotion_data_attributes.additional_properties = d
        return promotion_data_attributes
