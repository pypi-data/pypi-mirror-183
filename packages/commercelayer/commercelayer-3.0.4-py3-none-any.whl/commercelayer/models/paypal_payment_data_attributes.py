...
if TYPE_CHECKING:
    from ..models.paypal_payment_data_attributes_metadata import PaypalPaymentDataAttributesMetadata


T = TypeVar("T", bound="PaypalPaymentDataAttributes")


@attr.s(auto_attribs=True)
class PaypalPaymentDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PaypalPaymentDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PaypalPaymentDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PaypalPaymentDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PaypalPaymentDataAttributesMetadata.from_dict(_metadata)

        paypal_payment_data_attributes = cls(
        ...
        paypal_payment_data_attributes.additional_properties = d
        return paypal_payment_data_attributes
