...
if TYPE_CHECKING:
    from ..models.inventory_model_data_attributes_metadata import InventoryModelDataAttributesMetadata


T = TypeVar("T", bound="InventoryModelDataAttributes")


@attr.s(auto_attribs=True)
class InventoryModelDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, InventoryModelDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "InventoryModelDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, InventoryModelDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = InventoryModelDataAttributesMetadata.from_dict(_metadata)

        inventory_model_data_attributes = cls(
            name=name,
            strategy=strategy,
        ...
        inventory_model_data_attributes.additional_properties = d
        return inventory_model_data_attributes
