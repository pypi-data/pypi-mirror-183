...
if TYPE_CHECKING:
    from ..models.ge_tshipping_weight_tiers_response_200_data_item_attributes_metadata import (
        GETshippingWeightTiersResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingWeightTiersResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETshippingWeightTiersResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingWeightTiersResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETshippingWeightTiersResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingWeightTiersResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingWeightTiersResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tshipping_weight_tiers_response_200_data_item_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        ge_tshipping_weight_tiers_response_200_data_item_attributes.additional_properties = d
        return ge_tshipping_weight_tiers_response_200_data_item_attributes
