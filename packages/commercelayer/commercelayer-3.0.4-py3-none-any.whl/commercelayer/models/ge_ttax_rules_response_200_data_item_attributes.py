...
if TYPE_CHECKING:
    from ..models.ge_ttax_rules_response_200_data_item_attributes_breakdown import (
        GETtaxRulesResponse200DataItemAttributesBreakdown,
    )
    from ..models.ge_ttax_rules_response_200_data_item_attributes_metadata import (
        GETtaxRulesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETtaxRulesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETtaxRulesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        breakdown (Union[Unset, GETtaxRulesResponse200DataItemAttributesBreakdown]): The breakdown for this tax rule (if
            calculated). Example: {'41': {'tax_rate': 0.22}}.
        ...
        metadata (Union[Unset, GETtaxRulesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    breakdown: Union[Unset, "GETtaxRulesResponse200DataItemAttributesBreakdown"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETtaxRulesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        breakdown: Union[Unset, GETtaxRulesResponse200DataItemAttributesBreakdown]
        if isinstance(_breakdown, Unset):
            breakdown = UNSET
        else:
            breakdown = GETtaxRulesResponse200DataItemAttributesBreakdown.from_dict(_breakdown)
        ...
        metadata: Union[Unset, GETtaxRulesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETtaxRulesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_ttax_rules_response_200_data_item_attributes = cls(
            name=name,
            tax_rate=tax_rate,
        ...
        ge_ttax_rules_response_200_data_item_attributes.additional_properties = d
        return ge_ttax_rules_response_200_data_item_attributes
