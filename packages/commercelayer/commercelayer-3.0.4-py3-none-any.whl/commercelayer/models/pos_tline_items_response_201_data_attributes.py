...
if TYPE_CHECKING:
    from ..models.pos_tline_items_response_201_data_attributes_metadata import (
        POSTlineItemsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTlineItemsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTlineItemsResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTlineItemsResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTlineItemsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTlineItemsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTlineItemsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tline_items_response_201_data_attributes = cls(
            quantity=quantity,
            sku_code=sku_code,
        ...
        pos_tline_items_response_201_data_attributes.additional_properties = d
        return pos_tline_items_response_201_data_attributes
