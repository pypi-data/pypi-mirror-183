...
if TYPE_CHECKING:
    from ..models.ge_tfixed_amount_promotions_response_200_data_item_attributes_metadata import (
        GETfixedAmountPromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETfixedAmountPromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETfixedAmountPromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfixedAmountPromotionsResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETfixedAmountPromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfixedAmountPromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfixedAmountPromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)
        ...
        ge_tfixed_amount_promotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tfixed_amount_promotions_response_200_data_item_attributes.additional_properties = d
        return ge_tfixed_amount_promotions_response_200_data_item_attributes
