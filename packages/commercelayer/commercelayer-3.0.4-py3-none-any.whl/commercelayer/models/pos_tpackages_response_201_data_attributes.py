...
if TYPE_CHECKING:
    from ..models.pos_tpackages_response_201_data_attributes_metadata import (
        POSTpackagesResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTpackagesResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTpackagesResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTpackagesResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTpackagesResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTpackagesResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTpackagesResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tpackages_response_201_data_attributes = cls(
            name=name,
            length=length,
            width=width,
            height=height,
        ...
        pos_tpackages_response_201_data_attributes.additional_properties = d
        return pos_tpackages_response_201_data_attributes
