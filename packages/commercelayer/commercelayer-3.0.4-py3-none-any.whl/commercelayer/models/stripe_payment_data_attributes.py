...
if TYPE_CHECKING:
    from ..models.stripe_payment_data_attributes_metadata import StripePaymentDataAttributesMetadata
    from ..models.stripe_payment_data_attributes_options import StripePaymentDataAttributesOptions
    from ..models.stripe_payment_data_attributes_payment_method import StripePaymentDataAttributesPaymentMethod


T = TypeVar("T", bound="StripePaymentDataAttributes")


@attr.s(auto_attribs=True)
class StripePaymentDataAttributes:
    """
    Attributes:
        ...
        options (Union[Unset, StripePaymentDataAttributesOptions]): Stripe payment options: 'setup_future_usage',
            'customer', and 'payment_method' Example: {'customer': 'cus_xxx', 'payment_method': 'pm_xxx'}.
        payment_method (Union[Unset, StripePaymentDataAttributesPaymentMethod]): Stripe 'payment_method', set by
            webhook. Example: {'id': 'pm_xxx'}.
        ...
        metadata (Union[Unset, StripePaymentDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    options: Union[Unset, "StripePaymentDataAttributesOptions"] = UNSET
    payment_method: Union[Unset, "StripePaymentDataAttributesPaymentMethod"] = UNSET
    ...
    metadata: Union[Unset, "StripePaymentDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, StripePaymentDataAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = StripePaymentDataAttributesOptions.from_dict(_options)

        _payment_method = d.pop("payment_method", UNSET)
        payment_method: Union[Unset, StripePaymentDataAttributesPaymentMethod]
        if isinstance(_payment_method, Unset):
            payment_method = UNSET
        else:
            payment_method = StripePaymentDataAttributesPaymentMethod.from_dict(_payment_method)
        ...
        metadata: Union[Unset, StripePaymentDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StripePaymentDataAttributesMetadata.from_dict(_metadata)

        stripe_payment_data_attributes = cls(
        ...
        stripe_payment_data_attributes.additional_properties = d
        return stripe_payment_data_attributes
