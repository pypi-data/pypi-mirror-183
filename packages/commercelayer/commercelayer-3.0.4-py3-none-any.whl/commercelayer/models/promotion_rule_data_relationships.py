...
T = TypeVar("T", bound="PromotionRuleDataRelationships")


@attr.s(auto_attribs=True)
class PromotionRuleDataRelationships:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        promotion_rule_data_relationships = cls(
            promotion=promotion,
        )

        promotion_rule_data_relationships.additional_properties = d
        return promotion_rule_data_relationships
