...
if TYPE_CHECKING:
    from ..models.shipping_weight_tier_data_attributes_metadata import ShippingWeightTierDataAttributesMetadata


T = TypeVar("T", bound="ShippingWeightTierDataAttributes")


@attr.s(auto_attribs=True)
class ShippingWeightTierDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingWeightTierDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "ShippingWeightTierDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingWeightTierDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingWeightTierDataAttributesMetadata.from_dict(_metadata)

        shipping_weight_tier_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        shipping_weight_tier_data_attributes.additional_properties = d
        return shipping_weight_tier_data_attributes
