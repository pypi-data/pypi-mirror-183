...
if TYPE_CHECKING:
    from ..models.pos_tinventory_models_response_201_data_attributes_metadata import (
        POSTinventoryModelsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTinventoryModelsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTinventoryModelsResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTinventoryModelsResponse201DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "POSTinventoryModelsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTinventoryModelsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTinventoryModelsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tinventory_models_response_201_data_attributes = cls(
            name=name,
            strategy=strategy,
        ...
        pos_tinventory_models_response_201_data_attributes.additional_properties = d
        return pos_tinventory_models_response_201_data_attributes
