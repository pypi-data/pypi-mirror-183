...
if TYPE_CHECKING:
    ...
    from ..models.customer_payment_source_update_data_relationships_customer import (
        CustomerPaymentSourceUpdateDataRelationshipsCustomer,
    )
...
T = TypeVar("T", bound="CustomerPaymentSourceUpdateDataRelationships")


@attr.s(auto_attribs=True)
class CustomerPaymentSourceUpdateDataRelationships:
    """
    Attributes:
        customer (Union[Unset, CustomerPaymentSourceUpdateDataRelationshipsCustomer]):
    ...
    customer: Union[Unset, "CustomerPaymentSourceUpdateDataRelationshipsCustomer"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_customer, Unset):
            ...
            customer = CustomerPaymentSourceUpdateDataRelationshipsCustomer.from_dict(_customer)
        ...
        customer_payment_source_update_data_relationships = cls(
            customer=customer,
            payment_source=payment_source,
        )

        customer_payment_source_update_data_relationships.additional_properties = d
        return customer_payment_source_update_data_relationships
