...
if TYPE_CHECKING:
    from ..models.avalara_account_create_data_attributes_metadata import AvalaraAccountCreateDataAttributesMetadata


T = TypeVar("T", bound="AvalaraAccountCreateDataAttributes")


@attr.s(auto_attribs=True)
class AvalaraAccountCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AvalaraAccountCreateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "AvalaraAccountCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AvalaraAccountCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AvalaraAccountCreateDataAttributesMetadata.from_dict(_metadata)

        commit_invoice = d.pop("commit_invoice", UNSET)

        ddp = d.pop("ddp", UNSET)

        avalara_account_create_data_attributes = cls(
            name=name,
            username=username,
            password=password,
            company_code=company_code,
        ...
        avalara_account_create_data_attributes.additional_properties = d
        return avalara_account_create_data_attributes
