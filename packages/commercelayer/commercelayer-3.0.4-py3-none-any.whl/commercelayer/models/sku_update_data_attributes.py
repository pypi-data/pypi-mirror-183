...
if TYPE_CHECKING:
    from ..models.sku_update_data_attributes_metadata import SkuUpdateDataAttributesMetadata


T = TypeVar("T", bound="SkuUpdateDataAttributes")


@attr.s(auto_attribs=True)
class SkuUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "SkuUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuUpdateDataAttributesMetadata.from_dict(_metadata)

        sku_update_data_attributes = cls(
            code=code,
            name=name,
        ...
        sku_update_data_attributes.additional_properties = d
        return sku_update_data_attributes
