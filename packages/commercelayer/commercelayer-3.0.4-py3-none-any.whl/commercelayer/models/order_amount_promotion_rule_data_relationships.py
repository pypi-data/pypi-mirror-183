...
T = TypeVar("T", bound="OrderAmountPromotionRuleDataRelationships")


@attr.s(auto_attribs=True)
class OrderAmountPromotionRuleDataRelationships:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        order_amount_promotion_rule_data_relationships = cls(
            promotion=promotion,
        )

        order_amount_promotion_rule_data_relationships.additional_properties = d
        return order_amount_promotion_rule_data_relationships
