...
if TYPE_CHECKING:
    from ..models.patc_hfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes_metadata import (
        PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata]): Set of
        ...
        fixed_amount_cents (Union[Unset, int]): The price fixed amount to be applied on matching SKUs, in cents Example:
            1000.
    """
    ...
    metadata: Union[Unset, "PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHfixedPricePromotionsfixedPricePromotionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )

        fixed_amount_cents = d.pop("fixed_amount_cents", UNSET)

        patc_hfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes.additional_properties = d
        return patc_hfixed_price_promotionsfixed_price_promotion_id_response_200_data_attributes
