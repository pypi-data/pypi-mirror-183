...
if TYPE_CHECKING:
    from ..models.price_list_update_data_attributes_metadata import PriceListUpdateDataAttributesMetadata


T = TypeVar("T", bound="PriceListUpdateDataAttributes")


@attr.s(auto_attribs=True)
class PriceListUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PriceListUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "PriceListUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PriceListUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PriceListUpdateDataAttributesMetadata.from_dict(_metadata)

        price_list_update_data_attributes = cls(
            name=name,
        ...
        price_list_update_data_attributes.additional_properties = d
        return price_list_update_data_attributes
