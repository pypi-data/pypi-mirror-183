...
if TYPE_CHECKING:
    from ..models.patc_hshipping_zonesshipping_zone_id_response_200_data_attributes_metadata import (
        PATCHshippingZonesshippingZoneIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHshippingZonesshippingZoneIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHshippingZonesshippingZoneIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHshippingZonesshippingZoneIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "PATCHshippingZonesshippingZoneIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHshippingZonesshippingZoneIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHshippingZonesshippingZoneIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hshipping_zonesshipping_zone_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hshipping_zonesshipping_zone_id_response_200_data_attributes.additional_properties = d
        return patc_hshipping_zonesshipping_zone_id_response_200_data_attributes
