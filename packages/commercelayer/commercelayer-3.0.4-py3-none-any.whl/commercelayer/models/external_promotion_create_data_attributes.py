...
if TYPE_CHECKING:
    from ..models.external_promotion_create_data_attributes_metadata import (
        ExternalPromotionCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="ExternalPromotionCreateDataAttributes")


@attr.s(auto_attribs=True)
class ExternalPromotionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ExternalPromotionCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "ExternalPromotionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ExternalPromotionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExternalPromotionCreateDataAttributesMetadata.from_dict(_metadata)

        external_promotion_create_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        external_promotion_create_data_attributes.additional_properties = d
        return external_promotion_create_data_attributes
