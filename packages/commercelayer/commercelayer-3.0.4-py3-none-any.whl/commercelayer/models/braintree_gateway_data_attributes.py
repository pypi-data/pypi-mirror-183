...
if TYPE_CHECKING:
    from ..models.braintree_gateway_data_attributes_metadata import BraintreeGatewayDataAttributesMetadata


T = TypeVar("T", bound="BraintreeGatewayDataAttributes")


@attr.s(auto_attribs=True)
class BraintreeGatewayDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, BraintreeGatewayDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "BraintreeGatewayDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, BraintreeGatewayDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = BraintreeGatewayDataAttributesMetadata.from_dict(_metadata)
        ...
        braintree_gateway_data_attributes = cls(
            name=name,
        ...
        braintree_gateway_data_attributes.additional_properties = d
        return braintree_gateway_data_attributes
