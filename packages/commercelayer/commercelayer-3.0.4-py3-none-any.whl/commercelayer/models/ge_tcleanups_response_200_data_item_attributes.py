...
if TYPE_CHECKING:
    from ..models.ge_tcleanups_response_200_data_item_attributes_errors_log import (
        GETcleanupsResponse200DataItemAttributesErrorsLog,
    )
    from ..models.ge_tcleanups_response_200_data_item_attributes_filters import (
        GETcleanupsResponse200DataItemAttributesFilters,
    )
    from ..models.ge_tcleanups_response_200_data_item_attributes_metadata import (
        GETcleanupsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETcleanupsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcleanupsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        filters (Union[Unset, GETcleanupsResponse200DataItemAttributesFilters]): The filters used to select the records
            to be cleaned. Example: {'code_eq': 'AAA'}.
        ...
        errors_log (Union[Unset, GETcleanupsResponse200DataItemAttributesErrorsLog]): Contains the cleanup errors, if
        ...
        metadata (Union[Unset, GETcleanupsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    filters: Union[Unset, "GETcleanupsResponse200DataItemAttributesFilters"] = UNSET
    records_count: Union[Unset, int] = UNSET
    errors_count: Union[Unset, int] = UNSET
    processed_count: Union[Unset, int] = UNSET
    errors_log: Union[Unset, "GETcleanupsResponse200DataItemAttributesErrorsLog"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETcleanupsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filters: Union[Unset, GETcleanupsResponse200DataItemAttributesFilters]
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = GETcleanupsResponse200DataItemAttributesFilters.from_dict(_filters)
        ...
        errors_log: Union[Unset, GETcleanupsResponse200DataItemAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = GETcleanupsResponse200DataItemAttributesErrorsLog.from_dict(_errors_log)
        ...
        metadata: Union[Unset, GETcleanupsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcleanupsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tcleanups_response_200_data_item_attributes = cls(
        ...
        ge_tcleanups_response_200_data_item_attributes.additional_properties = d
        return ge_tcleanups_response_200_data_item_attributes
