...
if TYPE_CHECKING:
    from ..models.ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes_metadata import (
        GETstripePaymentsstripePaymentIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes_options import (
        GETstripePaymentsstripePaymentIdResponse200DataAttributesOptions,
    )
    from ..models.ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes_payment_method import (
        GETstripePaymentsstripePaymentIdResponse200DataAttributesPaymentMethod,
    )


T = TypeVar("T", bound="GETstripePaymentsstripePaymentIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETstripePaymentsstripePaymentIdResponse200DataAttributes:
    """
    Attributes:
        ...
        options (Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesOptions]): Stripe payment
            options: 'setup_future_usage', 'customer', and 'payment_method' Example: {'customer': 'cus_xxx',
            'payment_method': 'pm_xxx'}.
        payment_method (Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesPaymentMethod]): Stripe
        ...
        metadata (Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    options: Union[Unset, "GETstripePaymentsstripePaymentIdResponse200DataAttributesOptions"] = UNSET
    payment_method: Union[Unset, "GETstripePaymentsstripePaymentIdResponse200DataAttributesPaymentMethod"] = UNSET
    ...
    metadata: Union[Unset, "GETstripePaymentsstripePaymentIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = GETstripePaymentsstripePaymentIdResponse200DataAttributesOptions.from_dict(_options)

        _payment_method = d.pop("payment_method", UNSET)
        payment_method: Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesPaymentMethod]
        if isinstance(_payment_method, Unset):
            payment_method = UNSET
        else:
            payment_method = GETstripePaymentsstripePaymentIdResponse200DataAttributesPaymentMethod.from_dict(
                _payment_method
            )
        ...
        metadata: Union[Unset, GETstripePaymentsstripePaymentIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETstripePaymentsstripePaymentIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes = cls(
        ...
        ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes.additional_properties = d
        return ge_tstripe_paymentsstripe_payment_id_response_200_data_attributes
