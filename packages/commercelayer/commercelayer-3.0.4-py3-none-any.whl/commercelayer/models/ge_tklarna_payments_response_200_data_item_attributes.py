...
if TYPE_CHECKING:
    from ..models.ge_tklarna_payments_response_200_data_item_attributes_metadata import (
        GETklarnaPaymentsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_tklarna_payments_response_200_data_item_attributes_payment_methods_item import (
        GETklarnaPaymentsResponse200DataItemAttributesPaymentMethodsItem,
    )


T = TypeVar("T", bound="GETklarnaPaymentsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETklarnaPaymentsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        payment_methods (Union[Unset, List['GETklarnaPaymentsResponse200DataItemAttributesPaymentMethodsItem']]): The
            merchant available payment methods for the assoiated order. Available upon session creation. Example: [{'foo':
            'bar'}].
        ...
        metadata (Union[Unset, GETklarnaPaymentsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you
    ...
    payment_methods: Union[Unset, List["GETklarnaPaymentsResponse200DataItemAttributesPaymentMethodsItem"]] = UNSET
    ...
    metadata: Union[Unset, "GETklarnaPaymentsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for payment_methods_item_data in _payment_methods or []:
            payment_methods_item = GETklarnaPaymentsResponse200DataItemAttributesPaymentMethodsItem.from_dict(
        ...
        metadata: Union[Unset, GETklarnaPaymentsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETklarnaPaymentsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tklarna_payments_response_200_data_item_attributes = cls(
        ...
        ge_tklarna_payments_response_200_data_item_attributes.additional_properties = d
        return ge_tklarna_payments_response_200_data_item_attributes
