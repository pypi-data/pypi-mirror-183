...
if TYPE_CHECKING:
    from ..models.ge_tcustomer_payment_sources_response_200_data_item_attributes_metadata import (
        GETcustomerPaymentSourcesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETcustomerPaymentSourcesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcustomerPaymentSourcesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETcustomerPaymentSourcesResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETcustomerPaymentSourcesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETcustomerPaymentSourcesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcustomerPaymentSourcesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tcustomer_payment_sources_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tcustomer_payment_sources_response_200_data_item_attributes.additional_properties = d
        return ge_tcustomer_payment_sources_response_200_data_item_attributes
