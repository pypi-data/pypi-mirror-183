...
if TYPE_CHECKING:
    from ..models.sku_list_update_data_attributes_metadata import SkuListUpdateDataAttributesMetadata


T = TypeVar("T", bound="SkuListUpdateDataAttributes")


@attr.s(auto_attribs=True)
class SkuListUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "SkuListUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListUpdateDataAttributesMetadata.from_dict(_metadata)

        sku_list_update_data_attributes = cls(
            name=name,
        ...
        sku_list_update_data_attributes.additional_properties = d
        return sku_list_update_data_attributes
