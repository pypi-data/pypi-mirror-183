...
if TYPE_CHECKING:
    from ..models.avalara_account_data_attributes_metadata import AvalaraAccountDataAttributesMetadata


T = TypeVar("T", bound="AvalaraAccountDataAttributes")


@attr.s(auto_attribs=True)
class AvalaraAccountDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AvalaraAccountDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "AvalaraAccountDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AvalaraAccountDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AvalaraAccountDataAttributesMetadata.from_dict(_metadata)
        ...
        avalara_account_data_attributes = cls(
            name=name,
        ...
        avalara_account_data_attributes.additional_properties = d
        return avalara_account_data_attributes
