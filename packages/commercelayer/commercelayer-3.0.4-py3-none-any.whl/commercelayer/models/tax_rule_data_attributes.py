...
if TYPE_CHECKING:
    from ..models.tax_rule_data_attributes_breakdown import TaxRuleDataAttributesBreakdown
    from ..models.tax_rule_data_attributes_metadata import TaxRuleDataAttributesMetadata


T = TypeVar("T", bound="TaxRuleDataAttributes")


@attr.s(auto_attribs=True)
class TaxRuleDataAttributes:
    """
    Attributes:
        ...
        breakdown (Union[Unset, TaxRuleDataAttributesBreakdown]): The breakdown for this tax rule (if calculated).
        ...
        metadata (Union[Unset, TaxRuleDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    breakdown: Union[Unset, "TaxRuleDataAttributesBreakdown"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "TaxRuleDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        breakdown: Union[Unset, TaxRuleDataAttributesBreakdown]
        if isinstance(_breakdown, Unset):
            breakdown = UNSET
        else:
            breakdown = TaxRuleDataAttributesBreakdown.from_dict(_breakdown)
        ...
        metadata: Union[Unset, TaxRuleDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = TaxRuleDataAttributesMetadata.from_dict(_metadata)

        tax_rule_data_attributes = cls(
            name=name,
            tax_rate=tax_rate,
        ...
        tax_rule_data_attributes.additional_properties = d
        return tax_rule_data_attributes
