...
if TYPE_CHECKING:
    from ..models.ge_tline_item_options_response_200_data_item_attributes_metadata import (
        GETlineItemOptionsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_tline_item_options_response_200_data_item_attributes_options import (
        GETlineItemOptionsResponse200DataItemAttributesOptions,
    )


T = TypeVar("T", bound="GETlineItemOptionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETlineItemOptionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        delay_days (Union[Unset, int]): The shipping delay that the customer can expect when adding this option (days,
            rounded). Example: 2.
        options (Union[Unset, GETlineItemOptionsResponse200DataItemAttributesOptions]): Set of key-value pairs that
            represent the selected options. Example: {'embossing_text': 'Happy Birthday!'}.
        ...
        metadata (Union[Unset, GETlineItemOptionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    options: Union[Unset, "GETlineItemOptionsResponse200DataItemAttributesOptions"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETlineItemOptionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, GETlineItemOptionsResponse200DataItemAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = GETlineItemOptionsResponse200DataItemAttributesOptions.from_dict(_options)
        ...
        metadata: Union[Unset, GETlineItemOptionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETlineItemOptionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tline_item_options_response_200_data_item_attributes = cls(
            name=name,
            quantity=quantity,
        ...
        ge_tline_item_options_response_200_data_item_attributes.additional_properties = d
        return ge_tline_item_options_response_200_data_item_attributes
