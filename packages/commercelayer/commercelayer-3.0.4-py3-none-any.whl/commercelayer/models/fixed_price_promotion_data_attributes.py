...
if TYPE_CHECKING:
    from ..models.fixed_price_promotion_data_attributes_metadata import FixedPricePromotionDataAttributesMetadata


T = TypeVar("T", bound="FixedPricePromotionDataAttributes")


@attr.s(auto_attribs=True)
class FixedPricePromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FixedPricePromotionDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "FixedPricePromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FixedPricePromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FixedPricePromotionDataAttributesMetadata.from_dict(_metadata)
        ...
        fixed_price_promotion_data_attributes = cls(
            name=name,
        ...
        fixed_price_promotion_data_attributes.additional_properties = d
        return fixed_price_promotion_data_attributes
