...
if TYPE_CHECKING:
    from ..models.patc_hwebhookswebhook_id_response_200_data_attributes_metadata import (
        PATCHwebhookswebhookIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHwebhookswebhookIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHwebhookswebhookIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHwebhookswebhookIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHwebhookswebhookIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHwebhookswebhookIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHwebhookswebhookIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hwebhookswebhook_id_response_200_data_attributes = cls(
            name=name,
            topic=topic,
        ...
        patc_hwebhookswebhook_id_response_200_data_attributes.additional_properties = d
        return patc_hwebhookswebhook_id_response_200_data_attributes
