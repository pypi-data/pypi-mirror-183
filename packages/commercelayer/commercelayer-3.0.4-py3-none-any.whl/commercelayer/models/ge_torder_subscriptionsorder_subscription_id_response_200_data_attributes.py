...
if TYPE_CHECKING:
    from ..models.ge_torder_subscriptionsorder_subscription_id_response_200_data_attributes_metadata import (
        GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_torder_subscriptionsorder_subscription_id_response_200_data_attributes_options import (
        GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesOptions,
    )


T = TypeVar("T", bound="GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        succeeded_on_last_run (Union[Unset, bool]): Indicates if the subscription has succeeded on its last run.
            Example: True.
        options (Union[Unset, GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesOptions]): The
            subscription options used to create the order copy (check order_copies for more information). For subscriptions
            the `place_target_order` is enabled by default, specify custom options to overwrite it. Example:
        ...
        metadata (Union[Unset, GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesMetadata]): Set of key-
    ...
    options: Union[Unset, "GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesOptions"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesOptions.from_dict(_options)
        ...
        metadata: Union[Unset, GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETorderSubscriptionsorderSubscriptionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_torder_subscriptionsorder_subscription_id_response_200_data_attributes = cls(
            number=number,
            status=status,
            frequency=frequency,
        ...
        ge_torder_subscriptionsorder_subscription_id_response_200_data_attributes.additional_properties = d
        return ge_torder_subscriptionsorder_subscription_id_response_200_data_attributes
