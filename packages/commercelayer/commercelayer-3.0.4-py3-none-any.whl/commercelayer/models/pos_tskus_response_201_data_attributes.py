...
if TYPE_CHECKING:
    from ..models.pos_tskus_response_201_data_attributes_metadata import POSTskusResponse201DataAttributesMetadata


T = TypeVar("T", bound="POSTskusResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTskusResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTskusResponse201DataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "POSTskusResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTskusResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTskusResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tskus_response_201_data_attributes = cls(
            code=code,
            name=name,
        ...
        pos_tskus_response_201_data_attributes.additional_properties = d
        return pos_tskus_response_201_data_attributes
