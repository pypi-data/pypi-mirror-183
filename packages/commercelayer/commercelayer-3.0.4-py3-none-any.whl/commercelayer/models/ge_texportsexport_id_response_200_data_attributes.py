...
if TYPE_CHECKING:
    from ..models.ge_texportsexport_id_response_200_data_attributes_filters import (
        GETexportsexportIdResponse200DataAttributesFilters,
    )
    from ..models.ge_texportsexport_id_response_200_data_attributes_metadata import (
        GETexportsexportIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETexportsexportIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETexportsexportIdResponse200DataAttributes:
    """
    Attributes:
        ...
        includes (Union[Unset, List[str]]): List of related resources that should be included in the export. Example:
            ['prices.price_tiers'].
        filters (Union[Unset, GETexportsexportIdResponse200DataAttributesFilters]): The filters used to select the
            records to be exported. Example: {'code_eq': 'AAA'}.
        ...
        metadata (Union[Unset, GETexportsexportIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    filters: Union[Unset, "GETexportsexportIdResponse200DataAttributesFilters"] = UNSET
    ...
    metadata: Union[Unset, "GETexportsexportIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filters: Union[Unset, GETexportsexportIdResponse200DataAttributesFilters]
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = GETexportsexportIdResponse200DataAttributesFilters.from_dict(_filters)
        ...
        metadata: Union[Unset, GETexportsexportIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETexportsexportIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_texportsexport_id_response_200_data_attributes = cls(
        ...
        ge_texportsexport_id_response_200_data_attributes.additional_properties = d
        return ge_texportsexport_id_response_200_data_attributes
