...
if TYPE_CHECKING:
    from ..models.ge_timports_response_200_data_item_attributes_errors_log import (
        GETimportsResponse200DataItemAttributesErrorsLog,
    )
    from ..models.ge_timports_response_200_data_item_attributes_inputs_item import (
        GETimportsResponse200DataItemAttributesInputsItem,
    )
    from ..models.ge_timports_response_200_data_item_attributes_metadata import (
        GETimportsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_timports_response_200_data_item_attributes_warnings_log import (
        GETimportsResponse200DataItemAttributesWarningsLog,
    )


T = TypeVar("T", bound="GETimportsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETimportsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        inputs (Union[Unset, List['GETimportsResponse200DataItemAttributesInputsItem']]): Array of objects representing
            the resources that are being imported. Example: [{'code': 'ABC', 'name': 'Foo'}, {'code': 'DEF', 'name':
            'Bar'}].
        ...
        processed_count (Union[Unset, int]): Indicates the number of records that have been processed (created or
            updated). Example: 270.
        errors_log (Union[Unset, GETimportsResponse200DataItemAttributesErrorsLog]): Contains the import errors, if any.
            Example: {'ABC': {'name': ['has already been taken']}}.
        warnings_log (Union[Unset, GETimportsResponse200DataItemAttributesWarningsLog]): Contains the import warnings,
            if any. Example: {'ABC': ['could not be deleted']}.
        ...
        metadata (Union[Unset, GETimportsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    inputs: Union[Unset, List["GETimportsResponse200DataItemAttributesInputsItem"]] = UNSET
    ...
    errors_log: Union[Unset, "GETimportsResponse200DataItemAttributesErrorsLog"] = UNSET
    warnings_log: Union[Unset, "GETimportsResponse200DataItemAttributesWarningsLog"] = UNSET
    ...
    metadata: Union[Unset, "GETimportsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for inputs_item_data in _inputs or []:
            inputs_item = GETimportsResponse200DataItemAttributesInputsItem.from_dict(inputs_item_data)
        ...
        errors_log: Union[Unset, GETimportsResponse200DataItemAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = GETimportsResponse200DataItemAttributesErrorsLog.from_dict(_errors_log)

        _warnings_log = d.pop("warnings_log", UNSET)
        warnings_log: Union[Unset, GETimportsResponse200DataItemAttributesWarningsLog]
        if isinstance(_warnings_log, Unset):
            warnings_log = UNSET
        else:
            warnings_log = GETimportsResponse200DataItemAttributesWarningsLog.from_dict(_warnings_log)
        ...
        metadata: Union[Unset, GETimportsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETimportsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_timports_response_200_data_item_attributes = cls(
        ...
        ge_timports_response_200_data_item_attributes.additional_properties = d
        return ge_timports_response_200_data_item_attributes
