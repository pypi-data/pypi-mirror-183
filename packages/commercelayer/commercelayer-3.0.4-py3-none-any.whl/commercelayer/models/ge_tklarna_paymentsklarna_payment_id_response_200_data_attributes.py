...
if TYPE_CHECKING:
    from ..models.ge_tklarna_paymentsklarna_payment_id_response_200_data_attributes_metadata import (
        GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_tklarna_paymentsklarna_payment_id_response_200_data_attributes_payment_methods_item import (
        GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesPaymentMethodsItem,
    )


T = TypeVar("T", bound="GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributes:
    """
    Attributes:
        ...
        payment_methods (Union[Unset,
            List['GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesPaymentMethodsItem']]): The merchant available
        ...
        metadata (Union[Unset, GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    payment_methods: Union[
        Unset, List["GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesPaymentMethodsItem"]
    ] = UNSET
    ...
    metadata: Union[Unset, "GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for payment_methods_item_data in _payment_methods or []:
            payment_methods_item = (
                GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesPaymentMethodsItem.from_dict(
        ...
        metadata: Union[Unset, GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETklarnaPaymentsklarnaPaymentIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tklarna_paymentsklarna_payment_id_response_200_data_attributes = cls(
        ...
        ge_tklarna_paymentsklarna_payment_id_response_200_data_attributes.additional_properties = d
        return ge_tklarna_paymentsklarna_payment_id_response_200_data_attributes
