...
if TYPE_CHECKING:
    from ..models.inventory_model_update_data_attributes_metadata import InventoryModelUpdateDataAttributesMetadata


T = TypeVar("T", bound="InventoryModelUpdateDataAttributes")


@attr.s(auto_attribs=True)
class InventoryModelUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, InventoryModelUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "InventoryModelUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, InventoryModelUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = InventoryModelUpdateDataAttributesMetadata.from_dict(_metadata)

        inventory_model_update_data_attributes = cls(
            name=name,
            strategy=strategy,
        ...
        inventory_model_update_data_attributes.additional_properties = d
        return inventory_model_update_data_attributes
