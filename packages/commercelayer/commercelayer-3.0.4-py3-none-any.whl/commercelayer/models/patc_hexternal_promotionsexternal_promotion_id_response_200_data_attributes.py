...
if TYPE_CHECKING:
    from ..models.patc_hexternal_promotionsexternal_promotion_id_response_200_data_attributes_metadata import (
        PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributesMetadata]): Set of
    ...
    metadata: Union[Unset, "PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHexternalPromotionsexternalPromotionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        promotion_url = d.pop("promotion_url", UNSET)

        patc_hexternal_promotionsexternal_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hexternal_promotionsexternal_promotion_id_response_200_data_attributes.additional_properties = d
        return patc_hexternal_promotionsexternal_promotion_id_response_200_data_attributes
