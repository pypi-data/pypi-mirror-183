...
if TYPE_CHECKING:
    from ..models.free_gift_promotion_update_data_attributes_metadata import (
        FreeGiftPromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FreeGiftPromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class FreeGiftPromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeGiftPromotionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FreeGiftPromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FreeGiftPromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeGiftPromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        free_gift_promotion_update_data_attributes = cls(
            name=name,
        ...
        free_gift_promotion_update_data_attributes.additional_properties = d
        return free_gift_promotion_update_data_attributes
