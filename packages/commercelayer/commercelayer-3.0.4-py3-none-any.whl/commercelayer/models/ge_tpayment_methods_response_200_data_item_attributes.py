...
if TYPE_CHECKING:
    from ..models.ge_tpayment_methods_response_200_data_item_attributes_metadata import (
        GETpaymentMethodsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpaymentMethodsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpaymentMethodsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpaymentMethodsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETpaymentMethodsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpaymentMethodsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpaymentMethodsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tpayment_methods_response_200_data_item_attributes = cls(
        ...
        ge_tpayment_methods_response_200_data_item_attributes.additional_properties = d
        return ge_tpayment_methods_response_200_data_item_attributes
