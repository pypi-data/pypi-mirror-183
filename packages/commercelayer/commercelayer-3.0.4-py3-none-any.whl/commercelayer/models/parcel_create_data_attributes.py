...
if TYPE_CHECKING:
    from ..models.parcel_create_data_attributes_metadata import ParcelCreateDataAttributesMetadata


T = TypeVar("T", bound="ParcelCreateDataAttributes")


@attr.s(auto_attribs=True)
class ParcelCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ParcelCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ParcelCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ParcelCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ParcelCreateDataAttributesMetadata.from_dict(_metadata)

        parcel_create_data_attributes = cls(
            weight=weight,
            unit_of_weight=unit_of_weight,
            eel_pfc=eel_pfc,
        ...
        parcel_create_data_attributes.additional_properties = d
        return parcel_create_data_attributes
