...
if TYPE_CHECKING:
    from ..models.ge_tpackagespackage_id_response_200_data_attributes_metadata import (
        GETpackagespackageIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpackagespackageIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpackagespackageIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpackagespackageIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETpackagespackageIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpackagespackageIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpackagespackageIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tpackagespackage_id_response_200_data_attributes = cls(
            name=name,
            code=code,
            length=length,
            width=width,
        ...
        ge_tpackagespackage_id_response_200_data_attributes.additional_properties = d
        return ge_tpackagespackage_id_response_200_data_attributes
