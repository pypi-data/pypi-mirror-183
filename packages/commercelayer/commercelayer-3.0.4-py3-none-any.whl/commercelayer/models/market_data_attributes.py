...
if TYPE_CHECKING:
    from ..models.market_data_attributes_metadata import MarketDataAttributesMetadata


T = TypeVar("T", bound="MarketDataAttributes")


@attr.s(auto_attribs=True)
class MarketDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, MarketDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "MarketDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, MarketDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = MarketDataAttributesMetadata.from_dict(_metadata)

        market_data_attributes = cls(
            number=number,
            name=name,
        ...
        market_data_attributes.additional_properties = d
        return market_data_attributes
