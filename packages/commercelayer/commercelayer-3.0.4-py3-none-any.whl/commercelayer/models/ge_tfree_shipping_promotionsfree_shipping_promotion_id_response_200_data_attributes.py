...
if TYPE_CHECKING:
    from ..models.ge_tfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes_metadata import (
        GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata]): Set
    ...
    metadata: Union[Unset, "GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )

        ge_tfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes.additional_properties = d
        return ge_tfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes
