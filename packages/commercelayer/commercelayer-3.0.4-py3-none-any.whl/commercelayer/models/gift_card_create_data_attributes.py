...
if TYPE_CHECKING:
    from ..models.gift_card_create_data_attributes_metadata import GiftCardCreateDataAttributesMetadata


T = TypeVar("T", bound="GiftCardCreateDataAttributes")


@attr.s(auto_attribs=True)
class GiftCardCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GiftCardCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "GiftCardCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GiftCardCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GiftCardCreateDataAttributesMetadata.from_dict(_metadata)

        gift_card_create_data_attributes = cls(
            balance_cents=balance_cents,
            code=code,
        ...
        gift_card_create_data_attributes.additional_properties = d
        return gift_card_create_data_attributes
