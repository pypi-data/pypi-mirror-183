...
if TYPE_CHECKING:
    from ..models.pos_texternal_gateways_response_201_data_attributes_metadata import (
        POSTexternalGatewaysResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTexternalGatewaysResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTexternalGatewaysResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTexternalGatewaysResponse201DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "POSTexternalGatewaysResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTexternalGatewaysResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTexternalGatewaysResponse201DataAttributesMetadata.from_dict(_metadata)
        ...
        pos_texternal_gateways_response_201_data_attributes = cls(
            name=name,
            reference=reference,
        ...
        pos_texternal_gateways_response_201_data_attributes.additional_properties = d
        return pos_texternal_gateways_response_201_data_attributes
