...
if TYPE_CHECKING:
    from ..models.ge_tfree_shipping_promotions_response_200_data_item_attributes_metadata import (
        GETfreeShippingPromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETfreeShippingPromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETfreeShippingPromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfreeShippingPromotionsResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETfreeShippingPromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfreeShippingPromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfreeShippingPromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tfree_shipping_promotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tfree_shipping_promotions_response_200_data_item_attributes.additional_properties = d
        return ge_tfree_shipping_promotions_response_200_data_item_attributes
