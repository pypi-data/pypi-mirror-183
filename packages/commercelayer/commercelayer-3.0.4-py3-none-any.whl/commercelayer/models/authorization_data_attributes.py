...
if TYPE_CHECKING:
    from ..models.authorization_data_attributes_metadata import AuthorizationDataAttributesMetadata


T = TypeVar("T", bound="AuthorizationDataAttributes")


@attr.s(auto_attribs=True)
class AuthorizationDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AuthorizationDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "AuthorizationDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AuthorizationDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AuthorizationDataAttributesMetadata.from_dict(_metadata)
        ...
        authorization_data_attributes = cls(
            number=number,
        ...
        authorization_data_attributes.additional_properties = d
        return authorization_data_attributes
