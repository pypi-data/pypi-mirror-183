...
if TYPE_CHECKING:
    from ..models.adjustment_data_attributes_metadata import AdjustmentDataAttributesMetadata


T = TypeVar("T", bound="AdjustmentDataAttributes")


@attr.s(auto_attribs=True)
class AdjustmentDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AdjustmentDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "AdjustmentDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AdjustmentDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AdjustmentDataAttributesMetadata.from_dict(_metadata)

        adjustment_data_attributes = cls(
            name=name,
        ...
        adjustment_data_attributes.additional_properties = d
        return adjustment_data_attributes
