...
if TYPE_CHECKING:
    from ..models.pos_texternal_promotions_response_201_data_attributes_metadata import (
        POSTexternalPromotionsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTexternalPromotionsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTexternalPromotionsResponse201DataAttributes:
    """
    Attributes:
        ...
        promotion_url (str): The URL to the service that will compute the discount. Example:
        ...
        metadata (Union[Unset, POSTexternalPromotionsResponse201DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "POSTexternalPromotionsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        promotion_url = d.pop("promotion_url")
        ...
        metadata: Union[Unset, POSTexternalPromotionsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTexternalPromotionsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_texternal_promotions_response_201_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        pos_texternal_promotions_response_201_data_attributes.additional_properties = d
        return pos_texternal_promotions_response_201_data_attributes
