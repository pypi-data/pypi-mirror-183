...
if TYPE_CHECKING:
    from ..models.ge_tshipments_response_200_data_item_attributes_get_rates_errors_item import (
        GETshipmentsResponse200DataItemAttributesGetRatesErrorsItem,
    )
    from ..models.ge_tshipments_response_200_data_item_attributes_metadata import (
        GETshipmentsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_tshipments_response_200_data_item_attributes_rates_item import (
        GETshipmentsResponse200DataItemAttributesRatesItem,
    )


T = TypeVar("T", bound="GETshipmentsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETshipmentsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        rates (Union[Unset, List['GETshipmentsResponse200DataItemAttributesRatesItem']]): The available shipping rates.
            Example: [{'id': 'rate_f89e4663c3ed47ee94d37763f6d21d54', 'rate': '45.59', 'carrier': 'DHLExpress', 'service':
            'MedicalExpress'}].
        ...
        get_rates_errors (Union[Unset, List['GETshipmentsResponse200DataItemAttributesGetRatesErrorsItem']]): Any errors
            collected when fetching shipping rates. Example: [{'carrier': 'DHLExpress', 'message': 'to_address.postal_code:
            Shorter than minimum length 3', 'type': 'rate_error'}].
        ...
        metadata (Union[Unset, GETshipmentsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    rates: Union[Unset, List["GETshipmentsResponse200DataItemAttributesRatesItem"]] = UNSET
    purchase_error_code: Union[Unset, str] = UNSET
    purchase_error_message: Union[Unset, str] = UNSET
    get_rates_errors: Union[Unset, List["GETshipmentsResponse200DataItemAttributesGetRatesErrorsItem"]] = UNSET
    ...
    metadata: Union[Unset, "GETshipmentsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = GETshipmentsResponse200DataItemAttributesRatesItem.from_dict(rates_item_data)
        ...
        for get_rates_errors_item_data in _get_rates_errors or []:
            get_rates_errors_item = GETshipmentsResponse200DataItemAttributesGetRatesErrorsItem.from_dict(
        ...
        metadata: Union[Unset, GETshipmentsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshipmentsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tshipments_response_200_data_item_attributes = cls(
            number=number,
            status=status,
        ...
        ge_tshipments_response_200_data_item_attributes.additional_properties = d
        return ge_tshipments_response_200_data_item_attributes
