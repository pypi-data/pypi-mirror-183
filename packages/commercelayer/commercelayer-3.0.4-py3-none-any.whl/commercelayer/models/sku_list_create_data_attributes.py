...
if TYPE_CHECKING:
    from ..models.sku_list_create_data_attributes_metadata import SkuListCreateDataAttributesMetadata


T = TypeVar("T", bound="SkuListCreateDataAttributes")


@attr.s(auto_attribs=True)
class SkuListCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "SkuListCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListCreateDataAttributesMetadata.from_dict(_metadata)

        sku_list_create_data_attributes = cls(
            name=name,
        ...
        sku_list_create_data_attributes.additional_properties = d
        return sku_list_create_data_attributes
