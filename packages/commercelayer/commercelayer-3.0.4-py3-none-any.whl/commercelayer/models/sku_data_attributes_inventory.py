...
T = TypeVar("T", bound="SkuDataAttributesInventory")


@attr.s(auto_attribs=True)
class SkuDataAttributesInventory:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        sku_data_attributes_inventory = cls()

        sku_data_attributes_inventory.additional_properties = d
        return sku_data_attributes_inventory
