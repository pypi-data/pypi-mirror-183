...
if TYPE_CHECKING:
    from ..models.ge_taddressesaddress_id_response_200_data_attributes_metadata import (
        GETaddressesaddressIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETaddressesaddressIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETaddressesaddressIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETaddressesaddressIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETaddressesaddressIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETaddressesaddressIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETaddressesaddressIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_taddressesaddress_id_response_200_data_attributes = cls(
            business=business,
        ...
        ge_taddressesaddress_id_response_200_data_attributes.additional_properties = d
        return ge_taddressesaddress_id_response_200_data_attributes
