...
if TYPE_CHECKING:
    from ..models.sku_option_create_data_attributes_metadata import SkuOptionCreateDataAttributesMetadata


T = TypeVar("T", bound="SkuOptionCreateDataAttributes")


@attr.s(auto_attribs=True)
class SkuOptionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuOptionCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "SkuOptionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuOptionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuOptionCreateDataAttributesMetadata.from_dict(_metadata)

        sku_option_create_data_attributes = cls(
            name=name,
        ...
        sku_option_create_data_attributes.additional_properties = d
        return sku_option_create_data_attributes
