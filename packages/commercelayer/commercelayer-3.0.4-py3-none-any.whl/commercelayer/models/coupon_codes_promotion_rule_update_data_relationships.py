...
if TYPE_CHECKING:
    from ..models.coupon_codes_promotion_rule_update_data_relationships_coupons import (
        CouponCodesPromotionRuleUpdateDataRelationshipsCoupons,
    )
...
T = TypeVar("T", bound="CouponCodesPromotionRuleUpdateDataRelationships")


@attr.s(auto_attribs=True)
class CouponCodesPromotionRuleUpdateDataRelationships:
    """
    Attributes:
        ...
        coupons (Union[Unset, CouponCodesPromotionRuleUpdateDataRelationshipsCoupons]):
    """
    ...
    coupons: Union[Unset, "CouponCodesPromotionRuleUpdateDataRelationshipsCoupons"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_coupons, Unset):
            ...
            coupons = CouponCodesPromotionRuleUpdateDataRelationshipsCoupons.from_dict(_coupons)

        coupon_codes_promotion_rule_update_data_relationships = cls(
            promotion=promotion,
            coupons=coupons,
        )

        coupon_codes_promotion_rule_update_data_relationships.additional_properties = d
        return coupon_codes_promotion_rule_update_data_relationships
