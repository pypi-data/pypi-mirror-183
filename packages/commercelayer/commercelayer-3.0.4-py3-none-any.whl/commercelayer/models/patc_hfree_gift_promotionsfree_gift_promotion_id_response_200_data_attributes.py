...
if TYPE_CHECKING:
    from ..models.patc_hfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes_metadata import (
        PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata]): Set of
        ...
        max_quantity (Union[Unset, int]): The max quantity of free gifts globally applicable by the promotion, default
            to 1 Example: 3.
    """
    ...
    metadata: Union[Unset, "PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if max_quantity is not UNSET:
            field_dict["max_quantity"] = max_quantity
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHfreeGiftPromotionsfreeGiftPromotionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        patc_hfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes.additional_properties = d
        return patc_hfree_gift_promotionsfree_gift_promotion_id_response_200_data_attributes
