...
if TYPE_CHECKING:
    from ..models.ge_tavalara_accountsavalara_account_id_response_200_data_attributes_metadata import (
        GETavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETavalaraAccountsavalaraAccountIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETavalaraAccountsavalaraAccountIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata.from_dict(_metadata)
        ...
        ge_tavalara_accountsavalara_account_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tavalara_accountsavalara_account_id_response_200_data_attributes.additional_properties = d
        return ge_tavalara_accountsavalara_account_id_response_200_data_attributes
