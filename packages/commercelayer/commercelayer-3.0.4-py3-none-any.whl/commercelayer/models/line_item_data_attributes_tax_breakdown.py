...
T = TypeVar("T", bound="LineItemDataAttributesTaxBreakdown")


@attr.s(auto_attribs=True)
class LineItemDataAttributesTaxBreakdown:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        line_item_data_attributes_tax_breakdown = cls()

        line_item_data_attributes_tax_breakdown.additional_properties = d
        return line_item_data_attributes_tax_breakdown
