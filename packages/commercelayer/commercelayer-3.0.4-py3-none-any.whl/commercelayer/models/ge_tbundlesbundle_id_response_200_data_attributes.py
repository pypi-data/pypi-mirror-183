...
if TYPE_CHECKING:
    from ..models.ge_tbundlesbundle_id_response_200_data_attributes_metadata import (
        GETbundlesbundleIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETbundlesbundleIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETbundlesbundleIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETbundlesbundleIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETbundlesbundleIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETbundlesbundleIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETbundlesbundleIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tbundlesbundle_id_response_200_data_attributes = cls(
            code=code,
            name=name,
        ...
        ge_tbundlesbundle_id_response_200_data_attributes.additional_properties = d
        return ge_tbundlesbundle_id_response_200_data_attributes
