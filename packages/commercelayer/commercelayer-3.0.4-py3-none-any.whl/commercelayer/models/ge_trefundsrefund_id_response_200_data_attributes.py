...
if TYPE_CHECKING:
    from ..models.ge_trefundsrefund_id_response_200_data_attributes_metadata import (
        GETrefundsrefundIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETrefundsrefundIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETrefundsrefundIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETrefundsrefundIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETrefundsrefundIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETrefundsrefundIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETrefundsrefundIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_trefundsrefund_id_response_200_data_attributes = cls(
            number=number,
        ...
        ge_trefundsrefund_id_response_200_data_attributes.additional_properties = d
        return ge_trefundsrefund_id_response_200_data_attributes
