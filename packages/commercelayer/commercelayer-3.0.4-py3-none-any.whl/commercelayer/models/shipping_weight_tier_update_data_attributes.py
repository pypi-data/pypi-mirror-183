...
if TYPE_CHECKING:
    from ..models.shipping_weight_tier_update_data_attributes_metadata import (
        ShippingWeightTierUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="ShippingWeightTierUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ShippingWeightTierUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingWeightTierUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "ShippingWeightTierUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingWeightTierUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingWeightTierUpdateDataAttributesMetadata.from_dict(_metadata)

        shipping_weight_tier_update_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        shipping_weight_tier_update_data_attributes.additional_properties = d
        return shipping_weight_tier_update_data_attributes
