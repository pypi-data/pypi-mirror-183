...
if TYPE_CHECKING:
    from ..models.patc_hskussku_id_response_200_data_attributes_metadata import (
        PATCHskusskuIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHskusskuIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHskusskuIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHskusskuIdResponse200DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "PATCHskusskuIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHskusskuIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHskusskuIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hskussku_id_response_200_data_attributes = cls(
            code=code,
            name=name,
        ...
        patc_hskussku_id_response_200_data_attributes.additional_properties = d
        return patc_hskussku_id_response_200_data_attributes
