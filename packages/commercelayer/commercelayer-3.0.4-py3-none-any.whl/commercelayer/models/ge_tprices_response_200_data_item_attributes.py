...
if TYPE_CHECKING:
    from ..models.ge_tprices_response_200_data_item_attributes_metadata import (
        GETpricesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpricesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpricesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpricesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETpricesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpricesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpricesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tprices_response_200_data_item_attributes = cls(
        ...
        ge_tprices_response_200_data_item_attributes.additional_properties = d
        return ge_tprices_response_200_data_item_attributes
