...
if TYPE_CHECKING:
    from ..models.customer_password_reset_update_data_attributes_metadata import (
        CustomerPasswordResetUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="CustomerPasswordResetUpdateDataAttributes")


@attr.s(auto_attribs=True)
class CustomerPasswordResetUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CustomerPasswordResetUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "CustomerPasswordResetUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CustomerPasswordResetUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CustomerPasswordResetUpdateDataAttributesMetadata.from_dict(_metadata)

        customer_password_reset_update_data_attributes = cls(
        ...
        customer_password_reset_update_data_attributes.additional_properties = d
        return customer_password_reset_update_data_attributes
