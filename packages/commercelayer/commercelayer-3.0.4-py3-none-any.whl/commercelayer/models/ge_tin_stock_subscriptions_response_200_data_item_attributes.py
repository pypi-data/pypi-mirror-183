...
if TYPE_CHECKING:
    from ..models.ge_tin_stock_subscriptions_response_200_data_item_attributes_metadata import (
        GETinStockSubscriptionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETinStockSubscriptionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETinStockSubscriptionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETinStockSubscriptionsResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETinStockSubscriptionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETinStockSubscriptionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETinStockSubscriptionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tin_stock_subscriptions_response_200_data_item_attributes = cls(
            status=status,
        ...
        ge_tin_stock_subscriptions_response_200_data_item_attributes.additional_properties = d
        return ge_tin_stock_subscriptions_response_200_data_item_attributes
