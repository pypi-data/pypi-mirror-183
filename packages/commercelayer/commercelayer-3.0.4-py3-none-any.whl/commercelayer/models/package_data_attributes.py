...
if TYPE_CHECKING:
    from ..models.package_data_attributes_metadata import PackageDataAttributesMetadata


T = TypeVar("T", bound="PackageDataAttributes")


@attr.s(auto_attribs=True)
class PackageDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PackageDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PackageDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PackageDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PackageDataAttributesMetadata.from_dict(_metadata)

        package_data_attributes = cls(
            name=name,
            code=code,
            length=length,
            width=width,
        ...
        package_data_attributes.additional_properties = d
        return package_data_attributes
