...
if TYPE_CHECKING:
    from ..models.return_line_item_data_attributes_metadata import ReturnLineItemDataAttributesMetadata
    from ..models.return_line_item_data_attributes_return_reason import ReturnLineItemDataAttributesReturnReason


T = TypeVar("T", bound="ReturnLineItemDataAttributes")


@attr.s(auto_attribs=True)
class ReturnLineItemDataAttributes:
    """
    Attributes:
        ...
        return_reason (Union[Unset, ReturnLineItemDataAttributesReturnReason]): Set of key-value pairs that you can use
            to add details about return reason. Example: {'size': 'was wrong'}.
        ...
        metadata (Union[Unset, ReturnLineItemDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    return_reason: Union[Unset, "ReturnLineItemDataAttributesReturnReason"] = UNSET
    restocked_at: Union[Unset, str] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "ReturnLineItemDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return_reason: Union[Unset, ReturnLineItemDataAttributesReturnReason]
        if isinstance(_return_reason, Unset):
            return_reason = UNSET
        else:
            return_reason = ReturnLineItemDataAttributesReturnReason.from_dict(_return_reason)
        ...
        metadata: Union[Unset, ReturnLineItemDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ReturnLineItemDataAttributesMetadata.from_dict(_metadata)

        return_line_item_data_attributes = cls(
            sku_code=sku_code,
        ...
        return_line_item_data_attributes.additional_properties = d
        return return_line_item_data_attributes
