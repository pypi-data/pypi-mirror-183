...
if TYPE_CHECKING:
    from ..models.free_gift_promotion_create_data_attributes_metadata import (
        FreeGiftPromotionCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FreeGiftPromotionCreateDataAttributes")


@attr.s(auto_attribs=True)
class FreeGiftPromotionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeGiftPromotionCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FreeGiftPromotionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FreeGiftPromotionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeGiftPromotionCreateDataAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        free_gift_promotion_create_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        free_gift_promotion_create_data_attributes.additional_properties = d
        return free_gift_promotion_create_data_attributes
