...
if TYPE_CHECKING:
    from ..models.patc_havalara_accountsavalara_account_id_response_200_data_attributes_metadata import (
        PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHavalaraAccountsavalaraAccountIdResponse200DataAttributesMetadata.from_dict(_metadata)
        ...
        patc_havalara_accountsavalara_account_id_response_200_data_attributes = cls(
            name=name,
            reference=reference,
        ...
        patc_havalara_accountsavalara_account_id_response_200_data_attributes.additional_properties = d
        return patc_havalara_accountsavalara_account_id_response_200_data_attributes
