...
if TYPE_CHECKING:
    from ..models.stock_location_create_data_attributes_metadata import StockLocationCreateDataAttributesMetadata


T = TypeVar("T", bound="StockLocationCreateDataAttributes")


@attr.s(auto_attribs=True)
class StockLocationCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, StockLocationCreateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "StockLocationCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, StockLocationCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StockLocationCreateDataAttributesMetadata.from_dict(_metadata)

        stock_location_create_data_attributes = cls(
            name=name,
        ...
        stock_location_create_data_attributes.additional_properties = d
        return stock_location_create_data_attributes
