...
if TYPE_CHECKING:
    from ..models.ge_tpaypal_payments_response_200_data_item_attributes_metadata import (
        GETpaypalPaymentsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpaypalPaymentsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpaypalPaymentsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpaypalPaymentsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETpaypalPaymentsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpaypalPaymentsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpaypalPaymentsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tpaypal_payments_response_200_data_item_attributes = cls(
        ...
        ge_tpaypal_payments_response_200_data_item_attributes.additional_properties = d
        return ge_tpaypal_payments_response_200_data_item_attributes
