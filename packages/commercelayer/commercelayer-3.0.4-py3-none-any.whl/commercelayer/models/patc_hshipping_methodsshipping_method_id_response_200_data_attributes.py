...
if TYPE_CHECKING:
    from ..models.patc_hshipping_methodsshipping_method_id_response_200_data_attributes_metadata import (
        PATCHshippingMethodsshippingMethodIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHshippingMethodsshippingMethodIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHshippingMethodsshippingMethodIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHshippingMethodsshippingMethodIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "PATCHshippingMethodsshippingMethodIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHshippingMethodsshippingMethodIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHshippingMethodsshippingMethodIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hshipping_methodsshipping_method_id_response_200_data_attributes = cls(
            name=name,
            scheme=scheme,
        ...
        patc_hshipping_methodsshipping_method_id_response_200_data_attributes.additional_properties = d
        return patc_hshipping_methodsshipping_method_id_response_200_data_attributes
