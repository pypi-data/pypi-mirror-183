...
if TYPE_CHECKING:
    from ..models.shipment_data_attributes_get_rates_errors_item import ShipmentDataAttributesGetRatesErrorsItem
    from ..models.shipment_data_attributes_metadata import ShipmentDataAttributesMetadata
    from ..models.shipment_data_attributes_rates_item import ShipmentDataAttributesRatesItem


T = TypeVar("T", bound="ShipmentDataAttributes")


@attr.s(auto_attribs=True)
class ShipmentDataAttributes:
    """
    Attributes:
        ...
        rates (Union[Unset, List['ShipmentDataAttributesRatesItem']]): The available shipping rates. Example: [{'id':
            'rate_f89e4663c3ed47ee94d37763f6d21d54', 'rate': '45.59', 'carrier': 'DHLExpress', 'service':
            'MedicalExpress'}].
        ...
        get_rates_errors (Union[Unset, List['ShipmentDataAttributesGetRatesErrorsItem']]): Any errors collected when
            fetching shipping rates. Example: [{'carrier': 'DHLExpress', 'message': 'to_address.postal_code: Shorter than
            minimum length 3', 'type': 'rate_error'}].
        ...
        metadata (Union[Unset, ShipmentDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    rates: Union[Unset, List["ShipmentDataAttributesRatesItem"]] = UNSET
    purchase_error_code: Union[Unset, str] = UNSET
    purchase_error_message: Union[Unset, str] = UNSET
    get_rates_errors: Union[Unset, List["ShipmentDataAttributesGetRatesErrorsItem"]] = UNSET
    ...
    metadata: Union[Unset, "ShipmentDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = ShipmentDataAttributesRatesItem.from_dict(rates_item_data)
        ...
        for get_rates_errors_item_data in _get_rates_errors or []:
            get_rates_errors_item = ShipmentDataAttributesGetRatesErrorsItem.from_dict(get_rates_errors_item_data)
        ...
        metadata: Union[Unset, ShipmentDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShipmentDataAttributesMetadata.from_dict(_metadata)

        shipment_data_attributes = cls(
            number=number,
            status=status,
        ...
        shipment_data_attributes.additional_properties = d
        return shipment_data_attributes
