...
if TYPE_CHECKING:
    from ..models.fixed_price_promotion_create_data_attributes_metadata import (
        FixedPricePromotionCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FixedPricePromotionCreateDataAttributes")


@attr.s(auto_attribs=True)
class FixedPricePromotionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FixedPricePromotionCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FixedPricePromotionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FixedPricePromotionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FixedPricePromotionCreateDataAttributesMetadata.from_dict(_metadata)

        fixed_price_promotion_create_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        fixed_price_promotion_create_data_attributes.additional_properties = d
        return fixed_price_promotion_create_data_attributes
