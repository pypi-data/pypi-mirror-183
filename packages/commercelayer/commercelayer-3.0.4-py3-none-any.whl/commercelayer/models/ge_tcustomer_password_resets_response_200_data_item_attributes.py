...
if TYPE_CHECKING:
    from ..models.ge_tcustomer_password_resets_response_200_data_item_attributes_metadata import (
        GETcustomerPasswordResetsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETcustomerPasswordResetsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcustomerPasswordResetsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETcustomerPasswordResetsResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETcustomerPasswordResetsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETcustomerPasswordResetsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcustomerPasswordResetsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tcustomer_password_resets_response_200_data_item_attributes = cls(
        ...
        ge_tcustomer_password_resets_response_200_data_item_attributes.additional_properties = d
        return ge_tcustomer_password_resets_response_200_data_item_attributes
