...
if TYPE_CHECKING:
    from ..models.ge_tline_items_response_200_data_item_attributes_discount_breakdown import (
        GETlineItemsResponse200DataItemAttributesDiscountBreakdown,
    )
    from ..models.ge_tline_items_response_200_data_item_attributes_metadata import (
        GETlineItemsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_tline_items_response_200_data_item_attributes_tax_breakdown import (
        GETlineItemsResponse200DataItemAttributesTaxBreakdown,
    )


T = TypeVar("T", bound="GETlineItemsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETlineItemsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        discount_breakdown (Union[Unset, GETlineItemsResponse200DataItemAttributesDiscountBreakdown]): The discount
            breakdown for this line item (if calculated). Example: {'41': {'cents': -900, 'weight': 0.416}}.
        tax_rate (Union[Unset, float]): The tax rate for this line item (if calculated). Example: 0.22.
        tax_breakdown (Union[Unset, GETlineItemsResponse200DataItemAttributesTaxBreakdown]): The tax breakdown for this
            line item (if calculated). Example: {'id': '1234', 'city_amount': '0.0', 'state_amount': 6.6, 'city_tax_rate':
            0.0, 'county_amount': 2.78, 'taxable_amount': 139.0, 'county_tax_rate': 0.02, 'tax_collectable': 10.08,
        ...
        metadata (Union[Unset, GETlineItemsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    discount_breakdown: Union[Unset, "GETlineItemsResponse200DataItemAttributesDiscountBreakdown"] = UNSET
    tax_rate: Union[Unset, float] = UNSET
    tax_breakdown: Union[Unset, "GETlineItemsResponse200DataItemAttributesTaxBreakdown"] = UNSET
    item_type: Union[Unset, str] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETlineItemsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        discount_breakdown: Union[Unset, GETlineItemsResponse200DataItemAttributesDiscountBreakdown]
        if isinstance(_discount_breakdown, Unset):
            discount_breakdown = UNSET
        else:
            discount_breakdown = GETlineItemsResponse200DataItemAttributesDiscountBreakdown.from_dict(
                _discount_breakdown
            )
        ...
        tax_breakdown: Union[Unset, GETlineItemsResponse200DataItemAttributesTaxBreakdown]
        if isinstance(_tax_breakdown, Unset):
            tax_breakdown = UNSET
        else:
            tax_breakdown = GETlineItemsResponse200DataItemAttributesTaxBreakdown.from_dict(_tax_breakdown)
        ...
        metadata: Union[Unset, GETlineItemsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETlineItemsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tline_items_response_200_data_item_attributes = cls(
            sku_code=sku_code,
        ...
        ge_tline_items_response_200_data_item_attributes.additional_properties = d
        return ge_tline_items_response_200_data_item_attributes
