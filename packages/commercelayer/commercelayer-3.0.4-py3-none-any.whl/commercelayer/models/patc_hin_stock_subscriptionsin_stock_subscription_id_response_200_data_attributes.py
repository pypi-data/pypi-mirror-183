...
if TYPE_CHECKING:
    from ..models.patc_hin_stock_subscriptionsin_stock_subscription_id_response_200_data_attributes_metadata import (
        PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributesMetadata]): Set of
    ...
    metadata: Union[Unset, "PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHinStockSubscriptionsinStockSubscriptionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )

        patc_hin_stock_subscriptionsin_stock_subscription_id_response_200_data_attributes = cls(
            sku_code=sku_code,
        ...
        patc_hin_stock_subscriptionsin_stock_subscription_id_response_200_data_attributes.additional_properties = d
        return patc_hin_stock_subscriptionsin_stock_subscription_id_response_200_data_attributes
