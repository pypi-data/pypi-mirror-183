...
if TYPE_CHECKING:
    from ..models.sku_data_attributes_inventory import SkuDataAttributesInventory
    from ..models.sku_data_attributes_metadata import SkuDataAttributesMetadata


T = TypeVar("T", bound="SkuDataAttributes")


@attr.s(auto_attribs=True)
class SkuDataAttributes:
    """
    Attributes:
        ...
        inventory (Union[Unset, SkuDataAttributesInventory]): Aggregated information about the SKU's inventory. Returned
            only when retrieving a single SKU. Example: {'available': True, 'quantity': 10, 'levels': [{'quantity': 4,
            'delivery_lead_times': [{'shipping_method': {'name': 'Standard Shipping', 'reference': None,
        ...
        metadata (Union[Unset, SkuDataAttributesMetadata]): Set of key-value pairs that you can attach to the resource.
            This can be useful for storing additional information about the resource in a structured format. Example:
            {'foo': 'bar'}.
    """
    ...
    inventory: Union[Unset, "SkuDataAttributesInventory"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "SkuDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inventory: Union[Unset, SkuDataAttributesInventory]
        if isinstance(_inventory, Unset):
            inventory = UNSET
        else:
            inventory = SkuDataAttributesInventory.from_dict(_inventory)
        ...
        metadata: Union[Unset, SkuDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuDataAttributesMetadata.from_dict(_metadata)

        sku_data_attributes = cls(
            code=code,
            name=name,
        ...
        sku_data_attributes.additional_properties = d
        return sku_data_attributes
