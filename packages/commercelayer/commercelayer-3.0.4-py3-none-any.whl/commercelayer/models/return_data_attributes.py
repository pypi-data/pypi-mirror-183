...
if TYPE_CHECKING:
    from ..models.return_data_attributes_metadata import ReturnDataAttributesMetadata


T = TypeVar("T", bound="ReturnDataAttributes")


@attr.s(auto_attribs=True)
class ReturnDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ReturnDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ReturnDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ReturnDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ReturnDataAttributesMetadata.from_dict(_metadata)

        return_data_attributes = cls(
            number=number,
            status=status,
        ...
        return_data_attributes.additional_properties = d
        return return_data_attributes
