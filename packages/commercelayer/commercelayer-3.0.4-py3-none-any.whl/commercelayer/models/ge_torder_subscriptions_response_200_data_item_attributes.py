...
if TYPE_CHECKING:
    from ..models.ge_torder_subscriptions_response_200_data_item_attributes_metadata import (
        GETorderSubscriptionsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_torder_subscriptions_response_200_data_item_attributes_options import (
        GETorderSubscriptionsResponse200DataItemAttributesOptions,
    )


T = TypeVar("T", bound="GETorderSubscriptionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETorderSubscriptionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        succeeded_on_last_run (Union[Unset, bool]): Indicates if the subscription has succeeded on its last run.
            Example: True.
        options (Union[Unset, GETorderSubscriptionsResponse200DataItemAttributesOptions]): The subscription options used
            to create the order copy (check order_copies for more information). For subscriptions the `place_target_order`
            is enabled by default, specify custom options to overwrite it. Example: {'place_target_order': False}.
        ...
        metadata (Union[Unset, GETorderSubscriptionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    options: Union[Unset, "GETorderSubscriptionsResponse200DataItemAttributesOptions"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETorderSubscriptionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        options: Union[Unset, GETorderSubscriptionsResponse200DataItemAttributesOptions]
        if isinstance(_options, Unset):
            options = UNSET
        else:
            options = GETorderSubscriptionsResponse200DataItemAttributesOptions.from_dict(_options)
        ...
        metadata: Union[Unset, GETorderSubscriptionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETorderSubscriptionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_torder_subscriptions_response_200_data_item_attributes = cls(
            number=number,
            status=status,
            frequency=frequency,
        ...
        ge_torder_subscriptions_response_200_data_item_attributes.additional_properties = d
        return ge_torder_subscriptions_response_200_data_item_attributes
