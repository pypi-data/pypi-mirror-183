...
if TYPE_CHECKING:
    from ..models.ge_tdelivery_lead_timesdelivery_lead_time_id_response_200_data_attributes_metadata import (
        GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributesMetadata]): Set of key-
    ...
    metadata: Union[Unset, "GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETdeliveryLeadTimesdeliveryLeadTimeIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tdelivery_lead_timesdelivery_lead_time_id_response_200_data_attributes = cls(
            min_hours=min_hours,
            max_hours=max_hours,
            min_days=min_days,
            max_days=max_days,
        ...
        ge_tdelivery_lead_timesdelivery_lead_time_id_response_200_data_attributes.additional_properties = d
        return ge_tdelivery_lead_timesdelivery_lead_time_id_response_200_data_attributes
