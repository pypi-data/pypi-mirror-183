...
if TYPE_CHECKING:
    from ..models.sku_list_promotion_rule_data_attributes_metadata import SkuListPromotionRuleDataAttributesMetadata


T = TypeVar("T", bound="SkuListPromotionRuleDataAttributes")


@attr.s(auto_attribs=True)
class SkuListPromotionRuleDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListPromotionRuleDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "SkuListPromotionRuleDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListPromotionRuleDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListPromotionRuleDataAttributesMetadata.from_dict(_metadata)

        all_skus = d.pop("all_skus", UNSET)

        min_quantity = d.pop("min_quantity", UNSET)

        sku_list_promotion_rule_data_attributes = cls(
        ...
        sku_list_promotion_rule_data_attributes.additional_properties = d
        return sku_list_promotion_rule_data_attributes
