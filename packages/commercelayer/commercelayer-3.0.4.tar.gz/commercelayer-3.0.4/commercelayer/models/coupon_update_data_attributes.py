...
if TYPE_CHECKING:
    from ..models.coupon_update_data_attributes_metadata import CouponUpdateDataAttributesMetadata


T = TypeVar("T", bound="CouponUpdateDataAttributes")


@attr.s(auto_attribs=True)
class CouponUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CouponUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "CouponUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CouponUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CouponUpdateDataAttributesMetadata.from_dict(_metadata)

        coupon_update_data_attributes = cls(
            code=code,
        ...
        coupon_update_data_attributes.additional_properties = d
        return coupon_update_data_attributes
