...
if TYPE_CHECKING:
    from ..models.ge_tcoupons_response_200_data_item_attributes_metadata import (
        GETcouponsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETcouponsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcouponsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETcouponsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETcouponsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETcouponsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcouponsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tcoupons_response_200_data_item_attributes = cls(
            code=code,
        ...
        ge_tcoupons_response_200_data_item_attributes.additional_properties = d
        return ge_tcoupons_response_200_data_item_attributes
