...
if TYPE_CHECKING:
    from ..models.ge_tbundles_response_200_data_item_attributes_metadata import (
        GETbundlesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETbundlesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETbundlesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETbundlesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETbundlesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETbundlesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETbundlesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tbundles_response_200_data_item_attributes = cls(
            code=code,
            name=name,
        ...
        ge_tbundles_response_200_data_item_attributes.additional_properties = d
        return ge_tbundles_response_200_data_item_attributes
