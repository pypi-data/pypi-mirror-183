...
if TYPE_CHECKING:
    from ..models.pos_tin_stock_subscriptions_response_201_data_attributes_metadata import (
        POSTinStockSubscriptionsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTinStockSubscriptionsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTinStockSubscriptionsResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTinStockSubscriptionsResponse201DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "POSTinStockSubscriptionsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTinStockSubscriptionsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTinStockSubscriptionsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tin_stock_subscriptions_response_201_data_attributes = cls(
        ...
        pos_tin_stock_subscriptions_response_201_data_attributes.additional_properties = d
        return pos_tin_stock_subscriptions_response_201_data_attributes
