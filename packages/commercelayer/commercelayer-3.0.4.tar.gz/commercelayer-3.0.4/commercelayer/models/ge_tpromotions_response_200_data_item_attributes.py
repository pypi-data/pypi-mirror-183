...
if TYPE_CHECKING:
    from ..models.ge_tpromotions_response_200_data_item_attributes_metadata import (
        GETpromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpromotionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETpromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tpromotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tpromotions_response_200_data_item_attributes.additional_properties = d
        return ge_tpromotions_response_200_data_item_attributes
