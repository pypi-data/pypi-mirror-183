...
if TYPE_CHECKING:
    from ..models.patc_htax_rulestax_rule_id_response_200_data_attributes_metadata import (
        PATCHtaxRulestaxRuleIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHtaxRulestaxRuleIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHtaxRulestaxRuleIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHtaxRulestaxRuleIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHtaxRulestaxRuleIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHtaxRulestaxRuleIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHtaxRulestaxRuleIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_htax_rulestax_rule_id_response_200_data_attributes = cls(
            name=name,
            tax_rate=tax_rate,
        ...
        patc_htax_rulestax_rule_id_response_200_data_attributes.additional_properties = d
        return patc_htax_rulestax_rule_id_response_200_data_attributes
