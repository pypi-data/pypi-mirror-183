...
if TYPE_CHECKING:
    from ..models.shipping_method_create_data_attributes_metadata import ShippingMethodCreateDataAttributesMetadata


T = TypeVar("T", bound="ShippingMethodCreateDataAttributes")


@attr.s(auto_attribs=True)
class ShippingMethodCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingMethodCreateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "ShippingMethodCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingMethodCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingMethodCreateDataAttributesMetadata.from_dict(_metadata)

        shipping_method_create_data_attributes = cls(
            name=name,
            price_amount_cents=price_amount_cents,
            scheme=scheme,
        ...
        shipping_method_create_data_attributes.additional_properties = d
        return shipping_method_create_data_attributes
