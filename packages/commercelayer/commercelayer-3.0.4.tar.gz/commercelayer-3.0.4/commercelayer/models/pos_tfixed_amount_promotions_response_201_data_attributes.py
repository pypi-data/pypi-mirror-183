...
if TYPE_CHECKING:
    from ..models.pos_tfixed_amount_promotions_response_201_data_attributes_metadata import (
        POSTfixedAmountPromotionsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTfixedAmountPromotionsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTfixedAmountPromotionsResponse201DataAttributes:
    """
    Attributes:
        ...
        fixed_amount_cents (int): The discount fixed amount to be applied, in cents Example: 1000.
        ...
        metadata (Union[Unset, POSTfixedAmountPromotionsResponse201DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "POSTfixedAmountPromotionsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTfixedAmountPromotionsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTfixedAmountPromotionsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tfixed_amount_promotions_response_201_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        pos_tfixed_amount_promotions_response_201_data_attributes.additional_properties = d
        return pos_tfixed_amount_promotions_response_201_data_attributes
