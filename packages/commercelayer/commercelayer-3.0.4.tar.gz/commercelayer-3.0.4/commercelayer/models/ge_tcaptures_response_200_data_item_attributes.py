...
if TYPE_CHECKING:
    from ..models.ge_tcaptures_response_200_data_item_attributes_metadata import (
        GETcapturesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETcapturesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcapturesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETcapturesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETcapturesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETcapturesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcapturesResponse200DataItemAttributesMetadata.from_dict(_metadata)
        ...
        ge_tcaptures_response_200_data_item_attributes = cls(
            number=number,
        ...
        ge_tcaptures_response_200_data_item_attributes.additional_properties = d
        return ge_tcaptures_response_200_data_item_attributes
