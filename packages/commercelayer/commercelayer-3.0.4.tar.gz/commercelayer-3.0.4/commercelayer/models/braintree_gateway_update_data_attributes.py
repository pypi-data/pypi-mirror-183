...
if TYPE_CHECKING:
    from ..models.braintree_gateway_update_data_attributes_metadata import BraintreeGatewayUpdateDataAttributesMetadata


T = TypeVar("T", bound="BraintreeGatewayUpdateDataAttributes")


@attr.s(auto_attribs=True)
class BraintreeGatewayUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, BraintreeGatewayUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "BraintreeGatewayUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.braintree_gateway_update_data_attributes_metadata import (
            BraintreeGatewayUpdateDataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, BraintreeGatewayUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = BraintreeGatewayUpdateDataAttributesMetadata.from_dict(_metadata)
        ...
        braintree_gateway_update_data_attributes = cls(
            name=name,
            reference=reference,
        ...
        braintree_gateway_update_data_attributes.additional_properties = d
        return braintree_gateway_update_data_attributes
