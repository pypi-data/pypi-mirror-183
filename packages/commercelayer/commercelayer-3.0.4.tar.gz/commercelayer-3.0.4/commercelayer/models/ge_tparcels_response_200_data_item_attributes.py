...
if TYPE_CHECKING:
    from ..models.ge_tparcels_response_200_data_item_attributes_metadata import (
        GETparcelsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETparcelsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETparcelsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETparcelsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETparcelsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETparcelsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETparcelsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tparcels_response_200_data_item_attributes = cls(
            number=number,
            weight=weight,
        ...
        ge_tparcels_response_200_data_item_attributes.additional_properties = d
        return ge_tparcels_response_200_data_item_attributes
