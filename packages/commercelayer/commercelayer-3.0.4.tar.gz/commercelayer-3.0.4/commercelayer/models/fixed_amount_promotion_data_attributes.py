...
if TYPE_CHECKING:
    from ..models.fixed_amount_promotion_data_attributes_metadata import FixedAmountPromotionDataAttributesMetadata


T = TypeVar("T", bound="FixedAmountPromotionDataAttributes")


@attr.s(auto_attribs=True)
class FixedAmountPromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FixedAmountPromotionDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "FixedAmountPromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FixedAmountPromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FixedAmountPromotionDataAttributesMetadata.from_dict(_metadata)
        ...
        fixed_amount_promotion_data_attributes = cls(
            name=name,
        ...
        fixed_amount_promotion_data_attributes.additional_properties = d
        return fixed_amount_promotion_data_attributes
