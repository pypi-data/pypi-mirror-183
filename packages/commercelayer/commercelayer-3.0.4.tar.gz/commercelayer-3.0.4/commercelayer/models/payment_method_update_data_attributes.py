...
if TYPE_CHECKING:
    from ..models.payment_method_update_data_attributes_metadata import PaymentMethodUpdateDataAttributesMetadata


T = TypeVar("T", bound="PaymentMethodUpdateDataAttributes")


@attr.s(auto_attribs=True)
class PaymentMethodUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PaymentMethodUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "PaymentMethodUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PaymentMethodUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PaymentMethodUpdateDataAttributesMetadata.from_dict(_metadata)

        payment_method_update_data_attributes = cls(
        ...
        payment_method_update_data_attributes.additional_properties = d
        return payment_method_update_data_attributes
