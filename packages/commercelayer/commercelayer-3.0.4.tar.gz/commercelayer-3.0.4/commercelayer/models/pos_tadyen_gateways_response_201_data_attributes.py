...
if TYPE_CHECKING:
    from ..models.pos_tadyen_gateways_response_201_data_attributes_metadata import (
        POSTadyenGatewaysResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTadyenGatewaysResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTadyenGatewaysResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTadyenGatewaysResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTadyenGatewaysResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTadyenGatewaysResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTadyenGatewaysResponse201DataAttributesMetadata.from_dict(_metadata)

        public_key = d.pop("public_key", UNSET)

        pos_tadyen_gateways_response_201_data_attributes = cls(
            name=name,
            merchant_account=merchant_account,
            api_key=api_key,
            live_url_prefix=live_url_prefix,
        ...
        pos_tadyen_gateways_response_201_data_attributes.additional_properties = d
        return pos_tadyen_gateways_response_201_data_attributes
