...
if TYPE_CHECKING:
    from ..models.ge_ttransactionstransaction_id_response_200_data_attributes_metadata import (
        GETtransactionstransactionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETtransactionstransactionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETtransactionstransactionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETtransactionstransactionIdResponse200DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETtransactionstransactionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETtransactionstransactionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETtransactionstransactionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_ttransactionstransaction_id_response_200_data_attributes = cls(
            number=number,
        ...
        ge_ttransactionstransaction_id_response_200_data_attributes.additional_properties = d
        return ge_ttransactionstransaction_id_response_200_data_attributes
