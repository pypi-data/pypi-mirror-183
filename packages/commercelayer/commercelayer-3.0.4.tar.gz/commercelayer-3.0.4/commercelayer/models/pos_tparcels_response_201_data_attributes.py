...
if TYPE_CHECKING:
    from ..models.pos_tparcels_response_201_data_attributes_metadata import POSTparcelsResponse201DataAttributesMetadata


T = TypeVar("T", bound="POSTparcelsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTparcelsResponse201DataAttributes:
    """
    Attributes:
        weight (float): The parcel weight, used to automatically calculate the tax rates from the available carrier
            accounts. Example: 1000.0.
        unit_of_weight (str): Can be one of 'gr', 'lb', or 'oz' Example: gr.
        ...
        metadata (Union[Unset, POSTparcelsResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTparcelsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.pos_tparcels_response_201_data_attributes_metadata import (
            POSTparcelsResponse201DataAttributesMetadata,
        )

        d = src_dict.copy()
        weight = d.pop("weight")

        unit_of_weight = d.pop("unit_of_weight")
        ...
        metadata: Union[Unset, POSTparcelsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTparcelsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tparcels_response_201_data_attributes = cls(
            weight=weight,
            unit_of_weight=unit_of_weight,
            eel_pfc=eel_pfc,
        ...
        pos_tparcels_response_201_data_attributes.additional_properties = d
        return pos_tparcels_response_201_data_attributes
