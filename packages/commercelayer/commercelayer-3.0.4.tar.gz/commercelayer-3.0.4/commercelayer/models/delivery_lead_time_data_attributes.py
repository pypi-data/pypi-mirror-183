...
if TYPE_CHECKING:
    from ..models.delivery_lead_time_data_attributes_metadata import DeliveryLeadTimeDataAttributesMetadata


T = TypeVar("T", bound="DeliveryLeadTimeDataAttributes")


@attr.s(auto_attribs=True)
class DeliveryLeadTimeDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, DeliveryLeadTimeDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "DeliveryLeadTimeDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, DeliveryLeadTimeDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = DeliveryLeadTimeDataAttributesMetadata.from_dict(_metadata)

        delivery_lead_time_data_attributes = cls(
            min_hours=min_hours,
            max_hours=max_hours,
            min_days=min_days,
            max_days=max_days,
        ...
        delivery_lead_time_data_attributes.additional_properties = d
        return delivery_lead_time_data_attributes
