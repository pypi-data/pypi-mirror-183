...
if TYPE_CHECKING:
    from ..models.patc_hcouponscoupon_id_response_200_data_attributes_metadata import (
        PATCHcouponscouponIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHcouponscouponIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHcouponscouponIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHcouponscouponIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "PATCHcouponscouponIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHcouponscouponIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHcouponscouponIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hcouponscoupon_id_response_200_data_attributes = cls(
            code=code,
        ...
        patc_hcouponscoupon_id_response_200_data_attributes.additional_properties = d
        return patc_hcouponscoupon_id_response_200_data_attributes
