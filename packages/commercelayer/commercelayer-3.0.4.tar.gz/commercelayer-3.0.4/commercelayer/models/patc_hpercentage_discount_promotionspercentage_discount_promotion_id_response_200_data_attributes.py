...
if TYPE_CHECKING:
    from ..models.patc_hpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes_metadata import (
        PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset,
            PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata]): Set of key-
        ...
        percentage (Union[Unset, int]): The discount percentage to be applied. Example: 10.
    """
    ...
    metadata: Union[
        Unset, "PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = PATCHpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )

        percentage = d.pop("percentage", UNSET)

        patc_hpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes.additional_properties = (
            d
        )
        return patc_hpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes
