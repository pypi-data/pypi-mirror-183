...
if TYPE_CHECKING:
    from ..models.ge_tshipping_zonesshipping_zone_id_response_200_data_attributes_metadata import (
        GETshippingZonesshippingZoneIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingZonesshippingZoneIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETshippingZonesshippingZoneIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingZonesshippingZoneIdResponse200DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETshippingZonesshippingZoneIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingZonesshippingZoneIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingZonesshippingZoneIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tshipping_zonesshipping_zone_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tshipping_zonesshipping_zone_id_response_200_data_attributes.additional_properties = d
        return ge_tshipping_zonesshipping_zone_id_response_200_data_attributes
