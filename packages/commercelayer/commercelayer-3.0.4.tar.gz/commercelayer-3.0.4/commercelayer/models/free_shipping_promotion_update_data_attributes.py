...
if TYPE_CHECKING:
    from ..models.free_shipping_promotion_update_data_attributes_metadata import (
        FreeShippingPromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FreeShippingPromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class FreeShippingPromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeShippingPromotionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FreeShippingPromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FreeShippingPromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeShippingPromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        free_shipping_promotion_update_data_attributes = cls(
            name=name,
        ...
        free_shipping_promotion_update_data_attributes.additional_properties = d
        return free_shipping_promotion_update_data_attributes
