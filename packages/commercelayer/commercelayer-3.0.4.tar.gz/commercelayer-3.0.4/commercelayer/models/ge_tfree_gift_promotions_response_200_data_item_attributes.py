...
if TYPE_CHECKING:
    from ..models.ge_tfree_gift_promotions_response_200_data_item_attributes_metadata import (
        GETfreeGiftPromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETfreeGiftPromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETfreeGiftPromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETfreeGiftPromotionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETfreeGiftPromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETfreeGiftPromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETfreeGiftPromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        ge_tfree_gift_promotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tfree_gift_promotions_response_200_data_item_attributes.additional_properties = d
        return ge_tfree_gift_promotions_response_200_data_item_attributes
