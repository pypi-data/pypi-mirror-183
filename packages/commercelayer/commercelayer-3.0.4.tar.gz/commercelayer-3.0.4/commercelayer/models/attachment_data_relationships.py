...
T = TypeVar("T", bound="AttachmentDataRelationships")
...
class AttachmentDataRelationships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_data_relationships = cls(
            attachable=attachable,
        )

        attachment_data_relationships.additional_properties = d
        return attachment_data_relationships
