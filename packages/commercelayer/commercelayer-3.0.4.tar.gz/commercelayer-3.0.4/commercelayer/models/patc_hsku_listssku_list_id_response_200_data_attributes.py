...
if TYPE_CHECKING:
    from ..models.patc_hsku_listssku_list_id_response_200_data_attributes_metadata import (
        PATCHskuListsskuListIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHskuListsskuListIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHskuListsskuListIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHskuListsskuListIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHskuListsskuListIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHskuListsskuListIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHskuListsskuListIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hsku_listssku_list_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hsku_listssku_list_id_response_200_data_attributes.additional_properties = d
        return patc_hsku_listssku_list_id_response_200_data_attributes
