...
if TYPE_CHECKING:
    from ..models.capture_data_attributes_metadata import CaptureDataAttributesMetadata


T = TypeVar("T", bound="CaptureDataAttributes")


@attr.s(auto_attribs=True)
class CaptureDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CaptureDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "CaptureDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CaptureDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CaptureDataAttributesMetadata.from_dict(_metadata)
        ...
        capture_data_attributes.additional_properties = d
        return capture_data_attributes
