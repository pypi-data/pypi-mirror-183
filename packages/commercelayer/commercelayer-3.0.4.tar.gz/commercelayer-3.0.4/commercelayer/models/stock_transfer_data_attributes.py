...
if TYPE_CHECKING:
    from ..models.stock_transfer_data_attributes_metadata import StockTransferDataAttributesMetadata


T = TypeVar("T", bound="StockTransferDataAttributes")


@attr.s(auto_attribs=True)
class StockTransferDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, StockTransferDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "StockTransferDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, StockTransferDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StockTransferDataAttributesMetadata.from_dict(_metadata)

        stock_transfer_data_attributes = cls(
            sku_code=sku_code,
            status=status,
            quantity=quantity,
        ...
        stock_transfer_data_attributes.additional_properties = d
        return stock_transfer_data_attributes
