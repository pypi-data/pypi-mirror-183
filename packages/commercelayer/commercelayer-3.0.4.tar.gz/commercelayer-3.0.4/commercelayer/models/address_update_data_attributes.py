...
if TYPE_CHECKING:
    from ..models.address_update_data_attributes_metadata import AddressUpdateDataAttributesMetadata


T = TypeVar("T", bound="AddressUpdateDataAttributes")


@attr.s(auto_attribs=True)
class AddressUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AddressUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "AddressUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AddressUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AddressUpdateDataAttributesMetadata.from_dict(_metadata)

        address_update_data_attributes = cls(
            business=business,
        ...
        address_update_data_attributes.additional_properties = d
        return address_update_data_attributes
