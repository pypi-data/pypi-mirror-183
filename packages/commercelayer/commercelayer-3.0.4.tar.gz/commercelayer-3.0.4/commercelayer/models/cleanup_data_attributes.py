...
if TYPE_CHECKING:
    from ..models.cleanup_data_attributes_errors_log import CleanupDataAttributesErrorsLog
    from ..models.cleanup_data_attributes_filters import CleanupDataAttributesFilters
    from ..models.cleanup_data_attributes_metadata import CleanupDataAttributesMetadata


T = TypeVar("T", bound="CleanupDataAttributes")


@attr.s(auto_attribs=True)
class CleanupDataAttributes:
    """
    Attributes:
        ...
        filters (Union[Unset, CleanupDataAttributesFilters]): The filters used to select the records to be cleaned.
            Example: {'code_eq': 'AAA'}.
        ...
        errors_log (Union[Unset, CleanupDataAttributesErrorsLog]): Contains the cleanup errors, if any. Example: {'ABC':
        ...
        metadata (Union[Unset, CleanupDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    filters: Union[Unset, "CleanupDataAttributesFilters"] = UNSET
    records_count: Union[Unset, int] = UNSET
    errors_count: Union[Unset, int] = UNSET
    processed_count: Union[Unset, int] = UNSET
    errors_log: Union[Unset, "CleanupDataAttributesErrorsLog"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "CleanupDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filters: Union[Unset, CleanupDataAttributesFilters]
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = CleanupDataAttributesFilters.from_dict(_filters)
        ...
        errors_log: Union[Unset, CleanupDataAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = CleanupDataAttributesErrorsLog.from_dict(_errors_log)
        ...
        metadata: Union[Unset, CleanupDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CleanupDataAttributesMetadata.from_dict(_metadata)

        cleanup_data_attributes = cls(
        ...
        cleanup_data_attributes.additional_properties = d
        return cleanup_data_attributes
