...
if TYPE_CHECKING:
    from ..models.pos_torder_copies_response_201_data_attributes_metadata import (
        POSTorderCopiesResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTorderCopiesResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTorderCopiesResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTorderCopiesResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTorderCopiesResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTorderCopiesResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTorderCopiesResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_torder_copies_response_201_data_attributes = cls(
        ...
        pos_torder_copies_response_201_data_attributes.additional_properties = d
        return pos_torder_copies_response_201_data_attributes
