...
if TYPE_CHECKING:
    from ..models.ge_tprice_volume_tiers_response_200_data_item_attributes_metadata import (
        GETpriceVolumeTiersResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpriceVolumeTiersResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpriceVolumeTiersResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpriceVolumeTiersResponse200DataItemAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETpriceVolumeTiersResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpriceVolumeTiersResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpriceVolumeTiersResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tprice_volume_tiers_response_200_data_item_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        ge_tprice_volume_tiers_response_200_data_item_attributes.additional_properties = d
        return ge_tprice_volume_tiers_response_200_data_item_attributes
