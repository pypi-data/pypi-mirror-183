...
if TYPE_CHECKING:
    from ..models.free_shipping_promotion_create_data_attributes_metadata import (
        FreeShippingPromotionCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FreeShippingPromotionCreateDataAttributes")


@attr.s(auto_attribs=True)
class FreeShippingPromotionCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeShippingPromotionCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FreeShippingPromotionCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FreeShippingPromotionCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeShippingPromotionCreateDataAttributesMetadata.from_dict(_metadata)

        free_shipping_promotion_create_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        free_shipping_promotion_create_data_attributes.additional_properties = d
        return free_shipping_promotion_create_data_attributes
