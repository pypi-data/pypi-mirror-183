...
if TYPE_CHECKING:
    from ..models.ge_tpromotionspromotion_id_response_200_data_attributes_metadata import (
        GETpromotionspromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpromotionspromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpromotionspromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpromotionspromotionIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETpromotionspromotionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpromotionspromotionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpromotionspromotionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tpromotionspromotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tpromotionspromotion_id_response_200_data_attributes.additional_properties = d
        return ge_tpromotionspromotion_id_response_200_data_attributes
