...
if TYPE_CHECKING:
    from ..models.ge_tpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes_metadata import (
        GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset,
            GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata]): Set of key-
    ...
    metadata: Union[
        Unset, "GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = (
                GETpercentageDiscountPromotionspercentageDiscountPromotionIdResponse200DataAttributesMetadata.from_dict(
                    _metadata
                )
            )
        ...
        ge_tpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes.additional_properties = (
            d
        )
        return ge_tpercentage_discount_promotionspercentage_discount_promotion_id_response_200_data_attributes
