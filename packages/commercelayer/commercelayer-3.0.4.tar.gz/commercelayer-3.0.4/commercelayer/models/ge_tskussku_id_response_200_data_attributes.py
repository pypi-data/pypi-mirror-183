...
if TYPE_CHECKING:
    from ..models.ge_tskussku_id_response_200_data_attributes_inventory import (
        GETskusskuIdResponse200DataAttributesInventory,
    )
    from ..models.ge_tskussku_id_response_200_data_attributes_metadata import (
        GETskusskuIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETskusskuIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETskusskuIdResponse200DataAttributes:
    """
    Attributes:
        ...
        inventory (Union[Unset, GETskusskuIdResponse200DataAttributesInventory]): Aggregated information about the SKU's
        ...
        metadata (Union[Unset, GETskusskuIdResponse200DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    inventory: Union[Unset, "GETskusskuIdResponse200DataAttributesInventory"] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETskusskuIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inventory: Union[Unset, GETskusskuIdResponse200DataAttributesInventory]
        if isinstance(_inventory, Unset):
            inventory = UNSET
        else:
            inventory = GETskusskuIdResponse200DataAttributesInventory.from_dict(_inventory)
        ...
        metadata: Union[Unset, GETskusskuIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETskusskuIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tskussku_id_response_200_data_attributes = cls(
            code=code,
            name=name,
        ...
        ge_tskussku_id_response_200_data_attributes.additional_properties = d
        return ge_tskussku_id_response_200_data_attributes
