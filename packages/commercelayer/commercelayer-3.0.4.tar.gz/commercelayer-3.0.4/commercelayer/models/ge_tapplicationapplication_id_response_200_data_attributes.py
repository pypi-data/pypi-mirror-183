...
if TYPE_CHECKING:
    from ..models.ge_tapplicationapplication_id_response_200_data_attributes_metadata import (
        GETapplicationapplicationIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETapplicationapplicationIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETapplicationapplicationIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETapplicationapplicationIdResponse200DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETapplicationapplicationIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETapplicationapplicationIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETapplicationapplicationIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tapplicationapplication_id_response_200_data_attributes = cls(
            name=name,
            kind=kind,
        ...
        ge_tapplicationapplication_id_response_200_data_attributes.additional_properties = d
        return ge_tapplicationapplication_id_response_200_data_attributes
