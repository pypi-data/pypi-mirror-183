...
if TYPE_CHECKING:
    from ..models.adyen_gateway_update_data_attributes_metadata import AdyenGatewayUpdateDataAttributesMetadata


T = TypeVar("T", bound="AdyenGatewayUpdateDataAttributes")


@attr.s(auto_attribs=True)
class AdyenGatewayUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, AdyenGatewayUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "AdyenGatewayUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AdyenGatewayUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AdyenGatewayUpdateDataAttributesMetadata.from_dict(_metadata)
        ...
        adyen_gateway_update_data_attributes = cls(
            name=name,
            reference=reference,
        ...
        adyen_gateway_update_data_attributes.additional_properties = d
        return adyen_gateway_update_data_attributes
