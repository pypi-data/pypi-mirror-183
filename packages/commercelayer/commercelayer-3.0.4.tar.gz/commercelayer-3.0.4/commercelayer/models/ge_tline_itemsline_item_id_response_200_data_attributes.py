...
if TYPE_CHECKING:
    from ..models.ge_tline_itemsline_item_id_response_200_data_attributes_discount_breakdown import (
        GETlineItemslineItemIdResponse200DataAttributesDiscountBreakdown,
    )
    from ..models.ge_tline_itemsline_item_id_response_200_data_attributes_metadata import (
        GETlineItemslineItemIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_tline_itemsline_item_id_response_200_data_attributes_tax_breakdown import (
        GETlineItemslineItemIdResponse200DataAttributesTaxBreakdown,
    )


T = TypeVar("T", bound="GETlineItemslineItemIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETlineItemslineItemIdResponse200DataAttributes:
    """
    Attributes:
        ...
        discount_breakdown (Union[Unset, GETlineItemslineItemIdResponse200DataAttributesDiscountBreakdown]): The
            discount breakdown for this line item (if calculated). Example: {'41': {'cents': -900, 'weight': 0.416}}.
        tax_rate (Union[Unset, float]): The tax rate for this line item (if calculated). Example: 0.22.
        tax_breakdown (Union[Unset, GETlineItemslineItemIdResponse200DataAttributesTaxBreakdown]): The tax breakdown for
            this line item (if calculated). Example: {'id': '1234', 'city_amount': '0.0', 'state_amount': 6.6,
            'city_tax_rate': 0.0, 'county_amount': 2.78, 'taxable_amount': 139.0, 'county_tax_rate': 0.02,
            'tax_collectable': 10.08, 'special_tax_rate': 0.005, 'combined_tax_rate': 0.0725, 'city_taxable_amount': 0.0,
            'state_sales_tax_rate': 0.0475, 'state_taxable_amount': 139.0, 'county_taxable_amount': 139.0,
            'special_district_amount': 0.7, 'special_district_taxable_amount': 139.0}.
        ...
        metadata (Union[Unset, GETlineItemslineItemIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    discount_breakdown: Union[Unset, "GETlineItemslineItemIdResponse200DataAttributesDiscountBreakdown"] = UNSET
    tax_rate: Union[Unset, float] = UNSET
    tax_breakdown: Union[Unset, "GETlineItemslineItemIdResponse200DataAttributesTaxBreakdown"] = UNSET
    item_type: Union[Unset, str] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETlineItemslineItemIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        discount_breakdown: Union[Unset, GETlineItemslineItemIdResponse200DataAttributesDiscountBreakdown]
        if isinstance(_discount_breakdown, Unset):
            discount_breakdown = UNSET
        else:
            discount_breakdown = GETlineItemslineItemIdResponse200DataAttributesDiscountBreakdown.from_dict(
                _discount_breakdown
            )
        ...
        tax_breakdown: Union[Unset, GETlineItemslineItemIdResponse200DataAttributesTaxBreakdown]
        if isinstance(_tax_breakdown, Unset):
            tax_breakdown = UNSET
        else:
            tax_breakdown = GETlineItemslineItemIdResponse200DataAttributesTaxBreakdown.from_dict(_tax_breakdown)
        ...
        metadata: Union[Unset, GETlineItemslineItemIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETlineItemslineItemIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tline_itemsline_item_id_response_200_data_attributes = cls(
            sku_code=sku_code,
        ...
        ge_tline_itemsline_item_id_response_200_data_attributes.additional_properties = d
        return ge_tline_itemsline_item_id_response_200_data_attributes
