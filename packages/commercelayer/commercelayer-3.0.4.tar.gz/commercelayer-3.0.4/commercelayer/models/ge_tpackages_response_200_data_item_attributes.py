...
if TYPE_CHECKING:
    from ..models.ge_tpackages_response_200_data_item_attributes_metadata import (
        GETpackagesResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpackagesResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpackagesResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpackagesResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETpackagesResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpackagesResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpackagesResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tpackages_response_200_data_item_attributes = cls(
            name=name,
            code=code,
            length=length,
            width=width,
        ...
        ge_tpackages_response_200_data_item_attributes.additional_properties = d
        return ge_tpackages_response_200_data_item_attributes
