...
if TYPE_CHECKING:
    from ..models.price_list_data_attributes_metadata import PriceListDataAttributesMetadata


T = TypeVar("T", bound="PriceListDataAttributes")


@attr.s(auto_attribs=True)
class PriceListDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PriceListDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PriceListDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PriceListDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PriceListDataAttributesMetadata.from_dict(_metadata)

        price_list_data_attributes = cls(
            name=name,
        ...
        price_list_data_attributes.additional_properties = d
        return price_list_data_attributes
