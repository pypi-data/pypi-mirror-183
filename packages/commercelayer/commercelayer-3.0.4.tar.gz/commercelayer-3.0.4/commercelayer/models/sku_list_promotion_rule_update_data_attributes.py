...
if TYPE_CHECKING:
    from ..models.sku_list_promotion_rule_update_data_attributes_metadata import (
        SkuListPromotionRuleUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="SkuListPromotionRuleUpdateDataAttributes")


@attr.s(auto_attribs=True)
class SkuListPromotionRuleUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuListPromotionRuleUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "SkuListPromotionRuleUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuListPromotionRuleUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuListPromotionRuleUpdateDataAttributesMetadata.from_dict(_metadata)

        all_skus = d.pop("all_skus", UNSET)

        min_quantity = d.pop("min_quantity", UNSET)

        sku_list_promotion_rule_update_data_attributes = cls(
            reference=reference,
        ...
        sku_list_promotion_rule_update_data_attributes.additional_properties = d
        return sku_list_promotion_rule_update_data_attributes
