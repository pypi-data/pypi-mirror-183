...
if TYPE_CHECKING:
    from ..models.import_data_attributes_errors_log import ImportDataAttributesErrorsLog
    from ..models.import_data_attributes_inputs_item import ImportDataAttributesInputsItem
    from ..models.import_data_attributes_metadata import ImportDataAttributesMetadata
    from ..models.import_data_attributes_warnings_log import ImportDataAttributesWarningsLog


T = TypeVar("T", bound="ImportDataAttributes")


@attr.s(auto_attribs=True)
class ImportDataAttributes:
    """
    Attributes:
        ...
        inputs (Union[Unset, List['ImportDataAttributesInputsItem']]): Array of objects representing the resources that
            are being imported. Example: [{'code': 'ABC', 'name': 'Foo'}, {'code': 'DEF', 'name': 'Bar'}].
        ...
        processed_count (Union[Unset, int]): Indicates the number of records that have been processed (created or
            updated). Example: 270.
        errors_log (Union[Unset, ImportDataAttributesErrorsLog]): Contains the import errors, if any. Example: {'ABC':
            {'name': ['has already been taken']}}.
        warnings_log (Union[Unset, ImportDataAttributesWarningsLog]): Contains the import warnings, if any. Example:
            {'ABC': ['could not be deleted']}.
        ...
        metadata (Union[Unset, ImportDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    inputs: Union[Unset, List["ImportDataAttributesInputsItem"]] = UNSET
    ...
    errors_log: Union[Unset, "ImportDataAttributesErrorsLog"] = UNSET
    warnings_log: Union[Unset, "ImportDataAttributesWarningsLog"] = UNSET
    ...
    metadata: Union[Unset, "ImportDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for inputs_item_data in _inputs or []:
            inputs_item = ImportDataAttributesInputsItem.from_dict(inputs_item_data)
        ...
        errors_log: Union[Unset, ImportDataAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = ImportDataAttributesErrorsLog.from_dict(_errors_log)

        _warnings_log = d.pop("warnings_log", UNSET)
        warnings_log: Union[Unset, ImportDataAttributesWarningsLog]
        if isinstance(_warnings_log, Unset):
            warnings_log = UNSET
        else:
            warnings_log = ImportDataAttributesWarningsLog.from_dict(_warnings_log)
        ...
        metadata: Union[Unset, ImportDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ImportDataAttributesMetadata.from_dict(_metadata)

        import_data_attributes = cls(
        ...
        import_data_attributes.additional_properties = d
        return import_data_attributes
