...
if TYPE_CHECKING:
    from ..models.tax_rule_update_data_attributes_metadata import TaxRuleUpdateDataAttributesMetadata


T = TypeVar("T", bound="TaxRuleUpdateDataAttributes")


@attr.s(auto_attribs=True)
class TaxRuleUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, TaxRuleUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "TaxRuleUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, TaxRuleUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = TaxRuleUpdateDataAttributesMetadata.from_dict(_metadata)

        tax_rule_update_data_attributes = cls(
            name=name,
            tax_rate=tax_rate,
        ...
        tax_rule_update_data_attributes.additional_properties = d
        return tax_rule_update_data_attributes
