...
if TYPE_CHECKING:
    from ..models.coupon_create_data_attributes_metadata import CouponCreateDataAttributesMetadata


T = TypeVar("T", bound="CouponCreateDataAttributes")


@attr.s(auto_attribs=True)
class CouponCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CouponCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "CouponCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CouponCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CouponCreateDataAttributesMetadata.from_dict(_metadata)

        coupon_create_data_attributes = cls(
            code=code,
            usage_limit=usage_limit,
        ...
        coupon_create_data_attributes.additional_properties = d
        return coupon_create_data_attributes
