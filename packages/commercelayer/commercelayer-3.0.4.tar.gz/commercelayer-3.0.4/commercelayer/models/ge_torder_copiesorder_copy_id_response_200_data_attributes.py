...
if TYPE_CHECKING:
    from ..models.ge_torder_copiesorder_copy_id_response_200_data_attributes_errors_log import (
        GETorderCopiesorderCopyIdResponse200DataAttributesErrorsLog,
    )
    from ..models.ge_torder_copiesorder_copy_id_response_200_data_attributes_metadata import (
        GETorderCopiesorderCopyIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETorderCopiesorderCopyIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETorderCopiesorderCopyIdResponse200DataAttributes:
    """
    Attributes:
        ...
        errors_log (Union[Unset, GETorderCopiesorderCopyIdResponse200DataAttributesErrorsLog]): Contains the order copy
            errors, if any. Example: {'status': ['cannot transition from draft to placed']}.
        ...
        metadata (Union[Unset, GETorderCopiesorderCopyIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    errors_log: Union[Unset, "GETorderCopiesorderCopyIdResponse200DataAttributesErrorsLog"] = UNSET
    errors_count: Union[Unset, int] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETorderCopiesorderCopyIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        errors_log: Union[Unset, GETorderCopiesorderCopyIdResponse200DataAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = GETorderCopiesorderCopyIdResponse200DataAttributesErrorsLog.from_dict(_errors_log)
        ...
        metadata: Union[Unset, GETorderCopiesorderCopyIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETorderCopiesorderCopyIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_torder_copiesorder_copy_id_response_200_data_attributes = cls(
            status=status,
        ...
        ge_torder_copiesorder_copy_id_response_200_data_attributes.additional_properties = d
        return ge_torder_copiesorder_copy_id_response_200_data_attributes
