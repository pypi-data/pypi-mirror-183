...
if TYPE_CHECKING:
    from ..models.webhook_data_attributes_metadata import WebhookDataAttributesMetadata


T = TypeVar("T", bound="WebhookDataAttributes")


@attr.s(auto_attribs=True)
class WebhookDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, WebhookDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "WebhookDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, WebhookDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = WebhookDataAttributesMetadata.from_dict(_metadata)

        webhook_data_attributes = cls(
            name=name,
            topic=topic,
        ...
        webhook_data_attributes.additional_properties = d
        return webhook_data_attributes
