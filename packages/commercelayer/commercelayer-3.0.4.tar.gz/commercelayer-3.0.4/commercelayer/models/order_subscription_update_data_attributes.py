...
if TYPE_CHECKING:
    from ..models.order_subscription_update_data_attributes_metadata import (
        OrderSubscriptionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="OrderSubscriptionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class OrderSubscriptionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, OrderSubscriptionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "OrderSubscriptionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, OrderSubscriptionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = OrderSubscriptionUpdateDataAttributesMetadata.from_dict(_metadata)

        order_subscription_update_data_attributes = cls(
        ...
        order_subscription_update_data_attributes.additional_properties = d
        return order_subscription_update_data_attributes
