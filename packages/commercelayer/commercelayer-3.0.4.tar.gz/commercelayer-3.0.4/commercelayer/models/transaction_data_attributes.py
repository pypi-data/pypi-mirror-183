...
if TYPE_CHECKING:
    from ..models.transaction_data_attributes_metadata import TransactionDataAttributesMetadata


T = TypeVar("T", bound="TransactionDataAttributes")
...
class TransactionDataAttributes:
    ...
    Attributes:
        ...
        metadata (Union[Unset, TransactionDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "TransactionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, TransactionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = TransactionDataAttributesMetadata.from_dict(_metadata)

        transaction_data_attributes = cls(
            number=number,
        ...
        transaction_data_attributes.additional_properties = d
        return transaction_data_attributes
