...
if TYPE_CHECKING:
    from ..models.order_update_data_attributes_metadata import OrderUpdateDataAttributesMetadata


T = TypeVar("T", bound="OrderUpdateDataAttributes")


@attr.s(auto_attribs=True)
class OrderUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, OrderUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "OrderUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, OrderUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = OrderUpdateDataAttributesMetadata.from_dict(_metadata)

        order_update_data_attributes = cls(
        ...
        order_update_data_attributes.additional_properties = d
        return order_update_data_attributes
