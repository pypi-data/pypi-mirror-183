...
if TYPE_CHECKING:
    from ..models.fixed_amount_promotion_update_data_attributes_metadata import (
        FixedAmountPromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="FixedAmountPromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class FixedAmountPromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FixedAmountPromotionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "FixedAmountPromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FixedAmountPromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FixedAmountPromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        fixed_amount_cents = d.pop("fixed_amount_cents", UNSET)

        fixed_amount_promotion_update_data_attributes = cls(
            name=name,
        ...
        fixed_amount_promotion_update_data_attributes.additional_properties = d
        return fixed_amount_promotion_update_data_attributes
