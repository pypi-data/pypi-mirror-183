...
if TYPE_CHECKING:
    from ..models.patc_hfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes_metadata import (
        PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata]):
    ...
    metadata: Union[
        Unset, "PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = PATCHfreeShippingPromotionsfreeShippingPromotionIdResponse200DataAttributesMetadata.from_dict(
                _metadata
            )

        patc_hfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes.additional_properties = d
        return patc_hfree_shipping_promotionsfree_shipping_promotion_id_response_200_data_attributes
