...
if TYPE_CHECKING:
    from ..models.ge_torganizationorganization_id_response_200_data_attributes_metadata import (
        GETorganizationorganizationIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETorganizationorganizationIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETorganizationorganizationIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETorganizationorganizationIdResponse200DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "GETorganizationorganizationIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETorganizationorganizationIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETorganizationorganizationIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_torganizationorganization_id_response_200_data_attributes = cls(
            name=name,
            slug=slug,
            domain=domain,
        ...
        ge_torganizationorganization_id_response_200_data_attributes.additional_properties = d
        return ge_torganizationorganization_id_response_200_data_attributes
