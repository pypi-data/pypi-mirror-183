...
T = TypeVar("T", bound="GETskusResponse200DataItemAttributesInventory")


@attr.s(auto_attribs=True)
class GETskusResponse200DataItemAttributesInventory:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        ge_tskus_response_200_data_item_attributes_inventory = cls()

        ge_tskus_response_200_data_item_attributes_inventory.additional_properties = d
        return ge_tskus_response_200_data_item_attributes_inventory
