...
if TYPE_CHECKING:
    from ..models.ge_tbraintree_gatewaysbraintree_gateway_id_response_200_data_attributes_metadata import (
        GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributesMetadata]): Set of key-
    ...
    metadata: Union[Unset, "GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETbraintreeGatewaysbraintreeGatewayIdResponse200DataAttributesMetadata.from_dict(_metadata)
        ...
        ge_tbraintree_gatewaysbraintree_gateway_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tbraintree_gatewaysbraintree_gateway_id_response_200_data_attributes.additional_properties = d
        return ge_tbraintree_gatewaysbraintree_gateway_id_response_200_data_attributes
