...
if TYPE_CHECKING:
    from ..models.stock_transfer_update_data_attributes_metadata import StockTransferUpdateDataAttributesMetadata


T = TypeVar("T", bound="StockTransferUpdateDataAttributes")


@attr.s(auto_attribs=True)
class StockTransferUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, StockTransferUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "StockTransferUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, StockTransferUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StockTransferUpdateDataAttributesMetadata.from_dict(_metadata)

        stock_transfer_update_data_attributes = cls(
            sku_code=sku_code,
            upcoming=upcoming,
            picking=picking,
        ...
        stock_transfer_update_data_attributes.additional_properties = d
        return stock_transfer_update_data_attributes
