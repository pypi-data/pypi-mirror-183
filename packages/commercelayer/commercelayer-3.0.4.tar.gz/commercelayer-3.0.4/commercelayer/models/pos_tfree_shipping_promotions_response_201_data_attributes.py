...
if TYPE_CHECKING:
    from ..models.pos_tfree_shipping_promotions_response_201_data_attributes_metadata import (
        POSTfreeShippingPromotionsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTfreeShippingPromotionsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTfreeShippingPromotionsResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTfreeShippingPromotionsResponse201DataAttributesMetadata]): Set of key-value pairs
    ...
    metadata: Union[Unset, "POSTfreeShippingPromotionsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTfreeShippingPromotionsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTfreeShippingPromotionsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tfree_shipping_promotions_response_201_data_attributes = cls(
            name=name,
            starts_at=starts_at,
            expires_at=expires_at,
            total_usage_limit=total_usage_limit,
        ...
        pos_tfree_shipping_promotions_response_201_data_attributes.additional_properties = d
        return pos_tfree_shipping_promotions_response_201_data_attributes
