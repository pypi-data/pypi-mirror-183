...
if TYPE_CHECKING:
    from ..models.ge_tcheckout_com_paymentscheckout_com_payment_id_response_200_data_attributes_metadata import (
        GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesMetadata,
    )
    from ..models.ge_tcheckout_com_paymentscheckout_com_payment_id_response_200_data_attributes_payment_response import (
        GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesPaymentResponse,
    )


T = TypeVar("T", bound="GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributes:
    """
    Attributes:
        ...
        payment_response (Union[Unset,
            GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesPaymentResponse]): The Checkout.com payment
        ...
        metadata (Union[Unset, GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesMetadata]): Set of
    ...
    payment_response: Union[
        Unset, "GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesPaymentResponse"
    ] = UNSET
    ...
    metadata: Union[Unset, "GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_payment_response, Unset):
            ...
            payment_response = (
                GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesPaymentResponse.from_dict(
                    _payment_response
                )
            )
        ...
        metadata: Union[Unset, GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcheckoutComPaymentscheckoutComPaymentIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tcheckout_com_paymentscheckout_com_payment_id_response_200_data_attributes = cls(
        ...
        ge_tcheckout_com_paymentscheckout_com_payment_id_response_200_data_attributes.additional_properties = d
        return ge_tcheckout_com_paymentscheckout_com_payment_id_response_200_data_attributes
