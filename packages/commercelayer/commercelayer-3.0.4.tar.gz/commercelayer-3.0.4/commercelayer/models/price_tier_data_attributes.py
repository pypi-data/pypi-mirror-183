...
if TYPE_CHECKING:
    from ..models.price_tier_data_attributes_metadata import PriceTierDataAttributesMetadata


T = TypeVar("T", bound="PriceTierDataAttributes")


@attr.s(auto_attribs=True)
class PriceTierDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PriceTierDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PriceTierDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PriceTierDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PriceTierDataAttributesMetadata.from_dict(_metadata)

        price_tier_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        price_tier_data_attributes.additional_properties = d
        return price_tier_data_attributes
