...
if TYPE_CHECKING:
    from ..models.external_promotion_update_data_attributes_metadata import (
        ExternalPromotionUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="ExternalPromotionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ExternalPromotionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ExternalPromotionUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "ExternalPromotionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ExternalPromotionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExternalPromotionUpdateDataAttributesMetadata.from_dict(_metadata)

        promotion_url = d.pop("promotion_url", UNSET)

        external_promotion_update_data_attributes = cls(
            name=name,
        ...
        external_promotion_update_data_attributes.additional_properties = d
        return external_promotion_update_data_attributes
