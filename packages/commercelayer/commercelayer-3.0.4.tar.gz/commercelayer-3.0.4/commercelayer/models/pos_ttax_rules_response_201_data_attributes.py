...
if TYPE_CHECKING:
    from ..models.pos_ttax_rules_response_201_data_attributes_metadata import (
        POSTtaxRulesResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTtaxRulesResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTtaxRulesResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTtaxRulesResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTtaxRulesResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTtaxRulesResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTtaxRulesResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_ttax_rules_response_201_data_attributes = cls(
            name=name,
            tax_rate=tax_rate,
        ...
        pos_ttax_rules_response_201_data_attributes.additional_properties = d
        return pos_ttax_rules_response_201_data_attributes
