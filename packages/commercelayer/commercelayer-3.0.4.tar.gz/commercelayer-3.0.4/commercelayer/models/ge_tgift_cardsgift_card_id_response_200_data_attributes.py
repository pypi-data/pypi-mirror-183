...
if TYPE_CHECKING:
    from ..models.ge_tgift_cardsgift_card_id_response_200_data_attributes_balance_log_item import (
        GETgiftCardsgiftCardIdResponse200DataAttributesBalanceLogItem,
    )
    from ..models.ge_tgift_cardsgift_card_id_response_200_data_attributes_metadata import (
        GETgiftCardsgiftCardIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETgiftCardsgiftCardIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETgiftCardsgiftCardIdResponse200DataAttributes:
    """
    Attributes:
        ...
        balance_log (Union[Unset, List['GETgiftCardsgiftCardIdResponse200DataAttributesBalanceLogItem']]): The gift card
            balance log. Tracks all the gift card transactions. Example: [{'date': '2019-12-23T12:00:00.000Z',
            'amount_cents': -10000}, {'date': '2020-02-01T12:00:00.000Z', 'amount_cents': 5000}].
        ...
        metadata (Union[Unset, GETgiftCardsgiftCardIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    balance_log: Union[Unset, List["GETgiftCardsgiftCardIdResponse200DataAttributesBalanceLogItem"]] = UNSET
    ...
    metadata: Union[Unset, "GETgiftCardsgiftCardIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for balance_log_item_data in _balance_log or []:
            balance_log_item = GETgiftCardsgiftCardIdResponse200DataAttributesBalanceLogItem.from_dict(
                balance_log_item_data
            )
        ...
        metadata: Union[Unset, GETgiftCardsgiftCardIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETgiftCardsgiftCardIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tgift_cardsgift_card_id_response_200_data_attributes = cls(
            status=status,
            code=code,
        ...
        ge_tgift_cardsgift_card_id_response_200_data_attributes.additional_properties = d
        return ge_tgift_cardsgift_card_id_response_200_data_attributes
