...
if TYPE_CHECKING:
    from ..models.order_amount_promotion_rule_data_attributes_metadata import (
        OrderAmountPromotionRuleDataAttributesMetadata,
    )


T = TypeVar("T", bound="OrderAmountPromotionRuleDataAttributes")


@attr.s(auto_attribs=True)
class OrderAmountPromotionRuleDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, OrderAmountPromotionRuleDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "OrderAmountPromotionRuleDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, OrderAmountPromotionRuleDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = OrderAmountPromotionRuleDataAttributesMetadata.from_dict(_metadata)
        ...
        order_amount_promotion_rule_data_attributes = cls(
        ...
        order_amount_promotion_rule_data_attributes.additional_properties = d
        return order_amount_promotion_rule_data_attributes
