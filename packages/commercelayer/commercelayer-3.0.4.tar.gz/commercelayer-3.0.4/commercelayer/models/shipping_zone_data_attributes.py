...
if TYPE_CHECKING:
    from ..models.shipping_zone_data_attributes_metadata import ShippingZoneDataAttributesMetadata


T = TypeVar("T", bound="ShippingZoneDataAttributes")


@attr.s(auto_attribs=True)
class ShippingZoneDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingZoneDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ShippingZoneDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingZoneDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingZoneDataAttributesMetadata.from_dict(_metadata)

        shipping_zone_data_attributes = cls(
            name=name,
        ...
        shipping_zone_data_attributes.additional_properties = d
        return shipping_zone_data_attributes
