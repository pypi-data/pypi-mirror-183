...
if TYPE_CHECKING:
    from ..models.patc_hpackagespackage_id_response_200_data_attributes_metadata import (
        PATCHpackagespackageIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHpackagespackageIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHpackagespackageIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHpackagespackageIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHpackagespackageIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHpackagespackageIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHpackagespackageIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hpackagespackage_id_response_200_data_attributes = cls(
            name=name,
            code=code,
            length=length,
            width=width,
        ...
        patc_hpackagespackage_id_response_200_data_attributes.additional_properties = d
        return patc_hpackagespackage_id_response_200_data_attributes
