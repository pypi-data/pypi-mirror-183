...
if TYPE_CHECKING:
    from ..models.ge_tprice_tiersprice_tier_id_response_200_data_attributes_metadata import (
        GETpriceTierspriceTierIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpriceTierspriceTierIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpriceTierspriceTierIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpriceTierspriceTierIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETpriceTierspriceTierIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpriceTierspriceTierIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpriceTierspriceTierIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tprice_tiersprice_tier_id_response_200_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        ge_tprice_tiersprice_tier_id_response_200_data_attributes.additional_properties = d
        return ge_tprice_tiersprice_tier_id_response_200_data_attributes
