...
if TYPE_CHECKING:
    from ..models.pos_torders_response_201_data_attributes_metadata import POSTordersResponse201DataAttributesMetadata


T = TypeVar("T", bound="POSTordersResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTordersResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTordersResponse201DataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "POSTordersResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.pos_torders_response_201_data_attributes_metadata import (
            POSTordersResponse201DataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, POSTordersResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTordersResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_torders_response_201_data_attributes = cls(
        ...
        pos_torders_response_201_data_attributes.additional_properties = d
        return pos_torders_response_201_data_attributes
