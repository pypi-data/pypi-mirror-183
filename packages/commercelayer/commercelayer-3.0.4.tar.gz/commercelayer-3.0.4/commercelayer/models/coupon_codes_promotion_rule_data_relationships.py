...
if TYPE_CHECKING:
    from ..models.coupon_codes_promotion_rule_data_relationships_coupons import (
...
T = TypeVar("T", bound="CouponCodesPromotionRuleDataRelationships")


@attr.s(auto_attribs=True)
class CouponCodesPromotionRuleDataRelationships:
    """
    Attributes:
        ...
        coupons (Union[Unset, CouponCodesPromotionRuleDataRelationshipsCoupons]):
    """
    ...
    coupons: Union[Unset, "CouponCodesPromotionRuleDataRelationshipsCoupons"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_coupons, Unset):
            ...
            coupons = CouponCodesPromotionRuleDataRelationshipsCoupons.from_dict(_coupons)

        coupon_codes_promotion_rule_data_relationships = cls(
            promotion=promotion,
            coupons=coupons,
        )

        coupon_codes_promotion_rule_data_relationships.additional_properties = d
        return coupon_codes_promotion_rule_data_relationships
