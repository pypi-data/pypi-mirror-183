...
T = TypeVar("T", bound="GETlineItemsResponse200DataItemAttributesTaxBreakdown")


@attr.s(auto_attribs=True)
class GETlineItemsResponse200DataItemAttributesTaxBreakdown:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        ge_tline_items_response_200_data_item_attributes_tax_breakdown = cls()

        ge_tline_items_response_200_data_item_attributes_tax_breakdown.additional_properties = d
        return ge_tline_items_response_200_data_item_attributes_tax_breakdown
