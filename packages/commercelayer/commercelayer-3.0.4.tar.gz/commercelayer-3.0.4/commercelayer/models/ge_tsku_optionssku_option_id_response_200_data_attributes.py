...
if TYPE_CHECKING:
    from ..models.ge_tsku_optionssku_option_id_response_200_data_attributes_metadata import (
        GETskuOptionsskuOptionIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETskuOptionsskuOptionIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETskuOptionsskuOptionIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETskuOptionsskuOptionIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "GETskuOptionsskuOptionIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETskuOptionsskuOptionIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETskuOptionsskuOptionIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tsku_optionssku_option_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_tsku_optionssku_option_id_response_200_data_attributes.additional_properties = d
        return ge_tsku_optionssku_option_id_response_200_data_attributes
