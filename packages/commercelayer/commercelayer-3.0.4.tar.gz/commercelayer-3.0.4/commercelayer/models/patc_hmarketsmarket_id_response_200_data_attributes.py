...
if TYPE_CHECKING:
    from ..models.patc_hmarketsmarket_id_response_200_data_attributes_metadata import (
        PATCHmarketsmarketIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHmarketsmarketIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHmarketsmarketIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHmarketsmarketIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "PATCHmarketsmarketIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHmarketsmarketIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHmarketsmarketIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hmarketsmarket_id_response_200_data_attributes = cls(
            name=name,
        ...
        patc_hmarketsmarket_id_response_200_data_attributes.additional_properties = d
        return patc_hmarketsmarket_id_response_200_data_attributes
