...
if TYPE_CHECKING:
    from ..models.bundle_update_data_attributes_metadata import BundleUpdateDataAttributesMetadata


T = TypeVar("T", bound="BundleUpdateDataAttributes")


@attr.s(auto_attribs=True)
class BundleUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, BundleUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "BundleUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, BundleUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = BundleUpdateDataAttributesMetadata.from_dict(_metadata)

        bundle_update_data_attributes = cls(
            code=code,
            name=name,
        ...
        bundle_update_data_attributes.additional_properties = d
        return bundle_update_data_attributes
