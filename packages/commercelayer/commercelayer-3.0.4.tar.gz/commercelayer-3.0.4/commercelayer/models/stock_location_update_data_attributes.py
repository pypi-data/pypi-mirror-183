...
if TYPE_CHECKING:
    from ..models.stock_location_update_data_attributes_metadata import StockLocationUpdateDataAttributesMetadata


T = TypeVar("T", bound="StockLocationUpdateDataAttributes")


@attr.s(auto_attribs=True)
class StockLocationUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, StockLocationUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "StockLocationUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, StockLocationUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StockLocationUpdateDataAttributesMetadata.from_dict(_metadata)

        stock_location_update_data_attributes = cls(
            name=name,
        ...
        stock_location_update_data_attributes.additional_properties = d
        return stock_location_update_data_attributes
