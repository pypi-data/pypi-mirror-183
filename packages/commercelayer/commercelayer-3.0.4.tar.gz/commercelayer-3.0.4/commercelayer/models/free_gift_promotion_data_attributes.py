...
if TYPE_CHECKING:
    from ..models.free_gift_promotion_data_attributes_metadata import FreeGiftPromotionDataAttributesMetadata


T = TypeVar("T", bound="FreeGiftPromotionDataAttributes")


@attr.s(auto_attribs=True)
class FreeGiftPromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeGiftPromotionDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "FreeGiftPromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, FreeGiftPromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeGiftPromotionDataAttributesMetadata.from_dict(_metadata)

        max_quantity = d.pop("max_quantity", UNSET)

        free_gift_promotion_data_attributes = cls(
            name=name,
        ...
        free_gift_promotion_data_attributes.additional_properties = d
        return free_gift_promotion_data_attributes
