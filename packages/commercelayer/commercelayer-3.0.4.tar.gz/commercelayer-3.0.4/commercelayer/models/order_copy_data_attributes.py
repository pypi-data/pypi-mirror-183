...
if TYPE_CHECKING:
    from ..models.order_copy_data_attributes_errors_log import OrderCopyDataAttributesErrorsLog
    from ..models.order_copy_data_attributes_metadata import OrderCopyDataAttributesMetadata


T = TypeVar("T", bound="OrderCopyDataAttributes")


@attr.s(auto_attribs=True)
class OrderCopyDataAttributes:
    """
    Attributes:
        ...
        errors_log (Union[Unset, OrderCopyDataAttributesErrorsLog]): Contains the order copy errors, if any. Example:
            {'status': ['cannot transition from draft to placed']}.
        ...
        metadata (Union[Unset, OrderCopyDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    errors_log: Union[Unset, "OrderCopyDataAttributesErrorsLog"] = UNSET
    errors_count: Union[Unset, int] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "OrderCopyDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        errors_log: Union[Unset, OrderCopyDataAttributesErrorsLog]
        if isinstance(_errors_log, Unset):
            errors_log = UNSET
        else:
            errors_log = OrderCopyDataAttributesErrorsLog.from_dict(_errors_log)
        ...
        metadata: Union[Unset, OrderCopyDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = OrderCopyDataAttributesMetadata.from_dict(_metadata)

        order_copy_data_attributes = cls(
            status=status,
        ...
        order_copy_data_attributes.additional_properties = d
        return order_copy_data_attributes
