...
if TYPE_CHECKING:
    from ..models.pos_tsku_options_response_201_data_attributes_metadata import (
        POSTskuOptionsResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTskuOptionsResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTskuOptionsResponse201DataAttributes:
    """
    Attributes:
        name (str): The SKU option's internal name Example: Embossing.
        ...
        metadata (Union[Unset, POSTskuOptionsResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTskuOptionsResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTskuOptionsResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTskuOptionsResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tsku_options_response_201_data_attributes = cls(
            name=name,
        ...
        pos_tsku_options_response_201_data_attributes.additional_properties = d
        return pos_tsku_options_response_201_data_attributes
