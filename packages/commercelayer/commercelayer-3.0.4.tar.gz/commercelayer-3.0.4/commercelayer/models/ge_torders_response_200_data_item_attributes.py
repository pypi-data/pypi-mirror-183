...
if TYPE_CHECKING:
    from ..models.ge_torders_response_200_data_item_attributes_metadata import (
        GETordersResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_torders_response_200_data_item_attributes_payment_source_details import (
        GETordersResponse200DataItemAttributesPaymentSourceDetails,
    )


T = TypeVar("T", bound="GETordersResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETordersResponse200DataItemAttributes:
    """
    Attributes:
        ...
        payment_source_details (Union[Unset, GETordersResponse200DataItemAttributesPaymentSourceDetails]): An object
        ...
        metadata (Union[Unset, GETordersResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    payment_source_details: Union[Unset, "GETordersResponse200DataItemAttributesPaymentSourceDetails"] = UNSET
    ...
    metadata: Union[Unset, "GETordersResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payment_source_details: Union[Unset, GETordersResponse200DataItemAttributesPaymentSourceDetails]
        if isinstance(_payment_source_details, Unset):
            payment_source_details = UNSET
        else:
            payment_source_details = GETordersResponse200DataItemAttributesPaymentSourceDetails.from_dict(
        ...
        metadata: Union[Unset, GETordersResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETordersResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_torders_response_200_data_item_attributes = cls(
            number=number,
        ...
        ge_torders_response_200_data_item_attributes.additional_properties = d
        return ge_torders_response_200_data_item_attributes
