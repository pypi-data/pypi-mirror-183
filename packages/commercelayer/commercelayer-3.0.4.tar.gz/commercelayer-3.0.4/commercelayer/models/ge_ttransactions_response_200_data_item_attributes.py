...
if TYPE_CHECKING:
    from ..models.ge_ttransactions_response_200_data_item_attributes_metadata import (
        GETtransactionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETtransactionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETtransactionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETtransactionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETtransactionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETtransactionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETtransactionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_ttransactions_response_200_data_item_attributes = cls(
            number=number,
        ...
        ge_ttransactions_response_200_data_item_attributes.additional_properties = d
        return ge_ttransactions_response_200_data_item_attributes
