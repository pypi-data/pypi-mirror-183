...
if TYPE_CHECKING:
    from ..models.external_gateway_update_data_attributes_metadata import ExternalGatewayUpdateDataAttributesMetadata


T = TypeVar("T", bound="ExternalGatewayUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ExternalGatewayUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ExternalGatewayUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "ExternalGatewayUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.external_gateway_update_data_attributes_metadata import (
            ExternalGatewayUpdateDataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, ExternalGatewayUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ExternalGatewayUpdateDataAttributesMetadata.from_dict(_metadata)
        ...
        external_gateway_update_data_attributes = cls(
            name=name,
            reference=reference,
        ...
        external_gateway_update_data_attributes.additional_properties = d
        return external_gateway_update_data_attributes
