...
if TYPE_CHECKING:
    from ..models.pos_taddresses_response_201_data_attributes_metadata import (
        POSTaddressesResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTaddressesResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTaddressesResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTaddressesResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTaddressesResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTaddressesResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTaddressesResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_taddresses_response_201_data_attributes = cls(
            line_1=line_1,
            city=city,
            state_code=state_code,
            country_code=country_code,
        ...
        pos_taddresses_response_201_data_attributes.additional_properties = d
        return pos_taddresses_response_201_data_attributes
