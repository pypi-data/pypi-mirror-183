...
if TYPE_CHECKING:
    from ..models.parcel_update_data_attributes_metadata import ParcelUpdateDataAttributesMetadata


T = TypeVar("T", bound="ParcelUpdateDataAttributes")


@attr.s(auto_attribs=True)
class ParcelUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ParcelUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ParcelUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ParcelUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ParcelUpdateDataAttributesMetadata.from_dict(_metadata)

        parcel_update_data_attributes = cls(
            weight=weight,
        ...
        parcel_update_data_attributes.additional_properties = d
        return parcel_update_data_attributes
