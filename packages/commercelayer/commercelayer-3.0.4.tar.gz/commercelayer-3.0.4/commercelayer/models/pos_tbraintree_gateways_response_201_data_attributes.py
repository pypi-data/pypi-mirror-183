...
if TYPE_CHECKING:
    from ..models.pos_tbraintree_gateways_response_201_data_attributes_metadata import (
        POSTbraintreeGatewaysResponse201DataAttributesMetadata,
    )


T = TypeVar("T", bound="POSTbraintreeGatewaysResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTbraintreeGatewaysResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTbraintreeGatewaysResponse201DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "POSTbraintreeGatewaysResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, POSTbraintreeGatewaysResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTbraintreeGatewaysResponse201DataAttributesMetadata.from_dict(_metadata)
        ...
        pos_tbraintree_gateways_response_201_data_attributes = cls(
            name=name,
            merchant_account_id=merchant_account_id,
            merchant_id=merchant_id,
            public_key=public_key,
        ...
        pos_tbraintree_gateways_response_201_data_attributes.additional_properties = d
        return pos_tbraintree_gateways_response_201_data_attributes
