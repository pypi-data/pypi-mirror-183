...
if TYPE_CHECKING:
    from ..models.ge_tgift_cards_response_200_data_item_attributes_balance_log_item import (
        GETgiftCardsResponse200DataItemAttributesBalanceLogItem,
    )
    from ..models.ge_tgift_cards_response_200_data_item_attributes_metadata import (
        GETgiftCardsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETgiftCardsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETgiftCardsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        balance_log (Union[Unset, List['GETgiftCardsResponse200DataItemAttributesBalanceLogItem']]): The gift card
        ...
        metadata (Union[Unset, GETgiftCardsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    balance_log: Union[Unset, List["GETgiftCardsResponse200DataItemAttributesBalanceLogItem"]] = UNSET
    ...
    metadata: Union[Unset, "GETgiftCardsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for balance_log_item_data in _balance_log or []:
            balance_log_item = GETgiftCardsResponse200DataItemAttributesBalanceLogItem.from_dict(balance_log_item_data)
        ...
        metadata: Union[Unset, GETgiftCardsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETgiftCardsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tgift_cards_response_200_data_item_attributes = cls(
            status=status,
            code=code,
        ...
        ge_tgift_cards_response_200_data_item_attributes.additional_properties = d
        return ge_tgift_cards_response_200_data_item_attributes
