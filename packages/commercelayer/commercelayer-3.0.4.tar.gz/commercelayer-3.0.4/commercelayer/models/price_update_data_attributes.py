...
if TYPE_CHECKING:
    from ..models.price_update_data_attributes_metadata import PriceUpdateDataAttributesMetadata


T = TypeVar("T", bound="PriceUpdateDataAttributes")


@attr.s(auto_attribs=True)
class PriceUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PriceUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PriceUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PriceUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PriceUpdateDataAttributesMetadata.from_dict(_metadata)

        price_update_data_attributes = cls(
            sku_code=sku_code,
        ...
        price_update_data_attributes.additional_properties = d
        return price_update_data_attributes
