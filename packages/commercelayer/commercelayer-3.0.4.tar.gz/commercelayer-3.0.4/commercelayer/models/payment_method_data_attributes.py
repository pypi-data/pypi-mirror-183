...
if TYPE_CHECKING:
    from ..models.payment_method_data_attributes_metadata import PaymentMethodDataAttributesMetadata


T = TypeVar("T", bound="PaymentMethodDataAttributes")


@attr.s(auto_attribs=True)
class PaymentMethodDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PaymentMethodDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "PaymentMethodDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PaymentMethodDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PaymentMethodDataAttributesMetadata.from_dict(_metadata)

        payment_method_data_attributes = cls(
        ...
        payment_method_data_attributes.additional_properties = d
        return payment_method_data_attributes
