...
if TYPE_CHECKING:
    from ..models.ge_torder_amount_promotion_rulesorder_amount_promotion_rule_id_response_200_data_attributes_metadata import (
        GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset,
            GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[
        Unset, "GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributesMetadata"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = (
                GETorderAmountPromotionRulesorderAmountPromotionRuleIdResponse200DataAttributesMetadata.from_dict(
                    _metadata
                )
            )
        ...
        ge_torder_amount_promotion_rulesorder_amount_promotion_rule_id_response_200_data_attributes = cls(
        ...
        ge_torder_amount_promotion_rulesorder_amount_promotion_rule_id_response_200_data_attributes.additional_properties = (
            d
        )
        return ge_torder_amount_promotion_rulesorder_amount_promotion_rule_id_response_200_data_attributes
