...
if TYPE_CHECKING:
    from ..models.ge_tmarkets_response_200_data_item_attributes_metadata import (
        GETmarketsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETmarketsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETmarketsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETmarketsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETmarketsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETmarketsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETmarketsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tmarkets_response_200_data_item_attributes = cls(
            number=number,
            name=name,
        ...
        ge_tmarkets_response_200_data_item_attributes.additional_properties = d
        return ge_tmarkets_response_200_data_item_attributes
