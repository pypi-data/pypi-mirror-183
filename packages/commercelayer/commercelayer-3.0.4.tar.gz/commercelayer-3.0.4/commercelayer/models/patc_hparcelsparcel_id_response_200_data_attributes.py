...
if TYPE_CHECKING:
    from ..models.patc_hparcelsparcel_id_response_200_data_attributes_metadata import (
        PATCHparcelsparcelIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHparcelsparcelIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHparcelsparcelIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHparcelsparcelIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "PATCHparcelsparcelIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHparcelsparcelIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHparcelsparcelIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hparcelsparcel_id_response_200_data_attributes = cls(
            weight=weight,
        ...
        patc_hparcelsparcel_id_response_200_data_attributes.additional_properties = d
        return patc_hparcelsparcel_id_response_200_data_attributes
