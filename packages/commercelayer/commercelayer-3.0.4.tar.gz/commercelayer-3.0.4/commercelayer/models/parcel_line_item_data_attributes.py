...
if TYPE_CHECKING:
    from ..models.parcel_line_item_data_attributes_metadata import ParcelLineItemDataAttributesMetadata


T = TypeVar("T", bound="ParcelLineItemDataAttributes")


@attr.s(auto_attribs=True)
class ParcelLineItemDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ParcelLineItemDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "ParcelLineItemDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ParcelLineItemDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ParcelLineItemDataAttributesMetadata.from_dict(_metadata)

        parcel_line_item_data_attributes = cls(
            sku_code=sku_code,
            quantity=quantity,
            name=name,
            image_url=image_url,
        ...
        parcel_line_item_data_attributes.additional_properties = d
        return parcel_line_item_data_attributes
