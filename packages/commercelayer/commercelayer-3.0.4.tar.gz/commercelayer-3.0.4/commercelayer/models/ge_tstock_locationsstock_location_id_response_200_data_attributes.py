...
if TYPE_CHECKING:
    from ..models.ge_tstock_locationsstock_location_id_response_200_data_attributes_metadata import (
        GETstockLocationsstockLocationIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETstockLocationsstockLocationIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETstockLocationsstockLocationIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETstockLocationsstockLocationIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETstockLocationsstockLocationIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETstockLocationsstockLocationIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETstockLocationsstockLocationIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tstock_locationsstock_location_id_response_200_data_attributes = cls(
            number=number,
            name=name,
        ...
        ge_tstock_locationsstock_location_id_response_200_data_attributes.additional_properties = d
        return ge_tstock_locationsstock_location_id_response_200_data_attributes
