...
if TYPE_CHECKING:
    from ..models.order_data_attributes_metadata import OrderDataAttributesMetadata
    from ..models.order_data_attributes_payment_source_details import OrderDataAttributesPaymentSourceDetails


T = TypeVar("T", bound="OrderDataAttributes")


@attr.s(auto_attribs=True)
class OrderDataAttributes:
    """
    Attributes:
        ...
        payment_source_details (Union[Unset, OrderDataAttributesPaymentSourceDetails]): An object that contains the
            shareable details of the order's payment source. Example: {'foo': 'bar'}.
        ...
        metadata (Union[Unset, OrderDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    payment_source_details: Union[Unset, "OrderDataAttributesPaymentSourceDetails"] = UNSET
    ...
    metadata: Union[Unset, "OrderDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payment_source_details: Union[Unset, OrderDataAttributesPaymentSourceDetails]
        if isinstance(_payment_source_details, Unset):
            payment_source_details = UNSET
        else:
            payment_source_details = OrderDataAttributesPaymentSourceDetails.from_dict(_payment_source_details)
        ...
        metadata: Union[Unset, OrderDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = OrderDataAttributesMetadata.from_dict(_metadata)

        order_data_attributes = cls(
            number=number,
        ...
        order_data_attributes.additional_properties = d
        return order_data_attributes
