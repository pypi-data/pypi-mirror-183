...
if TYPE_CHECKING:
    from ..models.pos_tbundles_response_201_data_attributes_metadata import POSTbundlesResponse201DataAttributesMetadata


T = TypeVar("T", bound="POSTbundlesResponse201DataAttributes")


@attr.s(auto_attribs=True)
class POSTbundlesResponse201DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, POSTbundlesResponse201DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "POSTbundlesResponse201DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.pos_tbundles_response_201_data_attributes_metadata import (
            POSTbundlesResponse201DataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, POSTbundlesResponse201DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = POSTbundlesResponse201DataAttributesMetadata.from_dict(_metadata)

        pos_tbundles_response_201_data_attributes = cls(
            code=code,
            name=name,
            price_amount_cents=price_amount_cents,
            compare_at_amount_cents=compare_at_amount_cents,
        ...
        pos_tbundles_response_201_data_attributes.additional_properties = d
        return pos_tbundles_response_201_data_attributes
