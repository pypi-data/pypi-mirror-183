...
if TYPE_CHECKING:
    from ..models.checkout_com_payment_create_data_attributes_metadata import (
        CheckoutComPaymentCreateDataAttributesMetadata,
    )


T = TypeVar("T", bound="CheckoutComPaymentCreateDataAttributes")


@attr.s(auto_attribs=True)
class CheckoutComPaymentCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CheckoutComPaymentCreateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "CheckoutComPaymentCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CheckoutComPaymentCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CheckoutComPaymentCreateDataAttributesMetadata.from_dict(_metadata)

        checkout_com_payment_create_data_attributes = cls(
            payment_type=payment_type,
            token=token,
        ...
        checkout_com_payment_create_data_attributes.additional_properties = d
        return checkout_com_payment_create_data_attributes
