...
if TYPE_CHECKING:
    from ..models.ge_tcheckout_com_payments_response_200_data_item_attributes_metadata import (
        GETcheckoutComPaymentsResponse200DataItemAttributesMetadata,
    )
    from ..models.ge_tcheckout_com_payments_response_200_data_item_attributes_payment_response import (
        GETcheckoutComPaymentsResponse200DataItemAttributesPaymentResponse,
    )


T = TypeVar("T", bound="GETcheckoutComPaymentsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETcheckoutComPaymentsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        payment_response (Union[Unset, GETcheckoutComPaymentsResponse200DataItemAttributesPaymentResponse]): The
            Checkout.com payment response, used to fetch internal data. Example: {'foo': 'bar'}.
        ...
        metadata (Union[Unset, GETcheckoutComPaymentsResponse200DataItemAttributesMetadata]): Set of key-value pairs
    ...
    payment_response: Union[Unset, "GETcheckoutComPaymentsResponse200DataItemAttributesPaymentResponse"] = UNSET
    mismatched_amounts: Union[Unset, bool] = UNSET
    created_at: Union[Unset, str] = UNSET
    updated_at: Union[Unset, str] = UNSET
    reference: Union[Unset, str] = UNSET
    reference_origin: Union[Unset, str] = UNSET
    metadata: Union[Unset, "GETcheckoutComPaymentsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payment_response: Union[Unset, GETcheckoutComPaymentsResponse200DataItemAttributesPaymentResponse]
        if isinstance(_payment_response, Unset):
            payment_response = UNSET
        else:
            payment_response = GETcheckoutComPaymentsResponse200DataItemAttributesPaymentResponse.from_dict(
                _payment_response
            )
        ...
        metadata: Union[Unset, GETcheckoutComPaymentsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETcheckoutComPaymentsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tcheckout_com_payments_response_200_data_item_attributes = cls(
        ...
        ge_tcheckout_com_payments_response_200_data_item_attributes.additional_properties = d
        return ge_tcheckout_com_payments_response_200_data_item_attributes
