...
if TYPE_CHECKING:
    from ..models.shipping_zone_create_data_attributes_metadata import ShippingZoneCreateDataAttributesMetadata


T = TypeVar("T", bound="ShippingZoneCreateDataAttributes")


@attr.s(auto_attribs=True)
class ShippingZoneCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingZoneCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "ShippingZoneCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingZoneCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingZoneCreateDataAttributesMetadata.from_dict(_metadata)

        shipping_zone_create_data_attributes = cls(
            name=name,
        ...
        shipping_zone_create_data_attributes.additional_properties = d
        return shipping_zone_create_data_attributes
