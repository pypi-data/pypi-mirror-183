...
if TYPE_CHECKING:
    from ..models.checkout_com_payment_update_data_attributes_metadata import (
        CheckoutComPaymentUpdateDataAttributesMetadata,
    )


T = TypeVar("T", bound="CheckoutComPaymentUpdateDataAttributes")


@attr.s(auto_attribs=True)
class CheckoutComPaymentUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, CheckoutComPaymentUpdateDataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "CheckoutComPaymentUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, CheckoutComPaymentUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CheckoutComPaymentUpdateDataAttributesMetadata.from_dict(_metadata)

        checkout_com_payment_update_data_attributes = cls(
        ...
        checkout_com_payment_update_data_attributes.additional_properties = d
        return checkout_com_payment_update_data_attributes
