...
if TYPE_CHECKING:
    from ..models.ge_treturnsreturn_id_response_200_data_attributes_metadata import (
        GETreturnsreturnIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETreturnsreturnIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETreturnsreturnIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETreturnsreturnIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETreturnsreturnIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETreturnsreturnIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETreturnsreturnIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_treturnsreturn_id_response_200_data_attributes = cls(
            number=number,
            status=status,
        ...
        ge_treturnsreturn_id_response_200_data_attributes.additional_properties = d
        return ge_treturnsreturn_id_response_200_data_attributes
