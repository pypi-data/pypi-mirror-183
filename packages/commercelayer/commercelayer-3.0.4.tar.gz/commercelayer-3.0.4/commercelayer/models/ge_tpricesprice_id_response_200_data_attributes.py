...
if TYPE_CHECKING:
    from ..models.ge_tpricesprice_id_response_200_data_attributes_metadata import (
        GETpricespriceIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETpricespriceIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETpricespriceIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpricespriceIdResponse200DataAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETpricespriceIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpricespriceIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpricespriceIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tpricesprice_id_response_200_data_attributes = cls(
        ...
        ge_tpricesprice_id_response_200_data_attributes.additional_properties = d
        return ge_tpricesprice_id_response_200_data_attributes
