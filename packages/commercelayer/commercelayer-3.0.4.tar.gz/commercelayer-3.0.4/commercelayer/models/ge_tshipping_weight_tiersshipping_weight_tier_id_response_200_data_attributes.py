...
if TYPE_CHECKING:
    from ..models.ge_tshipping_weight_tiersshipping_weight_tier_id_response_200_data_attributes_metadata import (
        GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributesMetadata]): Set of
    ...
    metadata: Union[Unset, "GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETshippingWeightTiersshippingWeightTierIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tshipping_weight_tiersshipping_weight_tier_id_response_200_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        ge_tshipping_weight_tiersshipping_weight_tier_id_response_200_data_attributes.additional_properties = d
        return ge_tshipping_weight_tiersshipping_weight_tier_id_response_200_data_attributes
