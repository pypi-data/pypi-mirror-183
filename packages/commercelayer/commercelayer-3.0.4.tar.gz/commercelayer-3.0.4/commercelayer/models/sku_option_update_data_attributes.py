...
if TYPE_CHECKING:
    from ..models.sku_option_update_data_attributes_metadata import SkuOptionUpdateDataAttributesMetadata


T = TypeVar("T", bound="SkuOptionUpdateDataAttributes")


@attr.s(auto_attribs=True)
class SkuOptionUpdateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, SkuOptionUpdateDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "SkuOptionUpdateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, SkuOptionUpdateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = SkuOptionUpdateDataAttributesMetadata.from_dict(_metadata)

        sku_option_update_data_attributes = cls(
            name=name,
        ...
        sku_option_update_data_attributes.additional_properties = d
        return sku_option_update_data_attributes
