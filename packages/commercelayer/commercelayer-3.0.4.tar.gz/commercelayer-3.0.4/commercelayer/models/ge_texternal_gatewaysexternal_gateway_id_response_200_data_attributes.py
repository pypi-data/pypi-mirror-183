...
if TYPE_CHECKING:
    from ..models.ge_texternal_gatewaysexternal_gateway_id_response_200_data_attributes_metadata import (
        GETexternalGatewaysexternalGatewayIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETexternalGatewaysexternalGatewayIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETexternalGatewaysexternalGatewayIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETexternalGatewaysexternalGatewayIdResponse200DataAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETexternalGatewaysexternalGatewayIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETexternalGatewaysexternalGatewayIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETexternalGatewaysexternalGatewayIdResponse200DataAttributesMetadata.from_dict(_metadata)
        ...
        ge_texternal_gatewaysexternal_gateway_id_response_200_data_attributes = cls(
            name=name,
        ...
        ge_texternal_gatewaysexternal_gateway_id_response_200_data_attributes.additional_properties = d
        return ge_texternal_gatewaysexternal_gateway_id_response_200_data_attributes
