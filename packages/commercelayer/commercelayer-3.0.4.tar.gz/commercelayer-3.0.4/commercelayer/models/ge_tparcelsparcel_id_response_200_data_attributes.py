...
if TYPE_CHECKING:
    from ..models.ge_tparcelsparcel_id_response_200_data_attributes_metadata import (
        GETparcelsparcelIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="GETparcelsparcelIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class GETparcelsparcelIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETparcelsparcelIdResponse200DataAttributesMetadata]): Set of key-value pairs that you
    ...
    metadata: Union[Unset, "GETparcelsparcelIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETparcelsparcelIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETparcelsparcelIdResponse200DataAttributesMetadata.from_dict(_metadata)

        ge_tparcelsparcel_id_response_200_data_attributes = cls(
            number=number,
            weight=weight,
        ...
        ge_tparcelsparcel_id_response_200_data_attributes.additional_properties = d
        return ge_tparcelsparcel_id_response_200_data_attributes
