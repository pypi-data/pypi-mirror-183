...
if TYPE_CHECKING:
    from ..models.ge_texports_response_200_data_item_attributes_filters import (
        GETexportsResponse200DataItemAttributesFilters,
    )
    from ..models.ge_texports_response_200_data_item_attributes_metadata import (
        GETexportsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETexportsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETexportsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        includes (Union[Unset, List[str]]): List of related resources that should be included in the export. Example:
            ['prices.price_tiers'].
        filters (Union[Unset, GETexportsResponse200DataItemAttributesFilters]): The filters used to select the records
            to be exported. Example: {'code_eq': 'AAA'}.
        ...
        metadata (Union[Unset, GETexportsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    filters: Union[Unset, "GETexportsResponse200DataItemAttributesFilters"] = UNSET
    ...
    metadata: Union[Unset, "GETexportsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filters: Union[Unset, GETexportsResponse200DataItemAttributesFilters]
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = GETexportsResponse200DataItemAttributesFilters.from_dict(_filters)
        ...
        metadata: Union[Unset, GETexportsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETexportsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_texports_response_200_data_item_attributes = cls(
        ...
        ge_texports_response_200_data_item_attributes.additional_properties = d
        return ge_texports_response_200_data_item_attributes
