...
if TYPE_CHECKING:
    from ..models.ge_twebhooks_response_200_data_item_attributes_metadata import (
        GETwebhooksResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETwebhooksResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETwebhooksResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETwebhooksResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETwebhooksResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETwebhooksResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETwebhooksResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_twebhooks_response_200_data_item_attributes = cls(
            name=name,
            topic=topic,
        ...
        ge_twebhooks_response_200_data_item_attributes.additional_properties = d
        return ge_twebhooks_response_200_data_item_attributes
