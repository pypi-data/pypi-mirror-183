...
if TYPE_CHECKING:
    from ..models.market_create_data_attributes_metadata import MarketCreateDataAttributesMetadata


T = TypeVar("T", bound="MarketCreateDataAttributes")


@attr.s(auto_attribs=True)
class MarketCreateDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, MarketCreateDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "MarketCreateDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, MarketCreateDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = MarketCreateDataAttributesMetadata.from_dict(_metadata)

        market_create_data_attributes = cls(
            name=name,
        ...
        market_create_data_attributes.additional_properties = d
        return market_create_data_attributes
