...
if TYPE_CHECKING:
    from ..models.ge_tsku_options_response_200_data_item_attributes_metadata import (
        GETskuOptionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETskuOptionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETskuOptionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETskuOptionsResponse200DataItemAttributesMetadata]): Set of key-value pairs that you can
    ...
    metadata: Union[Unset, "GETskuOptionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETskuOptionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETskuOptionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        ge_tsku_options_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tsku_options_response_200_data_item_attributes.additional_properties = d
        return ge_tsku_options_response_200_data_item_attributes
