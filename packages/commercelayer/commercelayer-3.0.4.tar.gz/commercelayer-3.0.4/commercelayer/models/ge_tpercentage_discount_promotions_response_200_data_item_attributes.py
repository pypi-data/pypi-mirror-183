...
if TYPE_CHECKING:
    from ..models.ge_tpercentage_discount_promotions_response_200_data_item_attributes_metadata import (
        GETpercentageDiscountPromotionsResponse200DataItemAttributesMetadata,
    )


T = TypeVar("T", bound="GETpercentageDiscountPromotionsResponse200DataItemAttributes")


@attr.s(auto_attribs=True)
class GETpercentageDiscountPromotionsResponse200DataItemAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, GETpercentageDiscountPromotionsResponse200DataItemAttributesMetadata]): Set of key-value
    ...
    metadata: Union[Unset, "GETpercentageDiscountPromotionsResponse200DataItemAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, GETpercentageDiscountPromotionsResponse200DataItemAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = GETpercentageDiscountPromotionsResponse200DataItemAttributesMetadata.from_dict(_metadata)

        percentage = d.pop("percentage", UNSET)

        ge_tpercentage_discount_promotions_response_200_data_item_attributes = cls(
            name=name,
        ...
        ge_tpercentage_discount_promotions_response_200_data_item_attributes.additional_properties = d
        return ge_tpercentage_discount_promotions_response_200_data_item_attributes
