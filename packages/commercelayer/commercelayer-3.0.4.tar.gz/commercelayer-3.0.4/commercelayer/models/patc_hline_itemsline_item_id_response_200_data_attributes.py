...
if TYPE_CHECKING:
    from ..models.patc_hline_itemsline_item_id_response_200_data_attributes_metadata import (
        PATCHlineItemslineItemIdResponse200DataAttributesMetadata,
    )


T = TypeVar("T", bound="PATCHlineItemslineItemIdResponse200DataAttributes")


@attr.s(auto_attribs=True)
class PATCHlineItemslineItemIdResponse200DataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, PATCHlineItemslineItemIdResponse200DataAttributesMetadata]): Set of key-value pairs that
    ...
    metadata: Union[Unset, "PATCHlineItemslineItemIdResponse200DataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, PATCHlineItemslineItemIdResponse200DataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PATCHlineItemslineItemIdResponse200DataAttributesMetadata.from_dict(_metadata)

        patc_hline_itemsline_item_id_response_200_data_attributes = cls(
            sku_code=sku_code,
        ...
        patc_hline_itemsline_item_id_response_200_data_attributes.additional_properties = d
        return patc_hline_itemsline_item_id_response_200_data_attributes
