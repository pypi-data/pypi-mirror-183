...
if TYPE_CHECKING:
    from ..models.free_shipping_promotion_data_attributes_metadata import FreeShippingPromotionDataAttributesMetadata


T = TypeVar("T", bound="FreeShippingPromotionDataAttributes")


@attr.s(auto_attribs=True)
class FreeShippingPromotionDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, FreeShippingPromotionDataAttributesMetadata]): Set of key-value pairs that you can attach
    ...
    metadata: Union[Unset, "FreeShippingPromotionDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.free_shipping_promotion_data_attributes_metadata import (
            FreeShippingPromotionDataAttributesMetadata,
        )
        ...
        metadata: Union[Unset, FreeShippingPromotionDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = FreeShippingPromotionDataAttributesMetadata.from_dict(_metadata)

        free_shipping_promotion_data_attributes = cls(
            name=name,
        ...
        free_shipping_promotion_data_attributes.additional_properties = d
        return free_shipping_promotion_data_attributes
