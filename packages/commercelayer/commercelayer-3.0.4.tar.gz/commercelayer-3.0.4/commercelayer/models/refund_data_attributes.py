...
if TYPE_CHECKING:
    from ..models.refund_data_attributes_metadata import RefundDataAttributesMetadata


T = TypeVar("T", bound="RefundDataAttributes")


@attr.s(auto_attribs=True)
class RefundDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, RefundDataAttributesMetadata]): Set of key-value pairs that you can attach to the
    ...
    metadata: Union[Unset, "RefundDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, RefundDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = RefundDataAttributesMetadata.from_dict(_metadata)

        refund_data_attributes = cls(
            number=number,
        ...
        refund_data_attributes.additional_properties = d
        return refund_data_attributes
