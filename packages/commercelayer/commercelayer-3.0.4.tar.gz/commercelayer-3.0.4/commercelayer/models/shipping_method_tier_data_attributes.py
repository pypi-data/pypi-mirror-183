...
if TYPE_CHECKING:
    from ..models.shipping_method_tier_data_attributes_metadata import ShippingMethodTierDataAttributesMetadata


T = TypeVar("T", bound="ShippingMethodTierDataAttributes")


@attr.s(auto_attribs=True)
class ShippingMethodTierDataAttributes:
    """
    Attributes:
        ...
        metadata (Union[Unset, ShippingMethodTierDataAttributesMetadata]): Set of key-value pairs that you can attach to
    ...
    metadata: Union[Unset, "ShippingMethodTierDataAttributesMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ShippingMethodTierDataAttributesMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ShippingMethodTierDataAttributesMetadata.from_dict(_metadata)

        shipping_method_tier_data_attributes = cls(
            name=name,
            up_to=up_to,
        ...
        shipping_method_tier_data_attributes.additional_properties = d
        return shipping_method_tier_data_attributes
