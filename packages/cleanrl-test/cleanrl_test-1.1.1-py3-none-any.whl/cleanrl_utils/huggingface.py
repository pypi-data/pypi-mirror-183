...
Note that you may need to install additional dependencies depending on the algorithm you are using. You can do so by 
specifying the extra dependencies with the following command:

```
pip install --upgrade "cleanrl_test[atari,jax]"
```
