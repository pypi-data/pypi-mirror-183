...
class HomepageRecommendation(RecommendationInterface):
    ...
    @classmethod
    def from_payload(
        cls, graph_connection: GraphDbConnection, redis_uri: str
            ...
            byw.append(
                {
                    ...
                    "recommendation": "byw_offline_recommendation_{}".format(
    ...
    def fetch_user_behaviour_recommendation() -> List[Dict[str, Any]]:
        ...
        for i in range(1, 100):
            ub.append(
                {
                    "id": random.randint(1, 1_000),
                    "recommendation": "ub_offline_recommendation_{}".format(
                        random.randint(1, 1_000)
                    ),
                }
            )
