...
with open(
    path.join(here, "parametrization_cookbook", "__init__.py"), encoding="utf-8"
) as f:
...
setup(
    name="parametrization_cookbook",
    # Versions should comply with PEP440.  For a discussion on single-sourcing
    # the version across setup.py and the project code, see
    # https://packaging.python.org/en/latest/single_source_version.html
    version=version,
    description="Implementation and helpers of the Parametrization Cookbook",
