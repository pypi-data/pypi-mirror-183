...
class RefrigerationCompressorRack(openstudiomodelhvac.StraightComponent):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelrefrigeration.RefrigerationCompressorRack_swiginit(self, _openstudiomodelrefrigeration.new_RefrigerationCompressorRack(model))
    ...
    def setHeatRejectionLocation(self, heatRejectionLocation: "std::string") -> "bool":
