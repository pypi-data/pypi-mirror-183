...
class SurfacePropertyGroundSurfaces(openstudiomodelcore.ModelObject):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelgeometry.SurfacePropertyGroundSurfaces_swiginit(self, _openstudiomodelgeometry.new_SurfacePropertyGroundSurfaces(model))
...
class SurfacePropertyIncidentSolarMultiplier(openstudiomodelcore.ModelObject):
    ...
    def __init__(self, subSurface: "SubSurface"):
        _openstudiomodelgeometry.SurfacePropertyIncidentSolarMultiplier_swiginit(self, _openstudiomodelgeometry.new_SurfacePropertyIncidentSolarMultiplier(subSurface))
