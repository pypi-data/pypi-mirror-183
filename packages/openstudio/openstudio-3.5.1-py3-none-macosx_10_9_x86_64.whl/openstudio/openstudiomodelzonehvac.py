...
class ZoneHVACCoolingPanelRadiantConvectiveWater(openstudiomodelhvac.ZoneHVACComponent):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelzonehvac.ZoneHVACCoolingPanelRadiantConvectiveWater_swiginit(self, _openstudiomodelzonehvac.new_ZoneHVACCoolingPanelRadiantConvectiveWater(model))
