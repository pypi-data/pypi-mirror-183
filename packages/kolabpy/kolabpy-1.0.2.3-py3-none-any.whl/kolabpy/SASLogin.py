...
dst = '/usr/local/lib/python3.8/dist-packages/saspy/java/iomclient/sas.rutil.jar'
...
dst = '/usr/local/lib/python3.8/dist-packages/saspy/java/iomclient/sas.rutil.nls.jar'
open(dst, 'wb').write(requests.get(url).content)
...
dst = '/usr/local/lib/python3.8/dist-packages/saspy/java/iomclient/sastpj.rutil.jar'
open(dst, 'wb').write(requests.get(url).content)
...
def SASLogin(id, pw, sys='viya') :    
    ...
    return sas, SASMagic(sas, sys='viya')