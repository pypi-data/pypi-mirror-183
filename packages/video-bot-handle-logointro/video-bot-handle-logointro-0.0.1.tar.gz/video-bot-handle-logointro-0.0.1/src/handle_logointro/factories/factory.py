...
from handle_logointro.factories.base_factory import BaseFactory
...
#rest
from handle_logointro.infra.rest  import Rest



from handle_logointro.infra.handle_logointro.handle_logointro import HandleLogoIntro

#Services
from handle_logointro.services.handle_logointro_service import HandleLogoIntroService

#Controllers
from handle_logointro.controllers.handle_logointro_controller import  HandleLogoIntroController

#Other Services
from handle_logointro.services.text_utils_service import TextUtilsService
from handle_logointro.services.speech_service import SpeechService
from handle_logointro.services.time_service import AddTimeService
...
class Factory(BaseFactory):
    ...
    def make_script(self, script_name, general_config, script_config):
        return HandleLogoIntro(script_config, self.logger)
    ...
    def make_service(self, script_name, general_config, script_config) -> BaseService:
        ...
        return HandleLogoIntroService(script_config, executer, downloader, saver, external_services)
    ...
    def make_controller(self) -> BaseController:
        ...
        controller = HandleLogoIntroController(self.request, service)
