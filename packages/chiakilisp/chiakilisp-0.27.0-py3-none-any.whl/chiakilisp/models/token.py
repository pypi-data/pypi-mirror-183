...
class Token:
    ...
    def is_apostrophe(self) -> bool:

        """Just a handy shortcut"""

        return self._type == Token.Apostrophe

    def is_tilda(self) -> bool:

        """Just a handy shortcut"""

        return self._type == Token.Tilda

    def is_tilat(self) -> bool:

        """Just a handy shortcut"""

        return self._type == Token.TilAt

    def is_at(self) -> bool:

        """Just a handy shortcut"""

        return self._type == Token.At
