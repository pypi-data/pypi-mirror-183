...
wrong_dimension_message_error = 'The dimension is not correct!'
...
class TestQuadraticFunction(unittest.TestCase):
    ...
    def test_gradient_1(self):
        ...
        np.testing.assert_array_equal(dfdxfull.shape, (3, 100), wrong_dimension_message_error)
    ...
    def test_gradient_2(self):
        ...
        np.testing.assert_allclose(dfdx, np.array([[-0.83014478, -1.0575632, -1.10784864,
                                                   ...
                                                   [1.32352312, 5.91287408, 7.4618524,
                                                    ...
                                                    1.0103668]]),
                                   atol=1e-09)
        np.testing.assert_array_equal(dfdx.shape, (2, 10), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(dfdx_2.shape, (2, 1), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(dfdx_3.shape, (2, 2), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(dfdx_4.shape, (2, 3), wrong_dimension_message_error)
    ...
    def test_gradient_3(self):
        ...
        np.testing.assert_array_equal(dfdxs.shape, (3, 100), wrong_dimension_message_error)
    ...
    def test_hessian_2(self):
        ...
        np.testing.assert_allclose(hfdx, np.array(
            [[[2, 0], [0, 8]], [[2, 0], [0, 8]], [[2, 0], [0, 8]],
             ...
             [[2, 0], [0, 8]], [[2, 0], [0, 8]], [[2, 0], [0, 8]],
             [[2, 0], [0, 8]]]), atol=1e-09)
        np.testing.assert_array_equal(hfdx.shape, (10, 2, 2), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(hfdx_2.shape, (1, 2, 2), wrong_dimension_message_error)
        ...
        np.testing.assert_allclose(hfdx_3, np.array([[[2, 0], [0, 8]], [[2, 0], [0, 8]]]),
                                   atol=1e-09)
        np.testing.assert_array_equal(hfdx_3.shape, (2, 2, 2), wrong_dimension_message_error)
        ...
        np.testing.assert_allclose(hfdx_4, np.array([[[2, 0], [0, 8]], [[2, 0], [0, 8]],
                                                     [[2, 0], [0, 8]]]), atol=1e-09)
        np.testing.assert_array_equal(hfdx_4.shape, (3, 2, 2), wrong_dimension_message_error)
    ...
    def test_hessian_3(self):
        ...
        np.testing.assert_array_equal(hfdxs.shape, (100, 3, 3), wrong_dimension_message_error)
...
class TestPolynomialFunction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pol = PolynomialFunction(exponents=np.array([[3, 0, 0], [0, 3], [0, 0, 3]]),
                                      coefficients=np.array([1, 1, 1]))
    ...
    def test_gradient_1(self):
        ...
        np.testing.assert_array_equal(dfdx.shape, (3, 1), wrong_dimension_message_error)
        self.assertIsInstance(dfdx, np.ndarray)
    ...
    def test_gradient_2(self):
        ...
        np.testing.assert_array_equal(dfdx2.shape, (3, 2), wrong_dimension_message_error)
    ...
    def test_gradient_3(self):
        ...
        np.testing.assert_array_equal(dfdx3.shape, (3, 3), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(dfdx3_1.shape, (3, 1), wrong_dimension_message_error)
    ...
    def test_hessian_1(self):
        ...
        np.testing.assert_allclose(hfdx, np.array([[[6, 0, 0], [0, 12, 0], [0, 0, 18]]]),
                                   atol=1e-09)
        np.testing.assert_array_equal(hfdx.shape, (1, 3, 3), wrong_dimension_message_error)
        self.assertIsInstance(hfdx, np.ndarray)
    ...
    def test_hessian_2(self):
        ...
        np.testing.assert_allclose(hfdx2,
                                   np.array([[[14, 1, 0], [1, 0, 0], [0, 0, 72]],
                                             [[14, 1, 0], [1, 0, 0], [0, 0, 72]]]),
                                   atol=1e-09)
        np.testing.assert_array_equal(hfdx2.shape, (2, 3, 3), wrong_dimension_message_error)
    ...
    def test_hessian_3(self):
        ...
        np.testing.assert_array_equal(hfdx3.shape, (3, 3, 3), wrong_dimension_message_error)
        ...
        np.testing.assert_array_equal(hfdx3_1.shape, (1, 3, 3), wrong_dimension_message_error)
...
class TestLinearFunction(unittest.TestCase):
    ...
    def test_gradient_1(self):
        ...
        np.testing.assert_array_equal(dfdx.shape, (3, 100), wrong_dimension_message_error)
        self.assertIsInstance(dfdx, np.ndarray)
    ...
    def test_gradient_2(self):
        ...
        np.testing.assert_array_equal(dfdx_u.shape, (1, 1), wrong_dimension_message_error)
    ...
    def test_gradient_3(self):
        ...
        np.testing.assert_array_equal(dfdx_3.shape, (2, 1), wrong_dimension_message_error)
        self.assertIsInstance(dfdx_3, np.ndarray)
    ...
    def test_gradient_4(self):
        ...
        np.testing.assert_array_equal(dfdx_4.shape, (2, 2), wrong_dimension_message_error)
        self.assertIsInstance(dfdx_4, np.ndarray)
    ...
    def test_hessian_1(self):
        ...
        np.testing.assert_array_equal(hfdx.shape, (100, 3, 3), wrong_dimension_message_error)
        self.assertIsInstance(hfdx, np.ndarray)
    ...
    def test_hessian_2(self):
        ...
        np.testing.assert_array_equal(hfdx_u.shape, (1, 1, 1), wrong_dimension_message_error)
    ...
    def test_hessian_3(self):
        ...
        np.testing.assert_array_equal(hfdx_3.shape, (1, 2, 2), wrong_dimension_message_error)
        self.assertIsInstance(hfdx_3, np.ndarray)
    ...
    def test_hessian_4(self):
        ...
        np.testing.assert_allclose(hfdx_4, np.array([[[0., 0.], [0., 0.]], [[0., 0.], [0., 0.]]]),
                                   atol=1e-09)
        np.testing.assert_array_equal(hfdx_4.shape, (2, 2, 2), wrong_dimension_message_error)
        self.assertIsInstance(hfdx_4, np.ndarray)
...
class TestFunctionsComposite(unittest.TestCase):
    ...
    def test_eval(self):
        ...
        np.testing.assert_array_equal(f_x.shape, (3, 1), wrong_dimension_message_error)

        # series composition
        f_x = self.f_c.eval(self.x, composition="series")
        np.testing.assert_allclose(f_x, np.sum(self.fxr, axis=0).reshape(-1, 1), atol=1e-09)
        self.assertIsInstance(f_x, np.ndarray)
        np.testing.assert_array_equal(f_x.shape, (1, 1), wrong_dimension_message_error)
    ...
    def test_gradient(self):
        ...
        self.assertIsInstance(dfdx, np.ndarray)
        np.testing.assert_array_equal(dfdx.shape, (2, 3), wrong_dimension_message_error)
        ...
        self.assertIsInstance(dfdx, np.ndarray)
        np.testing.assert_array_equal(dfdx.shape, (2, 1), wrong_dimension_message_error)
    ...
    def test_hessian(self):
        ...
        np.testing.assert_allclose(hfdx, self.hfdxr, atol=1e-09)
        self.assertIsInstance(hfdx, np.ndarray)
        np.testing.assert_array_equal(hfdx.shape, (3, 2, 2), wrong_dimension_message_error)
