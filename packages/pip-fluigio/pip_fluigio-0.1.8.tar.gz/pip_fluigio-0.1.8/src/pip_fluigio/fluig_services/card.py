...
class Card(CardProvider):
    ...
    def update_card_data(self, *, company_id: str, user_name: str, password: str, card_id: str, items: list[Item]):

        try:

            self._logger.attribute.info(f"Start update card value by cardid - {card_id}")
