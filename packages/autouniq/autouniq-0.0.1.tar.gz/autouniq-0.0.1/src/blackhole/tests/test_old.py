...
import pytest
from src.blackhole import collection_framework
from src.blackhole.uniq.core import find_uniq_count_from_list, find_uniq_count_letters, find_uniq_count_in_text
from src.blackhole.tests.case import TEXT, result
...
def test_parcer(fake_args, expected_string, expected_path):
    with patch('sys.argv', fake_args):
        from src.blackhole.uniq.parcer import use_parser
