...
import pytest
from src import collection_framework
from src.core import find_uniq_count_from_list, find_uniq_count_letters, find_uniq_count_in_text
from src.case import TEXT, result
...
def test_parcer(fake_args, expected_string, expected_path):
    with patch('sys.argv', fake_args):
        from src.parcer import use_parser
