...
class DockerImage:
    ...
    def update(self, nextVersion: str, dry_run: bool, only_updates: bool):
        ...
        common += "tag: " + colored(self.namespace + '/' + self.repository + ':' + self.channel, 'yellow') + '\n'
        ...
        if nextVersion == self.version:
            ...
            majorUpdateNotification = Utility.detectMajorVersionUpdate(self.version, nextVersion)
            print(colored(majorUpdateNotification, 'red'))
