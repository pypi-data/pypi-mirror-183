...
def getArgs():
    ...
    parser = argparse.ArgumentParser(description='Doup is a tool to find and update Docker-Image-Strings recursivly in project files.')
    parser.add_argument('-p', '--path', type=str,
                        default=currentPath,
                        help='search in specific path')
