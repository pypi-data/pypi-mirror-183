...
def automate_copy(ref_file,source_col="source",dest_col="dest"):
    """Use `.csv` or `.xls*` file to automate process of copying files from source path to destination path. Copies file data and permissions.
...
def automate_copy2(ref_file,source_col="source",dest_col="dest"):
    """Use `.csv` or `.xls*` file to automate process of copying files from source path to destination path. Copies file data, permissions, and metadata.
...
def automate_copyfile(ref_file,source_col="source",dest_col="dest"):
    """Use `.csv` or `.xls*` file to automate process of copying files from source path to destination path. Files are copied without permissions and metadata.
