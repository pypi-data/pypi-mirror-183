...
class View(klovve.pieces.viewer.image.View, klovve.drivers.gtk.View):
    ...
    def get_native(self, model, model_bind):
        widget = self.gtk_new(Outer, width_request=100, hexpand=False, source=model_bind(twoway=False).source)#, hexpand=True, vexpand=True, visible=True) #TODO width_request
        return widget
