...
class List(collections.abc.MutableSequence, klovve.data.observable_value.ObservableValue):
    """
    A list implementation that is observable (with :py:class:`ListObserver` or as
    :py:class:`klovve.data.observable_value.ObservableValue`) and has some other additional features.
    """
    ...
    def update(self, source_list: t.Iterable[t.Any], *,
        ...
        """
        with klovve.data.deps.defer_value_propagation():
