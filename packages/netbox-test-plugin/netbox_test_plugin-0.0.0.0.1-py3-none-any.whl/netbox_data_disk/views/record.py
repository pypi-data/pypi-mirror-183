...
from netbox_test_plugin.tables import RecordTable, ManagedRecordTable
...
class ManagedRecordListView(generic.ObjectListView):
    ...
    actions = ("export",)
    template_name = "netbox_test_plugin/record/managed.html"
...
class RecordEditView(generic.ObjectEditView):
    ...
    form = RecordForm
    default_return_url = "plugins:netbox_test_plugin:record_list"
