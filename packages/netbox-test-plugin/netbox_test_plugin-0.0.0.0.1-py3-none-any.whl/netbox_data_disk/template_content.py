...
from netbox_test_plugin.models import Record, RecordTypeChoices, Zone
from netbox_test_plugin.tables import RelatedRecordTable, RelatedZoneTable
...
class RelatedDNSRecords(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        return self.render(
            "netbox_test_plugin/record/related.html",
            extra_context={
...
class RelatedDNSPointerZones(PluginTemplateExtension):
    ...
    def full_width_page(self):
        ...
        return self.render(
            "netbox_test_plugin/zone/related.html",
            extra_context={
...
if get_plugin_config("netbox_test_plugin", "feature_ipam_integration"):
