...
from netbox_test_plugin.models import View, Zone, Record, RecordTypeChoices, RecordStatusChoices
...
class RecordBulkEditForm(NetBoxModelBulkEditForm):
    ...
    zone = DynamicModelChoiceField(
        ...
        required=False,
        widget=APISelect(
            attrs={"data-url": reverse_lazy("plugins-api:netbox_test_plugin-api:zone-list")}
        ),
    )
