...
from netbox_test_plugin.fields import NetworkField, AddressField
...
class NameServer(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_test_plugin:nameserver", kwargs={"pk": self.pk})
...
class Zone(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_test_plugin:zone", kwargs={"pk": self.pk})
...
class Record(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_test_plugin:record", kwargs={"pk": self.id})
...
class View(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_test_plugin:view", kwargs={"pk": self.id})
