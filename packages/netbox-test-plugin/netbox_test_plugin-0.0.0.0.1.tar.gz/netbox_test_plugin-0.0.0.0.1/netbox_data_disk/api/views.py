...
from netbox_test_plugin.api.serializers import (
    ViewSerializer,
    ZoneSerializer,
    NameServerSerializer,
    RecordSerializer,
)
from netbox_test_plugin.filters import ViewFilter, ZoneFilter, NameServerFilter, RecordFilter
from netbox_test_plugin.models import View, Zone, NameServer, Record


class NetboxTestPluginRootView(APIRootView):
    """
    NetboxTestPlugin API root view
    """

    def get_view_name(self):
        return "NetboxTestPlugin"
