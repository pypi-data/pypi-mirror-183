...
from netbox_test_plugin.filters import ZoneFilter, RecordFilter
...
from netbox_test_plugin.models import Record, Zone
from netbox_test_plugin.tables import (
    ZoneTable,
    RecordTable,
    ManagedRecordTable,
)
...
class ZoneEditView(generic.ObjectEditView):
    ...
    form = ZoneForm
    default_return_url = "plugins:netbox_test_plugin:zone_list"
...
class ZoneRecordListView(generic.ObjectChildrenView):
    ...
    template_name = "netbox_test_plugin/zone/record.html"
    hide_if_empty = True

    tab = ViewTab(
        label="Records",
        permission="netbox_test_plugin.view_record",
...
class ZoneManagedRecordListView(generic.ObjectChildrenView):
    ...
    filterset = RecordFilter
    template_name = "netbox_test_plugin/zone/managed_record.html"
    actions = ("changelog",)
