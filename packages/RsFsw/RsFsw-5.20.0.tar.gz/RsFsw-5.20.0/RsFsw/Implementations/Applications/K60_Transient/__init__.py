...
class K60_TransientCls:
	"""K60_Transient commands group definition. 748 total commands, 13 Subgroups, 0 group commands"""
	...
	@property
	def sense(self):
		"""sense commands group. 20 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'K60_TransientCls':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = K60_TransientCls(self._core, self._cmd_group.parent)
