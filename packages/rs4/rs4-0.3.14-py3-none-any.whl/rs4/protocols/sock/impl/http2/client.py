...
class Session:
    ...
    def _request (self, method, urls, data = None, headers = {}, wait = 0):
        issingle = False
        if isinstance (urls, str):
            issingle = True
            urls = [urls]

        headers, data = self._rebuild_header (headers, data)
    ...
    def get (self, urls, headers = {}, wait = 0):
        return self._request ('GET', urls, headers = headers, wait = wait)

    def delete (self, urls, headers = {}, wait = 0):
        return self._request ('DELETE', urls, headers = headers, wait = wait)

    def options (self, urls, headers = {}, wait = 0):
        return self._request ('OPTIONS', urls, headers = headers, wait = wait)

    def head (self, urls, headers = {}, wait = 0):
        return self._request ('HEAD', urls, headers = headers, wait = wait)

    def post (self, urls, data, headers = {}, wait = 0):
        return self._request ('POST', urls, data, headers, wait = wait)

    def put (self, urls, data, headers = {}, wait = 0):
        return self._request ('PUT', urls, data, headers, wait = wait)

    def patch (self, urls, data, headers = {}, wait = 0):
        return self._request ('PATCH', urls, data, headers, wait = wait)
