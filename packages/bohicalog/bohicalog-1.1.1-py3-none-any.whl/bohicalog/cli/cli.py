...
- When you run ``python3 -m {{cookiecutter.package_name}}`` python will execute``__main__.py`` as a script.
  That means there won't be any ``{{cookiecutter.package_name}}.__main__`` in ``sys.modules``.
