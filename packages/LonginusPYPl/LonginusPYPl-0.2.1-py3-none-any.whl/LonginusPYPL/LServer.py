...
class Server:
    ...
    def start_server(self):
        ...
        while True:
            ...
            print(self.L.Token_DB_loader(Route=r'C:\Users\Eternal_Nightmare0\Desktop\Project-Longinus\package\LonginusPYPL\TokenDB.DB'))
            print(self.Server_DB_loader(Route=r'C:\Users\Eternal_Nightmare0\Desktop\Project-Longinus\package\LonginusPYPL\ServerDB.DB'))
            #except:
...
#############################################################################################################################################################################################################################
    ...
    def Server_DB_checker(self,Route:str):
        self.Route=Route
        try:
    ...
    def Server_DB_loader(self,Route=r'C:\Users\Eternal_Nightmare0\Desktop\Project-Longinus\package\LonginusPYPL\ServerDB.DB'):
        self.Route=Route
        if  self.Server_DB_checker(self.Route) == True:
            with open(self.Route,'r') as f:
    ...
    def saveing_all_data(self,set_token,user_data,Route=r'C:\Users\Eternal_Nightmare0\Desktop\Project-Longinus\package\LonginusPYPL\ServerDB.DB'):
