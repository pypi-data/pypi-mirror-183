...
def difference_datetimezone7_by_seconds_from_between(_dt_first, _dtz_last):
    ...
    print('check dtz_1 :',_dtz_1)
    _dtz_2 = datetime.strptime(str(_dtz_last).strip(),'%Y-%m-%dT%H:%M:%S.%f%z')
    print('check dtz_2 :',_dtz_2)
    diff = (_dtz_2-_dtz_1).seconds
    print('check difference_datetimezone7_by_seconds_from_between :',diff)
    return diff
...
## Testing
# dt_start = '2022-12-30 22:30'
# dt_lastoflog = '2022-12-30T22:32:41.124227+0700'
# oput = difference_datetimezone7_by_seconds_from_between(dt_start,dt_lastoflog)
# print('check difference_datetimezone7_by_seconds_from_between :',oput)