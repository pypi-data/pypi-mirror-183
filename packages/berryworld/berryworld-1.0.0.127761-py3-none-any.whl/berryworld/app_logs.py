...
class AppLogs:
    ...
    def __init__(self, instrumentation_key, project_name=None, pipeline=None, server_type=None,
    ...
    def allocate_properties(self):
        self.properties = {'custom_dimensions': {
            ...
            'IpAddress': self.ip_address if self.ip_address is not None else '',
            'RequestUrl': self.request_url if self.request_url is not None else ''}
        }
