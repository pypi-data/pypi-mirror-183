...
requires = ["requests==2.28.1", "pycryptodome==3.16.0","aiohttp==3.8.3","asyncio==3.4.3","tinytag==1.8.1","Pillow==9.3.0"]
_long_description = """
...
``` bash
pip install ArseinRubika==4.8.0
```
...
setup(
    ...
    license = "MIT",
    keywords = ["Arsein","Arseinrubika","ArseinRubika","arsein","bot","Bot","BOT","Robot","ROBOT","robot","self","api","API","Api","rubika","Rubika","RUBIKA","Python","python"],
