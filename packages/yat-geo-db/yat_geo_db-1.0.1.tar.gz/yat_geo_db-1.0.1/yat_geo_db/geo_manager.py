...
class RadiusSearchManager(object):
    ...
    def radius_search(self, reference_code, radius, country_exact: bool = False):
        shape_obj = self.get_shape_by_ref_code(reference_code=reference_code)
        ...
        return self.get_radius_lat_lng_shape_ids(
...
class GeoManager(ShapeManager, RadiusSearchManager, NgramSearchManager):
    ...
    def load_data(self, version: str = None, force_db_fetch: bool = False):
