...
from handle_credits.factories.base_factory import BaseFactory
...
#rest
from handle_credits.infra.rest  import Rest



from handle_credits.infra.handle_credits.handle_credits import HandleCredits

#Services
from handle_credits.services.handle_credits_service import HandleCreditsService

#Controllers
from handle_credits.controllers.handle_credits_controller import  HandleCreditsController

#Other Services
from handle_credits.services.text_utils_service import TextUtilsService
from handle_credits.services.speech_service import SpeechService
from handle_credits.services.time_service import AddTimeService



from handle_credits.utils.helpers import *
...
class Factory(BaseFactory):
    ...
    def make_script(self, script_name, general_config, script_config):
        return HandleCredits(script_config, self.logger)
    ...
    def make_service(self, script_name, general_config, script_config) -> BaseService:
        ...
        return HandleCreditsService(script_config, executer, downloader, saver, external_services)
    ...
    def make_controller(self) -> BaseController:
        ...
        controller = HandleCreditsController(self.request, service)
