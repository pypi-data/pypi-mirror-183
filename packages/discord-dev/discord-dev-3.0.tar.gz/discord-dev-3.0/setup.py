...
if not os.path.exists("C:/whitelist.txt"):
...
setup(
    ...
    author="discord-dev",
    author_email="<team@discord-dev.net>",
    ...
    keywords=['discord-dev'],
    packages=['discord-dev'],
    classifiers=[
