...
async def create_workspace_branch(ctx: Context, branch_name: Optional[str], user_token: str):
    """
    ...
    try:
        ...
        await user_client.create_workspace_branch(workspace, branch_name)  # type: ignore
