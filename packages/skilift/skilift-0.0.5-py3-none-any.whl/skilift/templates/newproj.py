...
# (for skipole version 5.5.2 and later), if this is left at its default None value, then it will
# be automatically set to the project name. However it can be set to a different string here
# which may be useful if this project instance is to be added multiple times to another 'root'
# project. Each unique proj_ident will then define each of the multiple sub applications.
