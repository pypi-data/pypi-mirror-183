...
class StepFunctionsAutoDiscover(
    ...
    def __init__(
        ...
        *,
        srcdir: builtins.str,
        cdk_deps: _projen_awscdk_04054675.AwsCdkDeps,
        tsconfig_path: builtins.str,
    ) -> None:
        '''
        :param project: -
        :param srcdir: Project source tree (relative to project output directory).
        ...
        options = StepFunctionsAutoDiscoverOptions(
            srcdir=srcdir, cdk_deps=cdk_deps, tsconfig_path=tsconfig_path
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_projen_awscdk_04054675.AutoDiscoverCommonOptions],
    name_mapping={
        "cdk_deps": "cdkDeps",
...
class StepFunctionsAutoDiscoverOptions(
    _projen_awscdk_04054675.AutoDiscoverCommonOptions,
):
    def __init__(
        self,
        *,
    ...
    @builtins.property
    def cdk_deps(self) -> _projen_awscdk_04054675.AwsCdkDeps:
        ...
        return typing.cast(_projen_awscdk_04054675.AwsCdkDeps, result)
