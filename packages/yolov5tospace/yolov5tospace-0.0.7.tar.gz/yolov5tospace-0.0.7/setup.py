...
def get_version():
    ...
    version_file = os.path.join(current_dir, "yolov5tospace", "__init__.py")
...
setuptools.setup(
    ...
    author="",
    license="MIT",
    description="Automatically create Gradio apps from YOLOv5 models and push to the Space.",
    ...
    entry_points={
        "console_scripts": [
            "yolov5tospace=yolov5tospace.cli:app",
        ],
    },
