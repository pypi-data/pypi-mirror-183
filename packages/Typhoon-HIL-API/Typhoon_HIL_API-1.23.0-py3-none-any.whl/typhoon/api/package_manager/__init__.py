...
class PackageManagerAPI(PackageManagerAPIBase):
    ...
    def create_example(self, title, model_file, panel_file, output_path,
        ...
        Args:
            ...
            output_path: Path where example should be saved
    ...
    def create_package(self, package_name, version, output_path, author="",
                       description="", library_paths=None,
                       resource_paths=None, example_paths=None,
                       additional_files_paths=None, python_packages_paths=None,
                       documentation_paths=None, documentation_landing_page="",
                       release_notes_path=""):
        """
