...
@organization: High Field Magnet Laboratpry, Radboud University, Nijmegen
@copyright: High Field Magnet Laboratpry, Radboud University, Nijmegen
@license: GPL-3+
@version: 0.0.1
"""
...
def __main__():
    ...
    for index, file in enumerate(input_file["File"]):
        ...
        actual_temp_std = zero_field_data.std()
    ...
    for to_plot, field in enumerate(fields):
        ...
        for index, data in enumerate(all_data):
            ...
            if field in all_data[index]["Accepted Data Points"][field_column_name]:
                ...
                meas_temp_err = matching_data.std()
            else:
