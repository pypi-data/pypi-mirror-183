...
class HttpSource(DataSource):
    ...
    def show_schema() -> None:
        ...
        schema = {
            ...
            "url": "http_uri",
            "args": {
                "requests_get|post_argument_keyword": "value_for_this_argument"
            }
        }
    ...
    def read_source(
        ...
        Args:
            ...
            close_session (bool, optional): If true the session will be closed
                after the request. Defaults to True.
