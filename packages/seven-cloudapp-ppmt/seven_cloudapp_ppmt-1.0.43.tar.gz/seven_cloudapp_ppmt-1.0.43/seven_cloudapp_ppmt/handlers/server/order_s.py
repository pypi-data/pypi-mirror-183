...
@LastEditTime: 2022-05-05 18:04:54
...
class PrizeOrderExportHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        if export_type == 1:
            ...
            data_columns = ["淘宝主订单号", "淘宝子订单号", "小程序订单号", "淘宝名", "盒子名称", "盒子价格", "奖品名称", "商家编码", "姓名", "手机号", "省份", "城市", "区县", "街道", "收货地址", "物流单号", "物流公司", "发货时间","下单时间", "订单状态", "奖品价值", "奖品规格", "备注"]
