...
import wagtail_rest_pack.generic_forms.models


class Migration(migrations.Migration):

    dependencies = [
        ('generic_forms', '0004_alter_formbuilder_content'),
    ]
