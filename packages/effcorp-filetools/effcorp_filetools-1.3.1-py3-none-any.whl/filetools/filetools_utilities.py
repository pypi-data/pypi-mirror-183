...
def search_drives(extension):
    ...
    print(f"We are searching for {extension} files in all your Drives. \n It may take some time. Please wait...")
...
def combine_excel(folder,mode="file",sheet=0,source="folder"):
    ...
    #this source parameter was added so that even list of excel files can be passed as a parameter
        ...
        if len(folder)<2:
            ...
            newfile = os.path.join(os.path.dirname(folder[0]), 'All_ExcelFiles_Combined_Auto.xlsx')
...
def find_in_pdf(folder):
    ...
    print("Code under testing phase, not to be used in production..!!")
