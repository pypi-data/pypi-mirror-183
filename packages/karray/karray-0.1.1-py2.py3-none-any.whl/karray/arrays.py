...
from typing import List, Dict, Tuple, Union # TODO: add to every funtion or method the appropriate typing e.g. index: Dict[str|int,List[str|int]] | None = None. After that use Mypy
