...
from bordercollie.sql import exec, insert_many, insert_to_redis

racc = auth.redis_account
cli = redis.Redis(host=racc['host'],
                  port=racc['port'],
...
class SyncToSQL(Component):
    ...
    def process(self) -> List[str]:
        ...
        try:
            ...
            # loop.run_until_complete(insert_to_redis(data))
            return records
