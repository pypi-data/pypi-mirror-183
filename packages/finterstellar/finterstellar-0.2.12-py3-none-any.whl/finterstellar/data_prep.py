...
def get_price(symbol, start_date=None, end_date=None, decimal_duex=True):
    ...
    df = _get_daily_price(symbols, start=start_date, end=end_date)['Close']
...
def _make_ohlc(raw):
    ...
    # close = raw['chart']['result'][0]['indicators']['adjclose'][0]['adjclose']
