...
class Lamp:
    def __init__(self, key: str, ip: str, port: int, group_id: int, json_settings_path: str = 'settings.json', request_delay: float = 500, timeout_sync: int = 5,
    ...
    def send_request(self, *args, **kwargs):
        ...
        try:
            self.connection.sendto(message.encode(), (self.ip, self.port))
