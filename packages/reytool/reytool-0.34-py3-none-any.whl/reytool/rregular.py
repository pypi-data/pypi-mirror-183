...
def re_search(pattern: str, text: str, mode: Optional[RegexFlag] = None) -> str | None | Tuple[str | None]:
    """
...
def res(text: str, *patterns: str, return_first: bool = True) -> str | None | Tuple[str | None]:
    """
