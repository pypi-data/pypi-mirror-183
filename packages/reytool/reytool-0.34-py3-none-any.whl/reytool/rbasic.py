...
from typing import Any, List, Tuple, Iterable, Callable, NoReturn, Type, Literal, Optional
...
def check_parm(value: Any, *targets: Any | Literal["_iterable"], check_element: bool = False) -> None:
    """
...
def get_first_notnull(*values: Any, default: Optional[Any] = None, exclude: List = []) -> Any:
    """
