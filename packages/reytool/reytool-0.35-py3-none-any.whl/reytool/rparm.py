...
from typing import Any, Tuple, Dict, Iterable, Iterator, Literal, Optional
...
class RParm(object):
    ...
    def __init__(self, *parms: Dict, default: Any | Literal["error"] = "error") -> None:
        """
    ...
    def __getitem__(self, indexes: Any | Tuple) -> Any:
        """
    ...
    def get(self, keys: Any | Iterable, default: Optional[Any] = None) -> Dict:
        """
    ...
    def pop(self, keys: Any | Iterable, default: Optional[Any] = None) -> Dict:
        """
