...
class REmail(object):
    ...
    def __init__(
        ...
        attachment: Optional[Dict[str, str | bytes]] = None,
        to_email: Optional[str | Iterable] = None,
        cc_email: Optional[str | Iterable] = None,
        display_from_email: Optional[str] = None,
        display_to_email: Optional[str | Iterable] = None,
        display_cc_email: Optional[str | Iterable] = None
    ) -> None:
        """
