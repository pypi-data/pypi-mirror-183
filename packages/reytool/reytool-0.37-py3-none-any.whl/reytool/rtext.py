...
def pformat(content: Any, width: int = 100) -> str:
    """
...
def print_frame(*contents: Any, title: Optional[str] = None, width: int = 100, frame: Literal["full", "half", "plain"] = "full") -> None:
    ...
    frame : Frame type.
        - 'full' : Build with symbol '═╔╗╡╞╠╣╚╝', and content not can exceed the frame.
        - 'half' : Build with symbol '═╡╞', and content can exceed the frame.
        - 'plain' : Build with symbol '=|', and content can exceed the frame.
    """
