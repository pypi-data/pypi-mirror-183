...
class RTMark():
    ...
    def mark(self) -> Dict[
        ...
        None | str | float | datetime.datetime | datetime.timedelta
    ]:
        """
...
def str_to_time(
        ...
        format_str: Optional[str] = None,
        throw_error: bool = False
    ) -> datetime.datetime | datetime.date | datetime.time | datetime.timedelta | int | Any:
    """
...
def is_sql_time(content: str | int, return_value: bool = False) -> bool | Tuple[int]:
    """
