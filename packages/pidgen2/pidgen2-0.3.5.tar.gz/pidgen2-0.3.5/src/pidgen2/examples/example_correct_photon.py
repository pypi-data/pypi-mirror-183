...
config = {
  'gamma' : {
              ...
              "IsPhoton0" : ("PP_IsPhoton", "gamma_B2KstarGammaType0_Region0", "IsPhoton", kernels),
              "IsPhoton1" : ("PP_IsPhoton", "gamma_B2KstarGammaType0_Region1", "IsPhoton", kernels),
              "IsPhoton2" : ("PP_IsPhoton", "gamma_B2KstarGammaType0_Region2", "IsPhoton", kernels),
            },
}
