...
def move_plate(ham, source_plate, target_plate, gripHeight = 6, try_inversions=None, widthBefore=132, **more_options):
    ...
    for inv in try_inversions:
        cid = ham.send_command(ISWAP_GET, plateLabwarePositions=src_pos, gripHeight=gripHeight, widthBefore=widthBefore, inverseGrip=inv, **more_options)
        try:
