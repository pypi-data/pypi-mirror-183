...
# host = 'https://bfranalytics-dev.cloud.databricks.com'
# token = 'dapi41bc0e27d8b91fd8c0144f0a6144655a'
# service = PermissionsService(host, token)
# p = Permission('Hossein.Shahandeh@brookfieldrenewable.com', AccessType.USER, Level.CAN_MANAGE)
# p = Permission('bdo-gam', AccessType.GROUP, Level.CAN_VIEW)
# p = Permission('516a582b-c0cd-496f-a6d5-969f69975e39', AccessType.PRINCIPAL, Level.CAN_VIEW)

# service.assign_permission('1024059401256209', permission=p)
